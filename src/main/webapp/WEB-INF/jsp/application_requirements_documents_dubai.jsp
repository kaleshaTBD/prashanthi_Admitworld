			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Application Requirements &#038; Documents for Dubai</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_dubai">Study in
										Dubai</a> &#187;  <span class="breadcrumb_last" aria-current="page">Application Requirements &#038; Documents for Dubai</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<blockquote>
										<h4>Dubai offers as many as 6 different time periods when
											you can consider applications to different Universities:
											January, May, July, August, September, November</h4>
									</blockquote>
									<p>
										<strong> </strong>
									</p>
									<h2>List of admission documents required to study in Dubai:</h2>
									<ul>
										<li>Attested copies of all your certificates X, XII &amp;
											Graduate Degree (if applicable), Mark Sheets including Backlogs
											(re-sits)</li>
										<li>Evidence of English Language proficiency e.g. <a
											href="ielts" target="_blank">IELTS</a>,
											<a href="toefl" target="_blank">TOEFL</a>,
											etc. (if applicable)
										</li>
										<li>Standardised Tests e.g. <a
											href="ielts" target="_blank">IELTS</a>,
											<a href="gmat" target="_blank">GMAT</a>,
											<a href="gre" target="_blank">GRE</a>
											(if applicable)
										</li>
										<li>Letter of Recommendation as required by the Institute
											(Min. 2) (preferably from employer if you have been working
											after your graduation)</li>
										<li>Passport sized photographs</li>
										<li>Passport photocopy (front and last page)</li>
										<li>Statement of Purpose (SOP – Institute Specific)</li>
										<li>Resume</li>
										<li>Draft for application fees, if applicable</li>
										<li>Design Portfolio (for Art, Design &amp; Architecture
											Courses)</li>
										<li>Certificates &amp; Achievements of Extracurricular
											Activities (if available)</li>
									</ul>
								</div>
