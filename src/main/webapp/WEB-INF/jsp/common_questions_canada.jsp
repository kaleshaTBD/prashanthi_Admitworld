			      ...
			      <div id="hero-wrapper">
						<img src="wp-content/uploads/2018/11/canada-desert-1009680_1920-1.jpg"
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>FAQs about studying in Canada</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_canada">Study in
										Canada</a> &#187;  <span class="breadcrumb_last" aria-current="page">FAQs about studying in Canada</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
						...
						<div class="entry-content">
							...
							<h1>Commonly asked questions/ FAQs about studying in Canada</h1>
							<p>FAQs about studying in Canada is to help you solve your
								queries. We have picked up the best ones based on the
								experience.</p>
							<h2>Where can I stay off campus?</h2>
							<p>
								<strong><br /></strong>In general, Canadian Universities
								provide adequate information on accommodation when they send you
								your Offer Letter. We may be able to get you in touch with other
								students or our previous students and they can help.
							</p>
							<h2>What&#8217;s the difference between assistantships and
								fellowships?</h2>
							<p>
								<strong><br /></strong>Assistantships &#8211; students provide
								services to the university e.g. assisting in teaching or
								research, in exchange for funding the students. This will help
								you network as well as add to your resume!
							</p>
							<p>Fellowships &#8211; Students receive funds from the
								university without having to give anything back</p>
							<h2>I want a scholarship to study in CANADA. What can I do?</h2>
							<p>
								<strong><br /></strong>Most universities will have their
								scholarship criteria and details listed on their websites. Most
								Canadian Universities will directly consider you for applicable
								scholarships. Many Universities email you about the details with
								the requirements, essays to be written, etc. You can also look
								into bodies in India to apply for a scholarship e.g. Aga Khan
								Foundation, Tata Endowment, Inlaks etc.
							</p>
							<p>
								<a href="contact_us">Contact us</a> in case you
								need counseling for your admission to study in Canada.
							</p>
						</div>
