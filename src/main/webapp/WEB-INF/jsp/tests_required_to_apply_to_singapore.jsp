			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Tests Required to Apply to Singapore</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_singapore">Study in
										Singapore</a> &#187;  <span class="breadcrumb_last" aria-current="page">Tests Required to Apply to Singapore</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h3>Bachelors in Singapore:</h3>
									<p>
										Students need to appear for <a
											href="ielts" target="_blank">IELTS</a>
										or <a href="toefl" target="_blank">TOEFL</a>.
										The recommended score is 6.0 in <a
											href="ielts" target="_blank">IELTS</a>
										(admissions are possible with 5.5 in <a
											href="ielts" target="_blank">IELTS</a>
										too) or 80 in <a href="toefl"
											target="_blank">TOEFL</a> iBT.
									</p>
									<p>
										<a href="sat1"
											target="_blank">SAT</a> is NOT required to apply to
										Universities in Singapore. National University of Singapore
										(NUS) however will need <a
											href="sat1"
											target="_blank">SAT</a> and <a
											href="sat1"
											target="_blank">SAT</a> II Subject Tests (with Math Level 2
										being compulsory) for students who have not studied their IBDP.
									</p>
									<p>&nbsp;</p>
									<h3>Masters in Singapore:</h3>
									<p>
										<a href="gre" target="_blank">GRE</a> is
										NOT required to study Masters in Singapore. Having a good score
										though when you are applying to National Universities will be
										helpful.
									</p>
									<p>
										Students need to appear for <a
										...
										The recommended score is 6.0 in <a
											href="ielts" target="_blank">IELTS</a>
										or 90 in <a href="toefl" target="_blank">TOEFL</a>
										iBT. If your undergraduate degree had English as the medium of
										instruction, the you can get a letter from your College that
										confirms this fact and your <a
											href="ielts" target="_blank">IELTS</a>
										or <a href="toefl" target="_blank">TOEFL</a>
										requirement can be waived for Private Institutions.
									</p>
									<p>
										For admissions to National Universities in Singapore, you
										essentially need to take your <a
											href="ielts" target="_blank">IELTS</a>
										or <a href="toefl" target="_blank">TOEFL</a>
									</p>
									<p>&nbsp;</p>
									<h3>MBA in Singapore:</h3>
									<p>
										<a href="gmat" target="_blank">GMAT</a>
										is required for applying to MBA programs at INSEAD, NUS, NTU,
										SMU, SP Jain. To know about the <a
											href="gmat" target="_blank">GMAT</a>
										requirements, average age, work experience, etc. as these top
										Institutions in Singapore, check out our <a
											href="mba_in_singapore" target="_blank"
											rel="noopener">MBA in Singapore</a> page
									</p>
									<p>
										Students need to appear for <a
											href="ielts" target="_blank">IELTS</a>
									...
									<p>
										For admissions to National Universities in Singapore (NUS, NTU,
										SMU) as well as applying to top programs like INSEAD, you
										essentially need to take your <a
											href="ielts" target="_blank">IELTS</a>
										or <a href="toefl" target="_blank">TOEFL</a>
									</p>
