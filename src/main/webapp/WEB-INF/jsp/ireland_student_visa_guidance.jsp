...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2019/05/Cork_Institute_of_Technology.jpg "
							alt="Master&#8217;s in Ireland" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Ireland Student Visa Guidance</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_ireland">Study in
										Ireland</a> &#187;  <span class="breadcrumb_last" aria-current="page">Ireland Student Visa Guidance</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
						<div class="entry-content">
							...
							<h1>Ireland Student Visa Guidance</h1>
							<p>&nbsp;</p>
							<p>Understand the Ireland Student Visa Guidance  and solve
								your queries.</p>
							<p>&nbsp;</p>
							<h2>When can I apply for an Irish student visa?</h2>
							<p>&nbsp;</p>
							<p>
								You can apply for a student visa for Ireland within <strong>3
									months </strong>to the course start date and can travel <strong>within
									30 days</strong> to the course start date. All applications for a
								student visa for Ireland must be made using the<a
									href="https://www.visas.inis.gov.ie/avats/OnlineHome.aspx">AVATS
										on-line facility</a> including from India.
							</p>
							<p>&nbsp;</p>
							<h3>Keep the following documents handy while taking applying
								online:</h3>
							<p>&nbsp;</p>
							<ul>
								<li>Passport and details of any previous passports –
									number, date of issue/expiry</li>
								<li>Details of any previous Irish visa applications</li>
								<li>Contact details for your host in Ireland ie. from your
									University</li>
								<li>Itinerary (if applicable) (it is not necessary to book
									the travel tickets before applying for a student visa for
									Ireland)</li>
							</ul>
							<p>Once you have filled this form, you will see a summary
								form (also known as summary sheet&#8217;). Take a print of it and
								follow the instructions on the summary form. You must sign
								this summary form dated along with the other documentation that
								you will be submitting to the VFS Ireland, in turn to the Irish
								Embassy in India.</p>
							<p>
								Book your appointment at VFS Ireland within 30 days from the
								date of filling the online application. You will need the <strong>application
									transaction number</strong> (available on the summary form that they
								generate after your online application) that you need to enter
								while taking the online appointment. Pay the visa application
								fee online.
							</p>
							<p>&nbsp;</p>
							<h2>Where to apply?</h2>
							<p>&nbsp;</p>
							<p>If there is an Irish Embassy, Consulate, Honorary Consul
								or Visa Office in your country of permanent residence you must
								apply there. Consulate of Ireland in Hyderabad is at Kamanwala
								Chambers, 2 Nd Floor Sir P M Road, Hyderabad G.p.o(fort) Hyderabad,
								Maharashtra 400001, India. Visa facilitation service (VFS)
								centres for applying for an Irish visa in India are available
								in: Hyderabad (North), Hyderabad (South), Ahmedabad, Bangalore,
								Chandigarh, Chennai, Cochin, Hyderabad, Jalandhar, Kolkata, New
								Delhi, Pune. You may require to go for a personal interview.</p>
							<h3></h3>
							<h2>Documents required for applying for an Irish student
								visa:</h2>
							<p>&nbsp;</p>
							<ul>
								<li>Two colour passport sized photographs not more than 6
									months old (photograph requirements are <a
										href="http://www.inis.gov.ie/en/INIS/Pages/Photograph Requirements">here</a>)
								</li>
								<li>Original Passport (should be valid for at least 12
									months after your proposed date of arrival in Ireland)</li>
								<li>The Visa Application forms and the summary form (that
									you will have printed after filling the online application at <a
										href="https://www.visas.inis.gov.ie/avats/OnlineHome.aspx">AVATS
											on-line facility</a>
								</li>
								<li>Letter of acceptance from the education institution</li>
								<li>All academic documents</li>
								<li><a href="ielts" target="_blank">IELTS</a>
									score report</li>
								<li>Police clearance Certificate</li>
								<li>Evidence of financial resources confirming that you
									have enough funds to cover your tuition and living expenses
									during your stay in Ireland (estimated living expense in
									Ireland for one academic year is Euro 7000)</li>
								<li>Evidence of fee payment made to the University (eg.
									Payment receipt from the University or a valid receipt that the
									course fee has been lodged with an approved fees payment
									service)</li>
								<li>Private Medical Insurance cover &#8211; your University
									may arrange this one your behalf and your letter of acceptance
									(admission letter) from the University must include this
									detail. If you have arranged it privately, then you must
									provide an evidence of it. How much medical cover is required
									is available
								</li>
								<li>Birth Certificate</li>
								<li>Information or confirmation of any previous Irish visa
									refusals</li>
							</ul>
							<p>All documents MUST be in ORIGINAL only. Keep a set of
								photocopy for your reference. Original documents such Birth
								Certificate, etc. will be returned. However, documents like bank
								statements or balance certificate may not be returned</p>
							<p>
								<strong>Note</strong>: There may be other documents that may be
								required based on your circumstances.
							</p>
							<p>&nbsp;</p>
							<h3>Visa Application Fee:</h3>
							<p>&nbsp;</p>
							<p>Cashier&#8217;s Order needs to pay the visa fees in favor
								of &#8220;Consulate General of Ireland, Hyderabad&#8221;. of Rs.
								5000/- approx (The applicable visa fee in Indian Rupees is as
								per the current exchange rate and is subject to change without
								notice).</p>
							<h3></h3>
							<h3>Visa Processing time:</h3>
							<p>&nbsp;</p>
							<p>You should allow as much time as possible when applying
								for a visa but a minimum time of 4 &#8211; 8 weeks for
								processing. Generally, you should have a decision in 4 to 6
								weeks.</p>
							<h3></h3>
							<h3>English Ability Requirements:</h3>
							<p>&nbsp;</p>
							<p>
								All applicant must show <a href="ielts">IELTS</a>
								/ or equivalent Score sheet for Visa.
							</p>
							<p>
								<strong>APPROVAL IN PRINCIPLE</strong>: If your course is a
								HETAC approved course (check with your college in Ireland), you
								do not have to pay fees in advance. If the authority approves
								your study visa then you need to pay the fees and evidence of
								the Electronic transfer. Also, you need to submit an original
								college receipt before the authority issues a visa. You should
								factor at least two extra weeks into the processing time if you
								wish to avail of this service. Otherwise fees will need to be
								paid in advance.
							</p>
							<p>&nbsp;</p>
						</div>
