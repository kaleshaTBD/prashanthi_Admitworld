							...
							<div class="container">
								...
								&#187; <span><a
									href="study_canada">Study in
										Canada</a> &#187;  <span class="breadcrumb_last" aria-current="page">Canada Education System</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
						...
						<div class="entry-content">
							<h1>Canada Education System</h1>
							<p>Canada Education System is good for Indian Students. Read
								some important points mentioned in the blog below.</p>
							<p>&nbsp;</p>
							<h2>Important Points of Canada Education System that you
								must know :</h2>
							<p>&nbsp;</p>
							<h3>Point 1 &#8211;</h3>
							<p>The education system in Canada encompasses both
								publicly-funded and private schools, including: colleges,
								secondary school, Universities and University Colleges.</p>
							<h3>Point 2 &#8211;</h3>
							<p>Education is a provincial responsibility under the
								Canadian constitution, which means there are significant
								differences between the education systems of the different
								provinces. However, education is important to Canadians, and
								standards across the country are uniformly high.</p>
							<h3>Point 3 &#8211;</h3>
							<p>In general, Canadian children attend kindergarten for one
								or two years at the age of four or five on a voluntary basis.
								All children begin Grade One at about six years of age.</p>
							<h3>Point 4 &#8211;</h3>
							<p>The school year normally runs from September through the
								following June but in some instances, January intake dates are
								possible. Secondary schools go up to Grades 11 or 12, depending
								on the province.</p>
							<h3>Point 5 &#8211;</h3>
							<p>From there, students may attend university, college or
								Cégep studies. Cégep is a French acronym for College of General
								and Vocational Education, and is two years of general or three
								years of technical education between high school and university.
								The province of Québec has the Cégep system. High Quality
								Education.</p>
							<h3>Point 6 &#8211;</h3>
							<p>Education institutions are not officially ranked in
								Canada, but you will find quality institutions across the
								country. When choosing your school in Canada, consider the type,
								size and location of the institution. If you are interested in a
								particular area of study, investigate which schools have more to
								offer in that discipline.</p>
							<p>
								<a href="contact_us" target="_blank"
									rel="noopener noreferrer">Contact us</a> if you want to study
								in Canada and get our admission counseling.
							</p>
						</div>
						<div id="how-can-we-help-eop">
							<h2 style="color: #c00026"> CANADA ADMISSION COUNSELING
							</h2>
											...
											<div class="tab-content">
												<div id="menu1" class="tab-pane fade in active">
													<p style="padding: 15px">We are experts at what we do.
														Since 2019, with prior experience of 14 years
														  we have helped 1000s of students (personally).
