							...
							<div class="container">
								<p id="breadcrumbs">
									<span><span><a href="index">Home</a>
											&#187; <span class="breadcrumb_last" aria-current="page">Study in Ireland</span></span></span>
								</p>
							</div>
						</div>
						<div id="why-study-in" style="background-color:#6dab3c">
							<div class="container">
								<h2 style="color:#fff">Why study in Ireland</h2>
								<div>
						<p>We&#8217;ve got a million reasons to give you. Let&#8217;s however
							categorically look at why you should study in Ireland when you
							are finalizing your study abroad plan.</p>
						<p style="margin-top: 10px;">
							<a href="why_study_in_ireland">Continue reading...</a>
						</p>
					</div>
							</div>
						</div>
					...
					<div id="left-area">
							...
							<div id="country-dashboard" style="margin-top:30px;marrgin-bottom:20px">
								...
								<div id="how-can-we-help-eop">
									<h2 style="color:#FD9601">Ireland Admission Counseling</h2>
