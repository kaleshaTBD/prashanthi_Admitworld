...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img src="wp-content/uploads/2018/11/canada-dubai-1242434_1920-1-e1543830109548.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Canada Admission Counseling</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_canada">Study in
										Canada</a> &#187;  <span class="breadcrumb_last" aria-current="page">Canada Admission Counseling</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
						...
						<div class="entry-content">
							...
							<h1>Canada Admission Counseling</h1>
							<p>In case you&#8217;re confused about your studies in CANADA, we
								...
								universities /colleges. With more discussions we&#8217;ll help you
								pick between them and narrow it down to the right selection of
								safe, moderate and ambitions options. We will make your process
								of studying in CANADA hassle-free.</p>
							<p>&nbsp;</p>
							...
							<p>We are extremely personal. Students ask us 1000s of
								...
								the service. We don&#8217;t count the number of hours spent on you.
								Admitworld don&#8217;t shed away responsibilities. We work on your side and
								have just one thing in mind-to get you your best in your career</p>
							<h2>Experience:</h2>
							<p>We are experts at what we do. We started in 2002 and have
								...
								will be, what kind of universities/colleges should be best
								suited for your future, what you need to do to get there</p>
							<h2>Insider Information:</h2>
							<p>We keep in touch with Universities and Colleges in Canada.
								We keep in touch with our past students. Admitworld knows exactly what
								a University will require or we can identify it very (very)
								easily. Our experts help you build your profile, craft a great
								resume, and statement of purpose (SOP)/essays and bring out the
								best in you while presenting you to a University/College.
								Chances of your admissions evidently rise because we are around</p>
							<h2>Total Solution:</h2>
							<p>
								We help you right from start to end in the process i.e. from
								selecting the right course and University/College list,
								documentation preparation, filling out and checking of forms,
								applying to Universities and Colleges, to securing admission
								offers, helping you finalize the best choice of
								University/College, visa guidance (including documentation, mock
								interview rounds, application), accommodation booking and much
								more. Hey! <a href="ielts"
									target="_blank">IELTS</a> coaching is also available at our
								centre. We are brilliant with our essay editing services
								(remember – you will have to end up writing 18 to 24 essays when
								you apply to 8 Universities and Colleges). We are simply there
								for everything!
							</p>
