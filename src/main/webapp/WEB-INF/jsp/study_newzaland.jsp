							...
							<div class="container">
								<p id="breadcrumbs">
									<span><span><a href="index">Home</a>
											&#187; <span class="breadcrumb_last" aria-current="page"> Study in New Zealand</span></span></span>
								</p>
							</div>
						</div>
						<div id="why-study-in" style="background-color:#21627c    !important">
							<div class="container">
								<h2 style="color:#fff !important">Why study in New Zealand</h2>
											<div>
									<p>New Zealand Tourism – that comes to mind when you think
										about studying in New Zealand isn’t it! Or perhaps you think
										about New Zealand as 2015’s Cricket World Cup finalists?</p>
									<p>Here are our simple reasons to tell you that New Zealand
										can be your best study destination:</p>
									<p>
										<strong>Top Education + Work during Study + Work after
											Study + Migrate</strong>
									</p>
									<p style="margin-top: 10px;">
										<a href="why_study_in_new_zealand">Continue
											reading...</a>
									</p>
								</div>
							</div>
							...
							<div id="country-dashboard" style="margin-top:30px;marrgin-bottom:20px">
													...
													<div class="tab-content">
														<div
															id="menu1" class="tab-pane fade in active">
																<p style="padding:15px">We are experts at what we do. Since 2019 , with prior experience of 14 yearswe have
								...
								<div>
									       <div class="et_pb_row et_pb_column_1" style="margin-top:20px;margin-bottom:20px">
														        <div class="et_pb_row">
														            <div class="col-md-12">
														                <h3 style="color:#6DAB3C;text-align:center;font-size:29px">
														                    Wall of Fame</h3>
