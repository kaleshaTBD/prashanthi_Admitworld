...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2018/11/study-in-dubai-banner-e1543830416186.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Tests Required to Apply to Dubai</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_dubai">Study in
										Dubai</a> &#187;  <span class="breadcrumb_last" aria-current="page">Tests Required to Apply to Dubai</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
							...
							<div class="entry-content">
									<h3>Bachelor’s in Dubai</h3>
									<p>
										Admissions for undergraduate or <a
											href="bachelors_in_dubai">Bachelors in Dubai</a>
										study for international students in Dubai requires a minimum of
										12 years of schooling. Some universities like the Al Ghurair
										University, University of Wollongong in Dubai and Middlesex
										University Dubai requires a minimum percentage of 50% to 60% if
										you are coming from CBSE or ISC board. The student must also
										fulfil English language requirements by either obtaining a
										cut-off score in <a href="ielts"
											target="_blank">IELTS</a> and <a
											href="toefl" target="_blank">TOEFL</a>
										or securing 70% marks in English. <a
											href="sat1"
											target="_blank">SAT</a> is NOT required to apply to
										Universities in Dubai, however certain universities may require
										it based on student profile and program applied for.
									</p>
									<p>&nbsp;</p>
									<h3>Master’s in Dubai:</h3>
									<p>
										Almost all universities and colleges accept students with a
										diverse range of qualifications and backgrounds. To get
										admission to any postgraduate program, one must have a
										bachelor&#8217;s degree that is recognized in Dubai and the home
										country. Foreign universities with branches in Dubai look for
										qualifications similar to that in their country. For example
										Murdoch University Dubai looks for postgraduate qualification
										that meets the same academic standards as an Australian three
										year bachelor degree. However, it does not mean it has to be an
										Australian degree. For admission to programs other than an <a
											href="mba_in_dubai">MBA in Dubai,</a> one needs
										bachelor&#8217;s degree along with TOEL or <a
											href="ielts" target="_blank">IELTS</a>.
										If a student wants to seek admission to an MBA program in Dubai,
										he/she should have relevant work experience of 2-4 years
										depending upon the program and the university they have applied.
									</p>
									<p>
