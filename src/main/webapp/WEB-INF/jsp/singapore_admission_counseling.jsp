...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2018/11/singapore-217990_1920-e1543827286311.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Singapore Admission Counseling</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_singapore">Study in
										Singapore</a> &#187;  <span class="breadcrumb_last" aria-current="page">Singapore Admission Counseling</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h3>
										<strong>Here’s what we get in to a discussion about g</strong><strong>enerally:</strong>
									</h3>
									<ul>
										<li>Why do you wish to study abroad? Have you compared
											different options available around the world?</li>
										<li>Is it the right time for you to study abroad? Or should
											you go later, perhaps after some work experience?</li>
										<li>What are you short and long-term career objectives?</li>
										<li>Your current profile, are you happy with it? What
											better could have helped you?</li>
										<li>Your work experience if any</li>
										<li>How has your academic profile to date shaped up well?
											In which areas could you improve your profile?</li>
										<li>Your budget? Or requirement of a scholarship?</li>
										<li>About Universities in Singapore and elsewhere around
											the world</li>
										<li>The best Universities in order of priority to apply to</li>
										<li>Work rules in different countries so that your future
											plans do not go for a toss</li>
										<li>Your reason to select a specific course? Otherwise we
											help you select the right one</li>
									</ul>
									<p>&nbsp;</p>
									<p>…so much more happens over a discussion</p>
									<p>
										<span style="font-weight: normal!msorm;"><strong>We
												basically help you draw a career path for the next 5 to 7
												years and not only your immediate goal post your higher
												education abroad</strong></span>
									</p>
									<p>&nbsp;</p>
									<h3></h3>
									<h2>
										<strong>Step-wise process of how we will help you:</strong>
									</h2>
									<p>&nbsp;</p>
									<h4>Consulting:</h4>
									<p>We explain the complete process of pursuing undergraduate
										studies in Singapore. We assess your profile and understand your
										suitability to study in Singapore. We suggest areas of profile
										development and guide right through the process from start to
										end</p>
									<p>
										<strong> </strong>
									</p>
									...
									<p>
										...
										Bachelors programs in Singapore you must apply to. This is very
									...
									<p>
										We guide you with your documents required for applying to
										Bachelors programs in Singapore. This includes helping you build
										...
										consulting in the country and <strong>essay editing</strong> is
										our forte
									</p>
									<p>
										<strong> </strong>
									...
									<p>Once your offers are in, we help you finalize on the right
										program for you. Often students face a dilemma at this stage
									...
									<p>Studying abroad is a crucial decision and we know that. We
										want that you use our experience in and join the perfect
									...
									<p>
										...
										join your dream University and even get in to your
										accommodation, we will guide you.
									</p>
