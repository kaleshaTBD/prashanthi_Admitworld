...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2018/11/new-zealand-lighthouse-93487_1920-e1543828230448.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Education System in New Zealand</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_newzaland">Study in
										New Zealand</a> &#187;  <span class="breadcrumb_last" aria-current="page">Education System in New Zealand</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
							<div class="entry-content">
									<h2>New Zealand has following types of Institutions:</h2>
									<p>&nbsp;</p>
									<h4>8 universities</h4>
									<h4>18 polytechnics and institutes of technology</h4>
									<h4>around 700 private training institutions</h4>
									<h4>27 English Language schools</h4>
									<h4>around 20 industry training organisations</h4>
									<p>&nbsp;</p>
									<p>&nbsp;</p>
									<h3>Universities in New Zealand:</h3>
									<p>offer a broad range of subjects for undergraduate, Masters
										and Doctoral (PhD) degrees in commerce, science and the
										humanities. Several universities have more than one campus,
										often located in different cities, and some have overseas
										programs.</p>
									<p>University education was established in New Zealand in
										1870 and has a similar tradition to the British university
										system. All 8 Universities in New Zealand are internationally
										renowned. New Zealand universities are ranked in the top 3% in
										the World (QS World Rankings)</p>
									<p>&nbsp;</p>
									<h3>Institutes of Technology and Polytechnics in New
										Zealand:</h3>
									<p>provide professional and vocational education and training
										ranging from introductory studies through to full degree
										programs. Many Institutes of Technology and Polytechnics in New
										Zealand also offer English language training and postgraduate
										study options, including up to Doctoral (PhD) level. Courses at
										Institutes of Technology and Polytechnics in New Zealand offer
										courses that are vocationally oriented, with emphasis on
										practical training. The courses at ITPs are informed by industry
										and employers to ensure their relevance. This also helps job
										opportunities when one graduates. A degree from one of these
										institutions has equal status with a university degree.</p>
									<p>New Zealand’s ITPs and universities are public
										institutions. To get funding and support they have to meet
										standards of excellence from the government</p>
									<p>&nbsp;</p>
									<h3>Private Training Institutions and English Language
										Schools:</h3>
									<p>700 registered Private Training Establishments (PTEs)
										offer courses that are generally specific to English language
										learning or niche occupations such as travel and tourism, design
										and ICT. Most PTEs provide certificate and diploma level
										qualifications, but some also deliver Bachelor and Masters
										degrees. They may sometimes have 3 to 4 intakes in a year.</p>
									<p>&nbsp;</p>
								</div>
