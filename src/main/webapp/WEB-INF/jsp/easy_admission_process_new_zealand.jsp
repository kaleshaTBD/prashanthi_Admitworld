...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2018/11/new-zealand-auckland-216820-e1543828442997.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Easy Admission Process &#8211; New Zealand</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_newzaland">Study in
										New Zealand</a> &#187;  <span class="breadcrumb_last" aria-current="page">Easy Admission Process &#8211; New Zealand</span></span></span></span>
					...
					<div id="left-area">
									...
									<table width="864">
										<tbody>
											<tr>
												<td>STEPS</td>
												<td width="419">Your DIY Kit | To do list to study in New
													Zealand</td>
												<td width="384">When we are around</td>
											</tr>
											<tr>
												<td>STEP 1</td>
												<td width="419"><strong>SEARCH</strong> &#8211; 100s of
													websites, all universities, specific courses. Here’s a <a
													href="new_zealand_universites">list
														of Universities in New Zealand</a> to give you a start</td>
												<td width="384"></td>
											</tr>
											<tr>
												<td>STEP 2</td>
												<td width="419"><strong>SHORTLIST</strong> &#8211; the
													right programme at the right list of Universities in New
													Zealand matching your academic background, test score,
											...
											<tr>
												...
												<td width="419"><strong>COLLECT</strong> &#8211;
													...
													(SOP), getting recommendations from the right referees, more.
													Here’s a <a
													href="application_requirements_documents_new_zealand">list
														of documents required to study in New Zealand</a> to start with</td>
												<td width="384"></td>
											</tr>
											<tr>
												<td>STEP 4</td>
											...
											<tr>
												<td>STEP 7</td>
												<td width="419"><strong>FINALIZE</strong> &#8211; make a
													final decision when you have more than one offer. Generally
													students apply to several Universities and you are bound to
													face this stage. Crucially important is, that you make the
													right decision</td>
												<td width="384"></td>
											</tr>
											<tr>
												...
												<td width="419"><strong>DEPOSIT</strong> and <strong>FEE
														PAYMENT</strong> &#8211; pay your deposit or enrolment fee in Euros
													to the University, wait for a confirmation, or follow up with
													the University. Book your medical insurance – it is mandatory
													in Germany</td>
												<td width="384"></td>
											</tr>
											<tr>
												<td>STEP 9</td>
												<td width="419"><strong>VISA</strong> &#8211; understand
													the student visa process, gather the right documents and
													check them thoroughly, book a visa appointment, present
													yourself rightly, wait for the decision. Here’s where you
													will information about the <a
													href="new_zealand_student_visa_guidance">visa
														process and documentation</a>. During this time, decide on where
													you will live, what to pack before going, buy forex, medical
											...
											<tr>
												<td>STEP 12</td>
												<td width="419"><strong>FLY</strong> &#8211; book tickets
													and fly. Ensure that you have collected details about how to
													open a bank account, about travelling locally in Germany,
													carried important documents along with you, bought the
													required forex and such other important information that
													comes up ONLY in the end</td>
												<td width="384"></td>
											</tr>
										</tbody>
									</table>
