							...
							<div class="container">
								...
								&#187; <span><a
									href="study_uk">Study in
										UK</a> &#187;  <span class="breadcrumb_last" aria-current="page">UK Counseling Packages</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					...
					<div class="entry-content">
						<p>It is FREE. We do not charge if you wish to apply to only
							UK Institutions through us. In fact, we SAVE you some application
							fee, your cost of couriers etc. in many cases</p>
						<p> </p>
						<h3>Our UK Education Counselling services will include:</h3>
						<ul>
							<li><p>Consulting and understanding your requirements
									(course interest, location, budget, future plans, etc.)</p></li>
							<li><p>Shortlisting and selecting the right set of UK
									Universities</p></li>
							<li><p>Documentation help and providing samples of CV,
									recommendation letters, statement of purpose etc.</p></li>
							<li><p>Applications to all UK Universities – we will be
									doing this on your behalf</p></li>
							<li><p>Following up with UK Universities for your offers
									or any other requirements</p></li>
							<li><p>Securing admission offers and helping you
									finalize the University</p></li>
							<li><p>Helping you with UK Scholarship applications and
									/ or education loans</p></li>
							<li><p>Guiding you on financial matters (fee payments to
									universities, financials required for UK student visa
									applications, etc.)</p></li>
							<li><p>UK Visa process help – including helping you with
									the documentation, student visa appointment, etc.</p></li>
							<li><p>Pre-departure brief where we will tell you about
									the life and living in Australia and much more</p></li>
							<li><p>Booking of accommodation, buying forex, flight
									tickets, etc.</p></li>
						</ul>
						<p> </p>
						...
						<ol>
							<li><p>We’ve got over 12 years experience in placing
									students abroad and you will be counselled by someone who has
									previously studied in the UK to share real-time experiences and
									support</p></li>
							<li><p>We’ve visited the UK and have seen most of the
									Universities and Institutions. We’ve met with University
									officials and we keep connecting with British Universities
									often to get you the perfect information</p></li>
							<li><p>We’ve understood the difference between studying
									in the UK vis-a-vis another country and we can guide you
									extremely well – Use Our Experience</p></li>
							<li><p>We help you right from start to end in the
									process of applying to UK Colleges and Universities and
									thereafter with the visa process, helping you book the
									accommodation, buy forex, and much more</p></li>
							<li><p>We’ve already mentioned about – we help you for
									FREE and we SAVE you your application fee sometimes</p></li>
						</ol>
						<p>
							You can check out our <a
								href="uk_admission_counseling" target="_blank"
								rel="noopener"><strong>UK Admission Counselling</strong></a> to
							get more information on how we will help
						</p>
					</div>
													...
													<div>
														...
														<div class="box-list-wrapper">
															<ul>
																...
																<li><a
																	href="application_requirements_documents_uk">Admission Documents for Masters/MBA in UK</a></li>
																<li><a
																	href="admission_req_bachelors">Admission requirements for Bachelors in UK</a></li>
																	<li><a
