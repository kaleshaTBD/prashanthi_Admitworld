...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2019/09/study-in-new-zealand-banner.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>MBA in New Zealand</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_newzaland">Study in
										New Zealand</a> &#187;  <span class="breadcrumb_last" aria-current="page">MBA in New Zealand</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h1>
										<strong>MBA in New Zealand</strong>
									</h1>
									<p>&nbsp;</p>
									<h2>Quick Notes on studying MBA in New Zealand:</h2>
									<p>&nbsp;</p>
									<h3>Duration of MBA in New Zealand:</h3>
									<p>MBA programs in New Zealand are between 1 and 2 years in
										duration with generally most MBAs being of 1.5 years</p>
									<p>&nbsp;</p>
									<h3>Work Experience for MBA in New Zealand:</h3>
									<p>Most MBA programmes in New Zealand require between 2 and 5
										years of work experience after your graduation. Students who do
										not qualify for an MBA in New Zealand because of lack of work
										experience generally take up a Post Graduate Diploma in New
										Zealand</p>
									<p>&nbsp;</p>
									<h3>
									...
									<p>
										MBA in New Zealand requires a <a
											href="gmat" target="_blank">GMAT</a> eg.
										Canterbury University in New Zealand requires a minimum <a
											href="gmat" target="_blank">GMAT</a> of
										600 while University of Otago and Victoria University of
										Wellington will require at least 550 in <a
											href="gmat" target="_blank">GMAT</a>.
										There are some programs that do not essentially require <a
											href="gmat" target="_blank">GMAT</a> eg.
										Auckland Institute of Studies (AIT St Helen) may accept a
										student on an MBA without <a href="gmat"
											target="_blank">GMAT</a>
									</p>
									<p>&nbsp;</p>
									<p>Students mostly opt for studying Masters in New Zealand
										rather than an MBA. This is especially considering that since
										most MBAs need high level of work experience, your employability
										in New Zealand after the MBA is better once you have gathered
										good amount of work experience</p>
									<p>&nbsp;</p>
									<h3>English Language Requirement:</h3>
									<p>
										You need to appear for an <a href="ielts"
											target="_blank">IELTS</a> test and the recommended score is 6.5
										band overall with no individual module being lower then 5.5
										band.
									</p>
									<p>&nbsp;</p>
									<p>
										You could register, prepare and appear for this test in about a
										month’s time from the time you decide to take one. 2 to 3 <a
											href="ielts" target="_blank">IELTS</a>
										test dates are available each month. If you wish to register for
										the <a href="ielts" target="_blank">IELTS</a>
										test, you can <a href="contact_us"
											target="_blank" rel="noopener noreferrer">contact us</a> and we
										can help you (for free)
									</p>
									<p>&nbsp;</p>
									<h3>15 Years Education Accepted for MBA:</h3>
									<p>If you wish to study an MBA in New Zealand or a New
										Zealand Masters, you can directly apply after your Bachelors.
										This means you will immediately start your Masters in Zealand in
										the same year that you finish your degree program in India</p>
									<p>&nbsp;</p>
									<h3>Work in New Zealand during studies:</h3>
									<p>
										You can work up to 20 hrs per week (like most other countries)
										during study period and full-time (generally 40 hrs per week)
										during scheduled holidays. You can take care of your living
										expenses this way (min. wage is <a
											href="https://www.xe.com/currencyconverter/convert/?Amount=1&amp;From=NZD&amp;To=INR"
											target="_blank" rel="noopener noreferrer">NZ $</a>12 per hour)
									</p>
									<p>&nbsp;</p>
									<h3>Work in New Zealand after studies (Job Search Visa in
										New Zealand):</h3>
									<p>After successful course completion, you will automatically
										get a 12 months &#8216;Work Permit&#8217;. You can work
										full-time in any job of your choice. But remember, if you are
										aiming a NZ Permanent Residency, then you have to find a job
										relevant to your course (that you have completed in NZ).</p>
									<p>&nbsp;</p>
									<h2>Some MBA programs in New Zealand are listed below:</h2>
									<p>&nbsp;</p>
									<table width="1231">
										<tbody>
											<tr>
												<td width="371"><strong>University</strong></td>
												<td width="151">Location</td>
												<td width="64">Course</td>
												<td width="303">Duration</td>
												<td width="64">Work Experience Requirement</td>
												<td width="154"><a href="gmat"
													target="_blank">GMAT</a></td>
												<td width="124">Fees</td>
											</tr>
											<tr>
												<td><strong>Auckland University of Technology
														AUT New Zealand</strong></td>
												<td>Auckland New Zealand</td>
												<td>MBA</td>
												<td>12 to 18 months</td>
												<td>5 years</td>
												<td>May be required for students who have not finished
													their bachelors in NZ</td>
												<td>NZ$46,410</td>
											</tr>
											<tr>
												<td><strong>Canterbury University New Zealand</strong></td>
												<td>Christchurch New Zealand</td>
												<td>MBA</td>
												<td>15 months</td>
												<td>5 years</td>
												<td><a href="gmat" target="_blank">GMAT</a>
													of 600 is required</td>
												<td>NZ$51,396</td>
											</tr>
											<tr>
												<td><strong>University of Auckland New Zealand</strong></td>
												<td>Auckland New Zealand</td>
												<td>MBA</td>
												<td width="303">is only available part time. Students can
													do the Post Graduate Diploma in Business for 2 years and
													thereafter spend another year to complete the MBA. The
													average age of students in class is 32 years with 11 years of
													experience approx.</td>
												<td></td>
												<td width="154"></td>
												<td></td>
											</tr>
											<tr>
												<td><strong>University of Otago New Zealand</strong></td>
												<td>Otago New Zealand</td>
												<td>MBA</td>
												<td>14 to 20 months</td>
												<td>3 years</td>
												<td><a href="gmat" target="_blank">GMAT</a>
													550 is required</td>
												<td>NZ$45240</td>
											...
											<tr>
												<td><strong>Victoria University of Wellington
														New Zealand</strong></td>
												<td>Victoria New Zealand</td>
												<td>MBA</td>
												<td>16 months</td>
												<td>5 years</td>
												<td><a href="gmat" target="_blank">GMAT</a>
											...
											<tr>
												<td><strong>UUNZ Institute of Business New
														Zealand</strong></td>
												<td>Auckland New Zealand</td>
												<td>MBA</td>
												<td>18 to 24 months</td>
												<td>3 years but depends from case to case</td>
												<td><a href="gmat" target="_blank">GMAT</a>
													not required</td>
												<td>NZ$3000 per paper</td>
											</tr>
											<tr>
												<td><strong>Auckland Institute of Studies (AIT
														St Helen) New Zealand</strong></td>
												<td>Auckland New Zealand</td>
											...
											<tr>
												<td><strong>Auckland Institute of Studies (AIT
														St Helen) New Zealand</strong></td>
												<td>Auckland New Zealand</td>
												<td>MBA Operations and Logistics</td>
												<td>18 months</td>
												<td>2 years</td>
												<td><a href="gmat" target="_blank">GMAT</a>
													not required</td>
