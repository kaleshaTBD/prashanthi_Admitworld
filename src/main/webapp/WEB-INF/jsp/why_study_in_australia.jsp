...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2018/11/australia-sydney-363244-e1543833838366.jpg"
						...
						<div id="breadcrumbs-wrapper">
							<div class="container">
								...
								&#187; <span><a
									href="study_australia">Study in
										Australia</a> &#187;  <span class="breadcrumb_last" aria-current="page">Why study in Australia?</span></span></span></span>
						...
						<div id="why-study-in" >
										<div class="container">
								<h1>
									<strong>Why study in Australia?</strong>
								</h1>
								<p>Here are our simple reasons to tell you that if you decide
									to study in Australia, you are making a great choice:</p>
								<h2>Suitable Climate + Top Education + Work during Study +
									Work after Study + Australia Immigration</h2>
								<p>&nbsp;</p>
								<h3>15 Years Education Accepted:</h3>
								<p>If you wish to study an MBA in Australia or an Masters in
									Australia, you can directly apply after your Bachelors. You can
									immediately start your Masters level study in Australia in the
									same year that you finish your degree program in India since the
									Indian 3 years Bachelors is accepted by all Australian
									Universities.</p>
								<h3>Work in Australia DURING studies:</h3>
								<p>You can work up to 20 hrs per week (like most other
									countries) during study period and full-time (generally 40 hrs per
									week) during vacations (and it’s visibly mentioned on your student
									visa too). Also, you can take care of your living expenses this
									way (On an average a student can earn around A$ 12 per hour.
									Casual jobs are available (A$15-18 per hour) as part-time work
									option).</p>
								<h3>Work in Australia after studies (Post Study Work Visa in
									Australia):</h3>
								<p>
									The &#8216;post study work visa&#8217; allows Indian students to
									work in Australia after completing their Masters (MS, MBA etc),
									Bachelors or Doctoral (PhD) degree. You should <strong>have
										at least two years of academic study in Australia at the
										Bachelors level or above</strong> (Bachelors, Masters (or MBA) or PhD
									level). The subject area of your study does not affect the Post
									Study Work Visa. You can complete your studies in any field to be
									eligible to apply for the Australian work permit.
								</p>
								<h3>English Speaking Country:</h3>
								<p>Australia being an English speaking country, this is a great
									advantage for Indian students. Eventually networking and making
									connections take you a long way in a new country.</p>
								<h3>Quality of Education and Flexibility:</h3>
								<p>
									Quality of Australian education is known to all and you are no
									exception. Education Services for Overseas Students (ESOS) <a
										href="act" target="_blank">Act</a> 2000
									ensures that Institutions who enroll international students are
									registered with Commonwealth Register of Institutions and Courses
									for Overseas Students (CRICOS). This ensures that Institutions
									meet stringent standards, for marketing activities, education
									delivery, facilities and student support services.
								</p>
								<p>The Australian Qualifications Framework (AQF) links 15
									school, vocational and university education qualifications into
									one national system. This allows you to move towards the next
									level of study easily and importantly, the flexibility to also
									change your Institution. If you’re studying an AQF qualification,
									you can be sure that your institution is Government-authorised and
									nationally accredited, and that your Degree or other AQF
									qualification will be genuine. The AQF makes it easy for overseas
									governments to recognise your qualification.</p>
								<p>Did you know that Australia has 8 of the top universities in
									the world? Employers and schools all over the world recognize
									degrees from Australian universities.  The Australian education
									system is very well regulated by their government to maintain high
									standards of education; something which Australia is famous for.
									Australian graduates are known to be confident and have the skills
									demanded by their employers. The teaching system in Australia aims
									to deliver realistic and career oriented skills to students.</p>
								<h3>Climate in Australia:</h3>
								<p>You definitely will not feel very cold. Many Indian students
									specifically prefer to study in Australia for this reason.
									Believable?</p>
								<h3>Duration of study in Australia:</h3>
								<p>Most Australian courses are of shorter duration. You can
									complete the degree courses in 3 years or even less if the
									education provider works on a trimester system. Did you know that
									several MBA programs ( in which you don&#8217;t need any work
									experience) are only of 1.5 years.</p>
								<h3>Costs, Affordability and ROI:</h3>
								<p>Both – course fees and living expenses are cheaper as
									compared to many other popular study destinations. The shorter
									duration of the course also saves money. Additionally, like we
									have mentioned above, you can work part time. Part time jobs in
									Australia are easily available. Again, after your studies in
									Australia, you can have a 2 years post study work permit.
									Thereafter, if you are working in a sector which is under
									Australia’s shortage occupations list, Australian immigration is
									the way forward.</p>
								<h3>Courses in Australia:</h3>
								<p>Australia covers almost all available study areas, ranging
									from natural sciences to life &amp; agricultural sciences,
									mathematics to clinical medicine &amp; pharmacy and physics. The
									Institutions have 22,000 plus courses to offer in their 1100
									institutions.</p>
								<p>
									If you are planning to study in Australia then reach out to <a
										href="contact_us">us</a>. As we provide
									admission counseling to our students to study abroad.
								</p>
								<p>&nbsp;</p>
								<h2>More about Why Study in Australia? Beyond work and top
									academics, here’s more:</h2>
								<ul style="color:#000">
									<li>Standard of living among the highest in the world</li>
									<li>Multicultural society &#8211; you wouldn&#8217;t ever
										feel left out</li>
									<li>Excellent Climate &#8211; not too hot not too cold, just
										how we Indians like it</li>
									<li>Clear blue seas</li>
									<li>unique and wonderful flora and fauna</li>
									<li>vibrant, beautiful and multicultural cities</li>
									<li>great weather</li>
									<li>amazing and diverse landscapes and scenery</li>
									<li>the amazing night life</li>
								</ul>
								<p>&nbsp;</p>
								<h2>Can you believe?</h2>
								<p>Australia is the 6th largest country in the world (same size
									as the 48 mainland states &#8211; USA; 50 percent larger than
									Europe), but has the lowest population density in the world
									&#8211; only 2 people per sq. km. It has a population of 20
									million only (is that as much as Mumbai?).</p>
