...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2019/08/Victoria-University-of-Wellington-New-Zealand.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Tests Required to Apply to New Zealand</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_newzaland">Study in
										New Zealand</a> &#187;  <span class="breadcrumb_last" aria-current="page">Tests Required to Apply to New Zealand</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<p>
										One of the English tests, ie. either <a
									...
									<p>&nbsp;</p>
									<h3>Score for studying Bachelors:</h3>
									<p>The recommended score is 6.0 band overall with no less
										than 5.5 band in the individual modules (Reading, Writing,
										Listening, Speaking). You can however apply with an overall
										score 5.5 band to several Institutions</p>
									<p>&nbsp;</p>
									<h3>Score for studying Masters / MBA:</h3>
									<p>The recommended score is 6.5 band overall with no less
										than 5.5 band in the individual modules (Reading, Writing,
										Listening, Speaking). You can   however apply with an overall
										score 6.0 band to several Institutions</p>
									<p>&nbsp;</p>
									<h4>
										<a href="sat1"
											target="_blank">SAT</a> Test:
									</h4>
									<p>
										No <a href="sat1"
											target="_blank">SAT</a> is required for studying Bachelors in
										New Zealand
									</p>
									<h4>
										<a href="gre" target="_blank">GRE</a> / <a
											href="gmat" target="_blank">GMAT</a>
										Test:
									</h4>
									<p>
										No <a href="gre" target="_blank">GRE</a>
										/ <a href="gmat" target="_blank">GMAT</a>
										test is required for studying Masters in New Zealand. <a
											href="gmat" target="_blank">GMAT</a> may
										be required by only some Universities for applying to their MBA
										program
									</p>
								</div>
