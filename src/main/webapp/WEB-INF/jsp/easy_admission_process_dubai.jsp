			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Easy Admission Process – Dubai</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_dubai">Study in
										Dubai</a> &#187;  <span class="breadcrumb_last" aria-current="page">Easy Admission Process – Dubai</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h2>The most important point that needs to be in place –
										You’re Passport and you’re good to go…!</h2>
									<h2></h2>
									<h3>Initial Opinion:</h3>
									<p>With insightful experience in counselling students, we
										make an assessment of academic qualifications, work experience,
										financial status, career goals as well as life interests and
										aspirations. We evaluate the requirement of any standardised
										tests you may need to take or review results that has been
										already obtained</p>
									<p>&nbsp;</p>
									<table width="864">
										<tbody>
											<tr>
												...
												<td width="419"><strong>Your DIY Kit | To do
														list to study in Dubai</strong></td>
											...
											<tr>
												...
												<td width="419"><strong>SEARCH:</strong> 100s of
													...
													href="dubai_universites">list
														of Universities</a> in Dubai to give you a start</td>
												<td width="384"></td>
											</tr>
											<tr>
												<td>STEP 2</td>
												<td width="419"><strong>SHORTLIST: </strong>The right
													course and the right list of Universities matching your
													academic background, test score, budget, other requirements.
													</p>
													<p>
											...
											<tr>
												...
												<td width="419"><strong>COLLECT</strong> &#8211;
													...
													Here’s a list of <a
													href="application_requirements_documents_dubai">documents
														required to study in Dubai</a> to start with</td>
												<td width="384"></td>
											</tr>
											<tr>
												<td>STEP 4</td>
											...
											<tr>
												<td>STEP 6</td>
												<td width="419"><strong>TRACK</strong> and <strong>FOLLOW</strong>
													<strong>UP</strong> &#8211; track your emails, wait for the
													decisions, or update the missing documents, understand the
													next round of process, etc.</td>
												<td width="384"></td>
											</tr>
											<tr>
												<td>STEP 7</td>
											...
											<tr>
												<td>STEP 8</td>
												<td width="419"><strong>DEPOSIT</strong> and <strong>FEE</strong>
													<strong>PAYMENT</strong> &#8211; pay your deposit or
													enrolment fee in Dubai Dollars to the University, wait for a
													confirmation, or follow up with the University. Book your
													Health insurance – it is advisable</td>
												<td width="384"></td>
											</tr>
											<tr>
												<td>STEP 9</td>
												<td width="419"><strong>VISA</strong> &#8211; understand
													...
													href="dubai_student_visa_guidance">visa
											...
											<tr>
												...
												<td width="419"><strong>FLY</strong> &#8211; book tickets
													...
													open a bank account, about travelling locally in Dubai,
