...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img src="wp-content/uploads/2019/08/Lakehead-University-Canada-1.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Application Requirements for Canada</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_canada">Study in
										Canada</a> &#187;  <span class="breadcrumb_last" aria-current="page">Application Requirements for Canada</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
						...
						<div class="entry-content">
							...
							<h1>Application Requirements for Canada</h1>
							<p>&nbsp;</p>
							<h2>Documents Requirement as part of Application
								Requirements for Canada are as follows:</h2>
							<p>&nbsp;</p>
							<h3>Resume &#8211;</h3>
							<p>Updated, 1 page, using action verbs. Skip the “objective”
								but mention your 12th marks.</p>
							<p>&nbsp;</p>
							...
							<h3>Transcripts &#8211;</h3>
							<p>
								Std. 10, Std. 11 &amp; 12, Bachelor&#8217;s, Master&#8217;s &#8211; you need
								to go to your institute and ask them to issue transcripts. Get 1
								per university you&#8217;re applying to. They will be stamped &amp;
								signed, and then sealed in an envelope which also needs to be
								stamped and signed. Ensure the transcript states your medium of
								instruction was English &#8211; this way some of your institutes
								may waive the <a href="toefl"
									target="_blank">TOEFL</a> requirement.
							</p>
							<p>&nbsp;</p>
							<h3>Referees &#8211;</h3>
							<p>You will have to add the title, full name, designation,
								company name and official email ID of your referees to the
								online application. They will then get an email from the
								university with a link they need to click on to recommend you.
								Half of this is usually a rating scale and the other half is
								either a text box or specific questions about you need to be
								answered. Please pick referees who will be comfortable doing
								this all online and who have an official email ID. Tip: It&#8217;s
								more important for your immediate manager to be your referee as
								opposed to the Director of the company who has barely had any
								interaction with you.</p>
							<p>&nbsp;</p>
							<h3>Personal Statement / Statement of Purpose &#8211;</h3>
							<p>Should address 5 main questions: What motivates you to do
								this course? What prepares you to do this course? Why do you
								want to do this particular degree? Why do you want to study at
								this particular institute? What are your career plans? This
								should neither be an autobiography nor exceed 2 pages in length.
								Often, the university will tell you what information they want
								and what the word/character limit on the question is.</p>
							<p>&nbsp;</p>
							<h3>Essays &#8211;</h3>
							<p>Universities will also ask you topical questions with
								corresponding word limits. Usually, universities that ask for
								these won&#8217;t ask for a personal statement.</p>
							<p>&nbsp;</p>
							<h3>Work Experience or Internship Letters &#8211;</h3>
							<p>To strengthen your profile you must submit any work
								experience letters, internship certificates, summer jobs
								certificate etc.</p>
							<p>&nbsp;</p>
							<h3>Score Reports &#8211;</h3>
							<p>
								Test takers reports of the<a href="ielts"
									target="_blank" rel="noopener noreferrer"> IELTS</a>, <a
									href="toefl"
									target="_blank" rel="noopener noreferrer">TOEFL</a>, <a
									href="gre" target="_blank"
									rel="noopener noreferrer">GRE</a>,<a
									href="gmat" target="_blank"
									rel="noopener noreferrer"> GMAT</a> etc. If you haven&#8217;t taken
								the test yet, update the test date in the application. These
								scores will have to be reported to the universities officially
								as well e.g. <a href="toefl"
									target="_blank">TOEFL</a> scores can be reported online by ETS
								to the university, after making the payment and entering the
								university code.
							</p>
							<p>&nbsp;</p>
							<h3>Certificated &#8211;</h3>
							<p>Extracurricular activities, social work, volunteer work,
								...
								(unless it&#8217;s a workshop, seminar or the like). Keep to the
								certificates you earned 9th standard onward, unless it&#8217;s at the
								inter-state level.</p>
							<p>&nbsp;</p>
							<h3>Passport &#8211;</h3>
							...
							<p>&nbsp;</p>
							<h3>Photo &#8211;</h3>
							<p>Passport sized photograph where you&#8217;re formally dressed.</p>
							<p>&nbsp;</p>
							<h3>Financial Documents:</h3>
							<p>(i) Bank statement showing adequate funds (1st year
								tuition + cost of living)</p>
							<p>(ii) Affidavit of Support if someone else, e.g. your
								parents, grandparents, aunt &amp; uncle etc. are sponsoring you.</p>
							<p>(iii) financial certification form (which is sometimes
								given by the university and needs to be filled up as requested)</p>
							<p>&nbsp;</p>
							<h3>Credential Evaluation &#8211;</h3>
							<p>
								Some universities may ask for an “academic credential
								evaluation” or a “course by course evaluation”. This needs to be
								done through WES as required by the university. You will have to
								send your academic documents to these bodies who, for a fee of
								between CAD<a
									href="https://www.xe.com/currencyconverter/convert/?Amount=1&amp;From=CAD&amp;To=INR"
									target="_blank" rel="noopener noreferrer">$</a> 245, will
								convert your scores to the Canadian Grading system. They will
								then report these scores to the universities you ask them to for
								an additional fee.
							</p>
							<p>&nbsp;</p>
							<p>Please keep in mind that this is a general checklist, more
								or fewer documents may be required based on the universities
								requirements. In case of a courier, you will need to attest
								these or send originals of some documents, like transcripts.</p>
						</div>
