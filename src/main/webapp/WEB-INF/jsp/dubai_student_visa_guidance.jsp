			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Dubai Student Visa Guidance</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_dubai">Study in
										Dubai</a> &#187;  <span class="breadcrumb_last" aria-current="page">Dubai Student Visa Guidance</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<p>Students attending a tertiary level university, college or
										institute will require Educator-sponsored Dubai study visa.
										Full-time students can be sponsored by their educational
										institution if the institution is eligible. This allows them to
										obtain a UAE study visa for the duration of their course</p>
									<p>&nbsp;</p>
									<p>Student Residence Visas are normally only valid for 1 year
										at a time, renewed each year during the study program.</p>
									<h3>Documents needed:</h3>
									<ul>
										<li>Passport</li>
										<li>With at least 6 months validity, the passport must have
											two blank visa pages (one to endorse the visa and one for entry
											stamps)</li>
										<li>Passport copies (about 4)</li>
										<li>Photographs (about 12)</li>
										<li>Upon arrival, passport copies with entry visa to the
											UAE (about 3 copies)</li>
										<li>Evidence of acceptance to a UAE tertiary institute
											(offer letter)</li>
										<li>Possibly bank statements showing evidence of funds in
											the UAE</li>
										<li>Possibly a tenancy agreement (or letter from university
											if staying in university accommodation)</li>
										<li>Copy of tuition fee receipt for the current study year
											of the program</li>
										<li>Copy of visa fees receipt for the current study year of
											the program</li>
										<li>Post-graduate students will need to have their
											undergraduate degree attested</li>
										<li>Students from some countries will undergo a security
											check to make sure they are not considered a threat to UAE
											security.</li>
										<li>A medical test at an authorised UAE medical center
											(approx AED 350-500) will normally be required. The medical
											check is a blood test and chest X-ray for HIV (AIDS), Hepatitis
											B, Hepatitis C, Tuberculosis (TB), Leprosy, and Syphilis. If
											results come back positive for any of those conditions, the
											person is deported, except for syphilis which is treated, but
											this may change, check with UAE immigration department or UAE
											Ministry of Health (and keep in mind it&#8217;s possible to get
											conflicting reports from them).</li>
									</ul>
									<h3></h3>
									<h3>Student Residence Visa Fees</h3>
									<ul>
										<li>Student Visa Fees vary between universities, colleges
											and institutions. It Varies between 1,000 to 3,000 AED for a
											one-year student residence visa.</li>
										<li>Some universities, colleges and institutions may
											require a refundable visa deposit, may vary between 2,000 to
											3,000 AED.</li>
										<li>Renewal charges vary between 1,000 to 3,000 AED yearly.</li>
										<li>There might also be differences in fees between
											different emirates.</li>
										<li>There are also differences depending on if the
											university is located in a UAE education free zone such as
											Dubai Academic City or Knowledge Village, or not.</li>
										<li>Please check with university, college or institute
											applying to for up-to-date information.</li>
									</ul>
									<h3>Visa Validity</h3>
									<p>If a student stays out of the UAE for longer than six
										months, their student residence visa becomes invalid and they
										will be denied entry to the UAE until it is cancelled. Usually
										the sponsor will report the visa holder to the immigration
										authorities.</p>
									<ul>
										<li>Visas normally take 2-5 weeks to process once all the
											correct documentation has been supplied.</li>
										<li>Express visas take 1-3 weeks to process.</li>
										<li>Cancellation of visa normally takes 1-3 weeks, express
											cancellation takes 1-2 weeks.</li>
									</ul>
								</div>
