			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Application Requirements &#038; Documents for Australia</h1>
						...
						<div id="breadcrumbs-wrapper">
							<div class="container">
								...
								&#187; <span><a
									href="study_australia">Study in Australia</a> &#187;  <span class="breadcrumb_last" aria-current="page">Application Requirements &#038; Documents for Australia</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h2>Admission Documents Checklist to Study in Australia:</h2>
									<ul>
										<li>Resume</li>
										<li>Passport Copy &#8211; first and last two pages</li>
										<li>All Mark sheets (From 10th to Final Year of Studies)</li>
										...
										<li>Statement of Purpose depending on the course &#8211;
											we&#8217;ll inform you if required (we shall provide your with
											any formats)</li>
										<li>Recommendation Letters from your school / college /
											employer on the letter headed paper of the Institution /
											Organization</li>
										<li>Portfolio, if design related course</li>
										<li><a href="ielts" target="_blank">IELTS</a>
											Score Report – you can submit this at a later date. We can try
											for a waiver for you for admissions but is compulsory for
											applying for an Australian visa</li>
										<li>Extra-curricular activities certificates, if any</li>
										<li>Essays (only in case of some MBA programs)</li>
									</ul>
									<p>Notes:</p>
									<p>Even though most university applications are made online,
										we&#8217;ll require notarized copies of your documents to make
										applications.</p>
								</div>
