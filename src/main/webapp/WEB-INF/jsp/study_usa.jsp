			...
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
							...
							<div class="container">
								<p id="breadcrumbs">
									<span><span><a href="index">Home</a>
											&#187; <span class="breadcrumb_last" aria-current="page">Study
						...
						<div id="why-study-in" style="background-color:#002868">
							<div class="container">
								<h2 style="color:#fff">Why study in USA</h2>
								<div>
									
									<p>Because your mother&#8217;s uncle&#8217;s cousin&#8217;s wife&#8217;s daughter
										lives there. Because their star spangled banner has been
										attracting Indians for decades now. Because you want an Ivy
										League education. Because it&#8217;s the land of the free and home of
										the brave. Why wouldn&#8217;t you want to study in US? America is the
									...
									<p style="margin-top: 10px;">
										<a
											href="why_study_in_usa" style="color:#fff">Continue
											reading...</a>
									</p>
								</div>
							</div>
