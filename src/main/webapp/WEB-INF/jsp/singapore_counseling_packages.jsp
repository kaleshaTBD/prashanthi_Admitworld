...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2018/11/singapore-221502.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Singapore Counseling Packages</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_singapore">Study in
										Singapore</a> &#187;  <span class="breadcrumb_last" aria-current="page">Singapore Counseling Packages</span></span></span></span>
					...
					<div id="left-area">
									...
									<p>
										<strong>We help you right from start to end in the
											process of studying in Singapore and the support is completely
											free of cost when you apply to most Universities. Isn’t that
											great?</strong>
									</p>
									<p>
										<strong> </strong>
									...
									<p>Only if you wish to apply to National Universities in
										Singapore or some world renowned programs like the INSEAD MBA,
										we charge for our services. These charges are completely based
										on the scope of work which will analyze after our first
										discussion. Only if we believe that you are eligible for
										applying and after reviewing the suitability, it will make sense
										for us to charge you; otherwise we will simply be happy to help!</p>
									...
									<ul>
										...
										<li>Shortlisting and selecting the right set of
											Universities in Singapore</li>
										...
										<li>Securing admission offers and helping you finalize the
											University</li>
										<li>Helping you with Singapore scholarship applications and
											/ or education loans</li>
										<li>Guiding you on financial matters (fee payments to
											Singaporean universities, financials required for Singapore
										...
										<li>Pre-departure brief where we will tell you about the
											life and living in Singapore and much more</li>
									...
									<ol>
										<li>We’ve got over 12 years experience in placing students
											abroad</li>
										<li>We’ve visited Singapore and have seen most of the
											Universities and Institutions. We’ve met with University
											officials and we keep connecting with Singaporean Universities
											often to get you the perfect information</li>
										<li>We’ve understood the difference between studying in
											Singapore vis-a-vis another country and we can guide you
											extremely well – Use Our Experience</li>
										<li>We help you right from start to end in the process of
											applying to Singapore Colleges and Universities and thereafter
											with the visa process, helping you book the accommodation, buy
											forex, and much more</li>
										<li>We’ve already mentioned about – we help you for FREE
											and we SAVE you your application fee sometimes</li>
									</ol>
