			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Applications Requirements for Ireland</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_ireland">Study in
										Ireland</a> &#187;  <span class="breadcrumb_last" aria-current="page">Applications Requirements for Ireland</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
						<div class="entry-content">
							<h1>Applications Requirements for Ireland</h1>
							<p>Applications Requirements for Ireland become simpler if
								you have the experience person with you. Our counselors had
								helped a lot of our students to go to Ireland.</p>
							<p>&nbsp;</p>
							<h3>Documents as part of Applications Requirements for
								Ireland:</h3>
							<p>&nbsp;</p>
							<ol>
								<li>Resume</li>
								<li>Passport Copy (front page and last page)</li>
								<li>All marksheets (from 10th standard to final year of
									studies)</li>
								<li>Degree certificate or provisional degree certificate
									(if you are currently studying for eg. in your final year, then
									you could submit this later)</li>
								<li>Bachelors&#8217; transcripts (not compulsory for all
									Universities in Ireland) &#8211; do not wait to submit your
									application if you are going to get these later</li>
								<li><a href="ielts" target="_blank"
									rel="noopener noreferrer">IELTS</a> (Academic) score report (if
									you are yet to take the test, you can submit this later as soon
									as it arrives)</li>
								<li>2 Recommendation Letters (from your College / Employer
									&#8211; on the letter headed paper of the Institution /
									Organization)</li>
								<li>Statement of Purpose (SOP)</li>
								<li>Work Experience Letter (s) (if any)</li>
								<li>Certificates of Extracurricular Activities (if any)</li>
								<li>Birth Certificate Copy (may be required by only some
									Universities in Ireland)</li>
							</ol>
							<p>
								These documents are the part of your application. If you are
								planning to apply for Ireland then we can provide you the <a
									href="contact_us">admission counseling</a>.
							</p>
							<p>&nbsp;</p>
							<h3>Notes:</h3>
							<ul>
								<li>Most Universities and Institutes of Technology in
									Ireland have online application. Care must be taken to fill the
									form thoroughly.</li>
								<li>If you are yet to appear for your<a
									href="ielts"> IELTS</a> test or have not
									yet received the result, you could enter the date of the test
									that you would have booked. Once the result arrives, we can
									update the University on your behalf.
								</li>
							</ul>
							<p>&nbsp;</p>
							<hr />
							...
							<p>
								As one of top education consultants for Ireland in Hyderabad, and
								...
								for free consultation to study!
							</p>
							<p>&nbsp;</p>
						</div>
