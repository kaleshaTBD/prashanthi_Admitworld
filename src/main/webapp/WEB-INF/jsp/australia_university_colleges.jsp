			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Universities and Colleges in Australia</h1>
						...
						<div id="breadcrumbs-wrapper">
							<div class="container">
								...
								&#187; <span><a
									href="study_australia">Study in Australia</a> &#187;  <span class="breadcrumb_last" aria-current="page">Universities and Colleges in Australia</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h1 id="universities-amp;-colleges-in-">Universities and
										Colleges in Australia</h1>
									<p>Australia has 43 universities with at least one university
										main campus based in each state or territory.</p>
									<h2 id="list-of-australian-universitie">List of Australian
										Universities</h2>
									<p>Universities in Australia territory-wise are listed below:</p>
									<h3 id="universities-in-australian-cap">Universities in
										Australian Capital Territory</h3>
									<ul>
										<li>Australian National University</li>
										<li>University
												of Canberra</li>
									</ul>
									<h3 id="universities-in-new-south-wale">Universities in New
										South Wales</h3>
									<ul>
										<li>Australian
												Catholic University</li>
										<li>Charles
												Sturt University</li>
										<li>Macquarie
												University</li>
										...
										<li>University
												of New England</li>
										<li>University
												of New South Wales</li>
										<li>University
												of Newcastle</li>
										<li>University
												of Sydney</li>
										<li>University
												of Technology, Sydney</li>
										<li>Western Sydney University</li>
										<li>University
												of Wollongong</li>
									</ul>
									<h3 id="universities-in-northern-terri">Universities in
										Northern Territory</h3>
									<ul>
										<li>Charles
												Darwin University</li>
									</ul>
									<h3 id="universities-in-queensland">Universities in
										Queensland</h3>
									<ul>
										<li>Bond
												University</li>
										<li>CQ
												University</li>
										<li>Federation
												University of Australia</li>
										<li>Griffith
												University</li>
										<li>James
												Cook University</li>
										<li>Queensland
												University of Technology</li>
										<li>University
												of Queensland</li>
										<li>University
												of Southern Queensland</li>
										<li>University
												of the Sunshine Coast</li>
									</ul>
									<h3 id="universities-in-south-australi">Universities in
										South Australia</h3>
									<ul>
										<li>Carnegie
										...
										<li>Torrens
												University Australia</li>
										<li>University College London</li>
										<li>University
												of Adelaide</li>
										<li>University
												of South Australia</li>
									</ul>
									<h3 id="universities-in-tasmania">Universities in Tasmania</h3>
									<ul>
										<li>University
												of Tasmania</li>
									</ul>
									<h3 id="universities-in-victoria">Universities in Victoria</h3>
									<ul>
										<li>Deakin
												University</li>
										<li>Federation
									...
									<h3 id="universities-in-western-austra">Universities in
									...
									<ul>
										...
										<li>urdoch
												University</li>
										<li>University
												of Notre Dame Australia</li>
										<li>University
												of Western Australia</li>
									</ul>
									<p>&nbsp;</p>
									<hr />
									<h2 id="australian-universities-in-pop">Australian
										Universities in popular cities</h2>
									<h3 id="universities-in-melbourne">Universities in Melbourne</h3>
									<ul>
										<li>Deakin
												University</li>
										<li>La
									...
									<h3 id="universities-in-adelaide">Universities in Adelaide</h3>
									<ul>
										<li>Carnegie
												Mellon University</li>
										<li>Flinders University</li>
									...
									<h3 id="universities-in-brisbane">Universities in Brisbane</h3>
									<ul>
										<li>Griffith University</li>
										<li>Queensland University of Technology</li>
										<li>University of Queensland</li>
									</ul>
									<h3 id="universities-in-perth">Universities in Perth</h3>
									<ul>
										<li>Curtin University</li>
										<li>Edith
												Cowan University</a></li>
										<li>Murdoch University</li>
										<li>University of Western Australia</li>
									</ul>
									<h3 id="universities-in-sydney">Universities in Sydney</h3>
									<ul>
									...
									<ul class="list_li_inner margin_30">
										<li>Adelaide Central School of Art</li>
										<li>Alexander Institute of Technology, Perth</li>
										<li>Australian Academy of Design, Melbourne</li>
										<li>Australian College of Applied Psychology, Sydney</li>
										<li>Australian College of Natural Medicine, Brisbane</li>
										<li>Australian College of Physical Education, Sydney</li>
										<li>Australian Guild of Music Education, Melbourne</li>
										<li>Australian Institute of Business , Adelaide</li>
										<li>Australian Institute of Public Safety, Melbourne</li>
										<li>Australian Institute of Music, Sydney</li>
										<li>Australian International Hotel School, Canberra</li>
										<li>Australian National college, Melbourne</li>
										<li>Billy Blue College of Design, Sydney</li>
										<li>Blue Mountains International Hotel Management School,
											Leura</li>
										<li>Brandon Raynor’s School of Massage and Natural
											Therapies, Sydney</li>
										<li>Careers Australia College of Healthcare, Adelaide</li>
										<li>Chifley Business School, Melbourne</li>
										<li>Endeavor College of Natural Health, Adelaide</li>
										<li>Holmes Institute, Melbourne</li>
										<li>ILM Australia</li>
										<li>International College of Hotel Management, Adelaide</li>
										<li>Envisage, Brisbane</li>
										<li>Jansen Newman Institute, Sydney?</li>
										<li>Jschool: Journalism Education &amp; Training</li>
										<li>Kaylene Kranz and Associates, Adelaide</li>
										<li>Kollel Beth Hatalmud Yehuda Fishman Institute,
											Melbourne</li>
										<li>Le Cordon Bleu Australia, Adelaide</li>
										<li>Leo Cussen Institute of Law, Melbourne</li>
										<li>Marcus Oldham College, Geelong</li>
										<li>National Art School (NAS), Sydney</li>
										<li>National Institute of Dramatic Art (NIDA), Sydney</li>
										<li>National Institute of Health Sciences, Canberra</li>
										<li>Nature Care College, Sydney</li>
										<li>Navitas World, Sydney</li>
										<li>Oceania Polytechnic Institute of Education, Melbourne</li>
										<li>Open Polytechnic of New Zealand, Melbourne</li>
										<li>QANTM, Brisbane</li>
										<li>Raffles College of Design and Commerce, Sydney</li>
										<li>SAE Institute, Sydney</li>
										<li>Southern School of Natural Therapies, Melbourne</li>
										<li>Taylors College, Sydney</li>
										<li>The College of Law Ltd, Sydney</li>
										<li>William Blue College of Hospitality and Tourism, Sydney</li>
									</ul>
									<div class="clearfix"></div>
									<h3>Groupings of Universities in Australia</h3>
									<ul class="list_li_inner margin_30">
										<li>Universities Australia – the peak higher education
											institution group.</li>
										<li>Group of Eight – the leading research-focused
											universities.</li>
										<li>Australian Technology Network – the leading
											technology-focused universities.</li>
										<li>Innovative Research Universities Australia –
											research-focused universities.</li>
										<li>Universitas 21 – a worldwide group of universities
											founded by the University of Melbourne.</li>
										<li>Open Universities Australia – a group of universities
											that offer distance education courses as part of a common
											platform.</li>
										<li>Regional Universities Network – a group of regional
											universities.</li>
										<li>Sandstone Universities – an unofficial group of
											Australia’s oldest universities.</li>
									</ul>
								</div>
