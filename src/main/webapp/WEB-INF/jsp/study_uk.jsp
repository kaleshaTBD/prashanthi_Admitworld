		...
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
							...
							<div class="container">
								<p id="breadcrumbs">
									<span><span><a href="index">Home</a>
											&#187; <span class="breadcrumb_last" aria-current="page">Study in UK</span></span></span>
								</p>
							</div>
						</div>
						...
						<p>&#8220;Because my friend or relative has recommended&#8221;
							&#8211; Super reason. We wonder if they are paying for you.</p>
						<p>
						...
						<p style="margin-top: 10px;">
							<a href="why_study_in_uk">Continue reading...</a>
						</p>
					</div>
							</div>
						</div>
					...
					<div id="left-area">
							...
							<div id="country-dashboard" style="margin-top:30px;marrgin-bottom:20px">
								...
								<div id="how-can-we-help-eop">
									<h2 style="color:#FD9601">UK Admission Counseling</h2>
									...
									studying in Ireland hassle-free.
