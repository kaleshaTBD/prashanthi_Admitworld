						...
						<div id="breadcrumbs-wrapper">
							<div class="container">
								<p id="breadcrumbs">
									...
									<span><span><a href="index">Home</a> &#187; <span><a href="study_in_usa">Study in USA</a> &#187; <span class="breadcrumb_last" aria-current="page">USA University Rankings</span></span></span></span>			
					    ...
					    <div class="container">
							...
							<div class="entry-content">
								<div id="et-boc" class="et-boc">
									<p>There are varied ranking systems in the USA, and we
										recommend you look at &#8211; none of them! The criteria for
										ranking systems in the USA varies greatly, most have very
										little to do with the course you’re looking for. When looking
										at a program, the reputation of the university is important.
										However, factors like the curriculum, faculty, course
										outcomes, location etc. should have a greater impact on your
										decision. If you still want a point of reference though, you
										can use US News, Financial Times, The Economist, Forbes, etc.</p>
								...
								<div id="how-can-we-help-eop" style="margin-top:20px;">
												<h2 style="color:#c00026"
												 >USA Admission Counseling</h2>
