			      ...
			      <div id="hero-wrapper">
						...
						<div id="breadcrumbs-wrapper">
							<div class="container">
								<p id="breadcrumbs">
									...
									<span><span><a href="index">Home</a> &#187;  <span class="breadcrumb_last" aria-current="page">Glossary of Terminology</span></span></span>		
					    ...
					    <div class="container">
							...
							<div class="entry-content">
								<h1 style="color: #00A8E8">Glossary of Terminology</h1>
								<p>This Glossary of Terminology is unavoidable if you are
									planning to study abroad.</p>
								<p>&nbsp;</p>
								<h2 style="color: #00A8E8">Important Glossary of Terminology</h2>
								<p>&nbsp;</p>
								<h3 style="color: #00A8E8">Optional Practical Training (OPT):</h3>
								<p>Time period when UG &amp; PG students, after graduating,
									are permitted to work for a max. of 1 year to acquire practical
									training in their fields.</p>
								<p>&nbsp;</p>
								<h3 style="color: #00A8E8">Associate Degree:</h3>
								<p>In the USA, an associate degree is equivalent to the
									first two years of a four year college or university Bachelors
									degree. It is an academic degree awarded by the community
									colleges, junior colleges, business colleges and some
									bachelor&#8217;s degree upon completion of a course of study
									usually for two years (60 credits). It is the lowest in
									hierarchy of post secondary academic degrees offered in USA.</p>
								<p>&nbsp;</p>
								<h3 style="color: #00A8E8">Credential Evaluation:</h3>
								<p>
									Many institutes will ask for a credential evaluation or a
									course-by-course evaluation from bodies like ECE and WES.
									Essentially, these are organizations that convert your % or 10
									scale GPA or other grading systems to the standard USA 4.0
									scale GPA. You will have to send your academic documents to
									these companies and they will then assess your marks and give
									you a revised transcript. You will have to ask them to send the
									evaluation report to the universities that have requested it,
									just like you report your <a href="gre"
										target="_blank" rel="noopener noreferrer" style="color: #00A8E8">GRE</a>, <a
										href="gmat" target="_blank"
										rel="noopener noreferrer" style="color: #00A8E8">GMAT</a> or <a
										href="toefl"
										target="_blank" rel="noopener noreferrer" style="color: #00A8E8">TOEFL</a> scores to
									universities.
								</p>
								<p>&nbsp;</p>
								<h3 style="color: #00A8E8">Freshman:</h3>
								<p>A first year undergraduate student is a Freshman.</p>
								<p>&nbsp;</p>
								<h3 style="color: #00A8E8">Sophomore:</h3>
								<p>The term used to describe a student in the second year of
									study (generally referring to high school or university study)</p>
								<p>&nbsp;</p>
								<h3 style="color: #00A8E8">Junior:</h3>
								<p>A term used to describe a student in the third year.</p>
								<p>&nbsp;</p>
								<h3 style="color: #00A8E8">Senior:</h3>
								<p>A term used to describe a student in the final year
									(generally fourth year)</p>
								<p>&nbsp;</p>
								<h4 style="color: #00A8E8">Transfer:</h4>
								<p>Students, who have completed a part of their
									undergraduate degree and want to go to the USA, can apply as a
									transfer student. Students generally prefer to transfer after
									finishing their first two years of undergraduate studies (ie
									the associate degree). Admissions in to the third year of
									undergraduate studies is easier and widely acceptable by US
									Universities than in to the second or fourth year.</p>
								<p>&nbsp;</p>
								<h3 style="color: #00A8E8">i20 &#8211;</h3>
								<p>Let us simplify this for you: It&#8217;s the Certificate of
									Eligibility for Nonimmigrant Status. Essentially, once the
									university makes you an offer, they will either send the i20 or
									tell you what are the next few steps for you to complete to get
									this Form i20. You will need this in order to pay your SEVIS
									Fee (I 901). And apply for your nonimmigrant visa to study in
									the USA. Once you&#8217;re there, you&#8217;ll need it for your driver&#8217;s
									licence (if you can afford a car!) and social security number.</p>
								<p>&nbsp;</p>
								<h3 style="color: #00A8E8">Intake:</h3>
								<p>When classes begin. Spring &#8211; January/ February.
									Fall &#8211; August/ September. Summer &#8211; April/ May.
									Winter &#8211; December. Fall is usually the main intake. And 
									Spring is after that.</p>
