			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Application &#038; Admission Process for New Zealand</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_newzaland">Study in
										New Zealand</a> &#187;  <span class="breadcrumb_last" aria-current="page">Application &#038; Admission Process for New Zealand</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h2>Step-wise process of what you need to do if you wish to
										study in New Zealand :</h2>
									<p>
										<strong>STEP 1: Collect and Submit</strong>: Collect the above
										listed documents and submit it to us
									</p>
									<p>
										<strong>STEP 2: Applications</strong>: We will proof check your
										application and documents and send it to the University (at no
										cost)
									</p>
									<p>
										<strong>STEP 3:Follow-ups</strong>: We will follow up on your
										behalf with the Universities so that you do not have to get in
										to that hassle. Again, we set the right reminders and ensure
										that everything is done timely. We will provide any additional
										information to the Universities as they require
									</p>
									<p>
										<strong>STEP 4: Collect Offers and Finalize</strong>: We will
										keep you updated on the offers you have received from all the NZ
										Universities you have applied to. We will also keep an eye on
										the deadline for acceptance and update you on how long you
										should wait so that the next process ie. the New Zealand student
										visa process also works out timely
									</p>
									<p>
										<strong>STEP 5: Visa Guidance</strong>: We will at length
										discuss the visa process with you from documentation, to how to
										make the visa application
									</p>
									<p>
										<strong>STEP 6: Financial Matters</strong>: Generally before or
										during the visa application process, you are required to pay
										your fee to the University. We will guide you on how to go about
										this process. We will update the University after the payment is
										made so that they could track it. For details on what goes in to
										a New Zealand student visa application, check it out <a
											href="new_zealand_student_visa_guidance">here</a> on our
										website
									</p>
									<p>
										<strong>STEP 7: Accommodation</strong>: During the time of the
										visa application, we would be discussing on the best options
										that are available for a stay in New Zealand, whether it is
										private or University accommodation
									</p>
									<p>
										<strong>STEP 8: Pre-departure Brief</strong>: We will provide
										all the relevant information about life and living in New
										Zealand, opening of bank accounts, etc.
									</p>
									<p>
										<strong>STEP 9: Fly</strong>: We do not need to explain this to
										you. This is your day to begin your journey!
									</p>
									<p>&nbsp;</p>
								</div>
