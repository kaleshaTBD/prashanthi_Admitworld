			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Cost of Study in New Zealand</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_newzaland">Study in
										New Zealand</a> &#187;  <span class="breadcrumb_last" aria-current="page">Cost of Study in New Zealand</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<blockquote>
										<p>For many, it is very attractive to study in New Zealand
											because the cost of studying in NZ is lower as compared to a
											large number of other popular study destinations like the US or
											Australia.</p>
									</blockquote>
									<p>&nbsp;</p>
									<h2>
										<strong>Cost of studying in New Zealand can be divided
											in to</strong>:
									</h2>
									<p>&nbsp;</p>
									<ol>
										<li><h4>Tuition Fees (ie. your course fee)</h4></li>
										<li><h4>Living Cost</h4></li>
										<li><h4>Others Costs (insurance, etc.)</h4></li>
									</ol>
									<p>&nbsp;</p>
									<h3>Tuition fee cost to study in New Zealand:</h3>
									<p>&nbsp;</p>
									<table width="100%">
										<tbody>
											<tr>
												<td width="96%"><h4>Undergraduate  Courses</h4></td>
											</tr>
											<tr>
												<td width="96%">Undergraduate courses in New Zealand can
													cost you NZ$ 18000 to NZ$ 25000 per year. Again, the cost
													depends on the chosen program. Here is an indicative list of
													what it cost stream wise:
													</p>
													<table width="100%">
														<tbody>
															<tr>
																<td width="45%">Arts / Humanities / Social Sciences</td>
																<td width="54%">NZ $ 10,000 &#8211; $ 12,000  per
																	year</td>
															</tr>
															<tr>
																<td width="45%">Commerce / Administration /
																	Management</td>
																<td width="54%">NZ $ 10,000 &#8211; $ 12,500  per
																	year</td>
															</tr>
															<tr>
																<td width="45%">Computing &amp; Mathematical Sciences</td>
																<td width="54%">NZ $ 13,000 &#8211; $ 15,000 per year</td>
															</tr>
															<tr>
																<td width="45%">Engineering</td>
																<td width="54%">NZ $ 16,000 &#8211; $ 17,500  per
																	year</td>
															</tr>
															<tr>
																<td width="45%">Science / Science Technology</td>
																<td width="54%">NZ $ 14,000 &#8211; $ 16,000 per year</td>
															</tr>
															<tr>
																<td width="45%">Technology</td>
																<td width="54%">NZ $ 14,000 &#8211; $ 18,000  per
																	year</td>
															</tr>
														</tbody>
													</table>
											...
											<tr>
												<td width="96%"><h4>Postgraduate Courses</h4>
													<p>Postgraduate studies can cost between NZ$ 10,000 and
														NZ$ 30,000. It depends on the field you want to study in NZ.
														Here is an indication:</td>
											</tr>
											<tr>
												<td width="96%"><table width="100%">
														<tbody>
															<tr>
																<td width="45%">Arts / Humanities / Social Sciences</td>
																<td width="54%">NZ $ 14,000 &#8211; $ 16,000  per
																	year</td>
															</tr>
															<tr>
																<td width="45%">Master of Business Administration
																	(MBA)</td>
																<td width="54%">NZ $ 18,000 &#8211; $ 24,000  per
																	year</td>
															</tr>
															<tr>
																<td width="45%">Engineering</td>
																<td width="54%">NZ $ 18,000 &#8211; $ 24,500 per year</td>
															</tr>
														</tbody>
													</table></td>
											</tr>
									...
									<p>&nbsp;</p>
									<p>
										Cost of some MBA programs available in New Zealand are listed<a
											href="mba_in_new_zealand"><strong>
												here </strong></a>
									</p>
								</div>
