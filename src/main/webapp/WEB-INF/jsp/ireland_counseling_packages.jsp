			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Ireland Counseling Packages</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_ireland">Study in
										Ireland</a> &#187;  <span class="breadcrumb_last" aria-current="page">Ireland Counseling Packages</span></span></span></span>
					...
					<div id="left-area">
						<div class="entry-content">
							...
							<h3>However we won&#8217;t leave this opportunity to tell you why
								you should use our Free Ireland Counseling Packages:</h3>
							<p>&nbsp;</p>
							<ul>
								<li>We&#8217;ve got over <strong>12 years experience</strong> in
									placing students abroad
								</li>
								<li>Admitworld has visited Ireland and have <strong>seen
										most of the Universities and Institutions</strong>. We&#8217;ve met with
									University officials and we keep connecting with Irish
									Universities often to get you the perfect information
								</li>
								<li>We&#8217;ve understood the difference between studying in
									Ireland vis-a-vis another country and we can guide you
									extremely well &#8211; <strong>Use Our Experience</strong>
								</li>
								<li>Our counselors help you <strong>right from
										start to end in the process of applying to Irish Institutions</strong>
									and thereafter with the <strong>visa process</strong>, helping
									you <strong>book the accommodation</strong>, buy forex, and
									much more
								</li>
								<li>We&#8217;ve already mentioned about &#8211; we help you for <strong>FREE</strong>
									and we <strong>SAVE</strong> you your application fee.
								</li>
							</ul>
							<p>
