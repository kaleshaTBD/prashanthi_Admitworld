			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>MBA Programs in New Zealand</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_newzaland">Study in
										New Zealand</a> &#187;  <span class="breadcrumb_last" aria-current="page">MBA Programs in New Zealand</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h1>Quick Notes on studying MBA programs in New Zealand:</h1>
									<h2>Duration of MBA Programs in New Zealand:</h2>
									<p>MBA programs in New Zealand are between 1 and 2 years in
										duration with generally most MBAs being of 1.5 years.</p>
									<h2>Work Experience for MBA Programs in New Zealand:</h2>
									...
									<h2>15 Years Education Accepted for MBA:</h2>
									...
									<p>You can work up to 20 hrs per week (like most other
										countries) during study period and full-time (generally 40 hrs
										per week) during scheduled holidays. You can take care of your
										living expenses this way (min. wage is NZ $12 per hour)</p>
