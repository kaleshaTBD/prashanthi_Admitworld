...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2018/11/new-zealand-new-zealand-162373-e1543828652853.png"
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_newzaland">Study in
										New Zealand</a> &#187;  <span class="breadcrumb_last" aria-current="page">Why Study in New Zealand?</span></span></span></span>
						...
						<div id="why-study-in" >
								...
								<p>New Zealand Tourism – that comes to mind when you think
									about studying in New Zealand isn’t it! Or perhaps you think about
									New Zealand as 2015’s Cricket World Cup finalists?</p>
								<p>Here are our simple reasons to tell you that New Zealand can
									be your best study destination:</p>
								<h2>
									<strong>Top Education + Work during Study + Work after
										Study + Migrate</strong>
								</h2>
								<p>&nbsp;</p>
								<p>
									<strong>Safe to study in New Zealand</strong>: New Zealand is
									ranked the 3rd Most Peaceful Country, according to the Global
									Peace Index (after Iceland and Denmark). New Zealand people are
									approachable, very friendly and you will feel safe in New Zealand.
									New Zealand is clean, green and safe with some of the best and
									most scenic places to live around
								</p>
								<p>
									<strong>Cost of Study in New Zealand</strong>: Both – course fees
									in New Zealand and living expenses in New Zealand are cheaper as
									compared to many other popular study destinations.
								</p>
								<p>
									In the Mercer ‘Cost of Living Survey’ (2014), New Zealand’s major
									cities <strong>Auckland</strong> and <strong>Wellington</strong>
									were shown to provide a lower cost of living than cities such as
									Hong Kong, Singapore, Tokyo, Beijing, Seoul, New York, Paris,
									London, Dublin, Moscow, Sydney and Melbourne
								</p>
								<p>
									<strong>15 Years Education Accepted</strong>: If you wish to study
									an MBA in New Zealand or a New Zealand Masters, you can directly
									apply after your Bachelors. This means you will immediately start
									your Masters in Zealand in the same year that you finish your
									degree program in India
								</p>
								<p>
									<strong>Work in New Zealand during studies</strong>: You can work
									up to 20 hrs per week (like most other countries) during study
									period and full-time (generally 40 hrs per week) during vacations
									(and it’s visibly mentioned on your student visa too). Bingo! You
									can take care of your living expenses this way (min. wage is NZ
									$12 per hour)
								</p>
								<p>
									<strong>Work Permit in New Zealand after studies (Job
										Search Visa in New Zealand)</strong>: After successful course completion,
									you will automatically get a 12 months to 36 months &#8216;Work
									Permit&#8217; (in most cases, this will be done at your
									Institution). And do you know what? You can work full-time in any
									job of your choice. But remember, if you are aiming a NZ Permanent
									Residency, then you have to find a job relevant to your course
									(that you have completed in NZ).
								</p>
								<p>
									<strong>Immigration New Zealand</strong>: Once you have finished
									your study in New Zealand, you may be able to work in New Zealand
									for up to four years, and after that, apply to work or live in NZ
									longer term. Your chances of getting further work are higher if
									you have the skills that New Zealand urgently needs. Here’s the <a
										href="http://skillshortages.immigration.govt.nz/" target="_blank"
										rel="noopener">skill shortage list check</a>. All we can say is
									permanent residency (PR) in New Zealand is way easier as compared
									to most other countries
								</p>
								<p>
									<strong>English Speaking</strong>: English is a daily language in
									New Zealand – Indian students find it easy to study and work
								</p>
								<p>
									<strong>Quality Assurance</strong>: NZ government has appointed:
								</p>
								<p>
									<a href="study_newzaland" target="_blank"
										rel="noopener">NZQA</a> that is responsible for approving and
									registering all courses and national qualifications offered at
									polytechnics and private training establishments.
								</p>
								<p>
									<a href="study_newzaland" target="_blank"
										rel="noopener">NZVCC </a>that is responsible for approving all
									diplomas, undergraduate and graduate programs offered by New
									Zealand universities.
								</p>
								<p>These bodies ensure the quality of education and determine
									the delivery of qualifications. You can rest assured that
									Institutions in NZ provide superior quality education and an
									experience of a life time. As a former British colony, NZ’s
									education system is based on the prestigious British system</p>
								<p>
									<strong>New Zealand Visa</strong>: No personal interview is
									required unless there are some really unusual circumstances.
									Mostly, this is also done over the phone. And if you receive a
									call from the Consulate, you can always get back to them when the
									time is more appropriate (or if you were not busy)!
								</p>
