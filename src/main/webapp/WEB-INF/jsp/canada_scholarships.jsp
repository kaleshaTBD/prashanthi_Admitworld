							...
							<div class="container">
								...
								&#187; <span><a
									href="study_canada">Study in
										Canada</a> &#187;  <span class="breadcrumb_last" aria-current="page">Canada Scholarships</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
						...
						<div class="entry-content">
							...
							<h1>Canada Scholarships</h1>
							<p>
								Several Graduate scholarships are available to cover some of the
								costs of studying in Canada. The best source of funds tends to
								be universities many of whom offer a range of different
								scholarships that cover tuition costs or living expenses and
								sometimes both. Many awards are based solely on academic merit
								and therefore financial aid is not taken into account through
								the application process. The Canadian government also offers a
								range of awards for graduate students, as do a large number of
								individual universities. A free service coordinates most
								scholarships and is available at <a
									href="http://www.scholarshipscanada.com/">www.scholarshipscanada.com</a>.
								A number of scholarships that offer funds to cover tuition fees
								and living expenses are administered by the Association of
								Universities and Colleges of Canada.
							</p>
							<p>&nbsp;</p>
							<h2>Here&#8217;s how we will go about the process &#8211; Admitworld to
								your rescue!</h2>
							<h2> </h2>
							<h3>Let&#8217;s TALK you through:</h3>
							<p>&nbsp;</p>
							<h4>STEP 1</h4>
							<p>You can study just about anything that you wish to, at
								both undergraduate and postgraduate levels. All you have to do
								is tell us <b>I want to study MS in CANADA </b>or <b>MBA in CANADA</b> or
								<b>Bachelors in CANADA</b> or &#8220;Diplomas, Advance Diplomas,
								Graduate Certificate in CANADA&#8221; and we&#8217;ll give you the
								solution you require. Let us know about your preferences
								(location, budget, future plans, course specialization, interest
								in working in the CANADA or returning to India – and tons of
								other questions that we will ask you) and we will identify the
								best options available matching your profile. Canadian
								universities and colleges offer two main semester intakes: Fall
								(September / October), Winter (January ) and few programs may
								have a Spring (April to July) Intake.</p>
							<p>&nbsp;</p>
							<h4>STEP 2</h4>
							<p>Selecting universities and colleges is quite a complicated
								process that we pride ourselves on. We help you pick the right
								mix of ambitious, moderate and safe universities and colleges
								for your admissions. We do this by matching your profile to the
								universities and colleges requirements and class average
								student. This is also the stage where information about finances
								and scholarships is dispensed.</p>
							<p>&nbsp;</p>
							<h4>STEP 3</h4>
							<p>We recommend you select your universities and colleges
								before you take the tests because you will save some money by
								sending the scores to the correct university list (YES! You can
								report your scores to 5 Universities for free). Do not wait to
								apply to Canadian schools till you have given your tests.
								Instead, be realistic about the scores that you can achieve,
								decide on the universities you wish to apply (generally,
								restrict it to maximum 8 universities and colleges) and make
								your applications with the remaining documents. We can help you
								register for whichever tests it is you need to take. We can also
								coach you for the entrance exams. Our tutors have been working
								with us for years now and are qualified to help you reach your
								ideal score.</p>
							<p>&nbsp;</p>
							<h4>STEP 4</h4>
							<p>Then comes the time to gather and edit your documents.
								...
								GREAT at essay editing – ask any of our students! Then comes the
								tedious part &#8211; filling in the applications. We will help
								you do this and check this for you thoroughly as well.</p>
							<p>&nbsp;</p>
							<h4>STEP 5</h4>
							...
							<p>&nbsp;</p>
							<h4>STEP 6</h4>
							<p>Once we help you submit the application, our role becomes
								that of a liaison. We follow up with universities and colleges
								for admission decisions and whether any documents are pending or
								necessary to get an offer.</p>
							<p>&nbsp;</p>
							<h4>STEP 7</h4>
							<p>Once you have offers, we can also help you pick between
								universities and colleges and assist you with the time
								consuming, hair pulling, nail biting task of acquiring your
								visa. While it may seem odd at this stage, selecting which
								university or college in CANADA too go to is even more
								complicated than shortlisting universities and colleges! Other
								than filling out the forms and assisting you with your finances
								again, we take mock interviews to help you prepare of the big
								day. Once we&#8217;re done with you, your documents and confidence
								will both be in order. We will also help you open your (Graduate
								Investment Certificate) GIC Account in Canada.</p>
							<p>&nbsp;</p>
							<p>
								Let us help you achieve YOUR dream! <a
									href="contact_us" target="_blank"
									rel="noopener noreferrer">Contact us</a> if you are planning to
								study abroad.
							</p>
						</div>
