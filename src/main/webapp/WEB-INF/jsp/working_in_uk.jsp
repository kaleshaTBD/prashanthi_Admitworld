							...
							<div class="container">
								...
								&#187; <span><a
									href="study_uk">Study in
										UK</a> &#187;  <span class="breadcrumb_last" aria-current="page">Working in UK</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					...
					<div class="entry-content">
						<h3>Work DURING study in the UK:</h3>
						<ul>
							<li>Students are permitted to work part time for 20 hours
								per week during course</li>
							<li>Students can do full time work (40 hours per week)
								during holidays</li>
							<li>Students can work outside the University campus too</li>
							<li>Jobs in UK are readily available for international
								students. Given the size, lifestyle, density of population and
								existence of companies in the city of London, jobs in London are
								always more than most other cities in the UK (this is a question
								that we frequently get from students)</li>
							<li>Students must be happy to do any kind of jobs eg.
								working in cafeteria, Subway, McDonalds, Burger King or in
								supermarkets like Tesco, Sainsburys, Asda (Walmart)</li>
							<li>Students can expect to earn GBP 7 to GBP 10 per hour of
								work</li>
						</ul>
						<p> </p>
						<h3>Sandwich Courses in the UK:</h3>
						<ul>
							<li>Students who pursuing an undergraduate degree in the UK
								can opt for a sandwich placement programme</li>
							<li>The duration of a sandwich course in the UK is generally
								4 years (ie. one year more than the normal 3 year course
								duration)</li>
							<li>UK Universities provide a job in the 3<sup>rd</sup> year
								of study. This is mostly paid work and the work provided in a
								company is related to your field of study
							</li>
							<li>Students resume studies in the 4<sup>th</sup> year to
								finish their undergraduate course at the same UK University
							</li>
							<li>Sandwich course is a great opportunity for students
								because it not only provides a placement during work which
								offers real time experience but also help you connect well with
								the industry and the knowledge gained at work helps to perform
								well in the course</li>
						</ul>
						<p> </p>
						<h3>Work AFTER finishing studies in the UK:</h3>
						<ul>
							<li>Students generally get a UK study visa which allows them
								to stay in the UK for a period of 4 additionally months after
								the last date of the course</li>
							<li>If a student gets a job of GBP 20800 annually, then
								he/she can apply for a Tier 2 visa which allows a further
								extension of 3 years to work in UK</li>
							<li>We recommend students to start early ie. at least 6
								months before the course will be getting over to update their
								CV, apply for job opportunities, going out for interviews etc.</li>
							<li>Students can use the help of their University’s career
								service units, University jobs shops, placement cells to
								identify jobs in UK and also make a CV which is preferred by UK
								employers</li>
						</ul>
					</div>
