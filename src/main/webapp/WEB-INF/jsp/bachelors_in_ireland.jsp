			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h1>
										<strong>Study Bachelors in Ireland</strong>
									</h1>
									<h2>Quick Notes about studying Bachelors in Ireland:</h2>
									<p>&nbsp;</p>
									<h3>Cost:</h3>
									<p>Most Bachelors Degree in Ireland costs between Euro 7000
										to Euro 11000 per year except for degrees in medicals that may
										cost about Euro 25000 or higher per academic year</p>
									<h3>Duration:</h3>
									<p>Ordinary Bachelors is 3 years and Bachelors Honours is 4
										years</p>
									<h3>Entrance Tests:</h3>
									<p>
										No <a href="sat1"
											target="_blank">SAT</a> is required for applying to Ireland. <a
											href="ielts" target="_blank"
											rel="noopener noreferrer">IELTS</a> Academic is essential and
										the test can be done in about a month&#8217;s time from when you plan.
										2 to 3 test dates for <a href="ieltsl"
											target="_blank">IELTS</a> test are available each month and the
										test centres are available in most cities in India. Ideal score
										in <a href="ielts" target="_blank">IELTS</a>
										test would be 6.0 band (out of 9.0 band)
									</p>
									<h3>Time to Apply:</h3>
									<p>We recommend our students to apply in November of the
										preceding year to when they have to join. This allows enough
										time to apply for scholarships</p>
									<h3>Popular Bachelors Degrees in Ireland:</h3>
									<p>Some extremely popular Bachelors degree in Ireland are
										Business Management (or BBA), Software Systems, IT, Computer
										Science, Gaming Technology, Biomedical Science, Data Science,
										Pharmacy, Medicine.</p>
									<p>
										<strong> </strong>
									</p>
									...
									<ul>
										<li><strong>1000s of giant companies</strong> in
											Information &amp; Communications Technology (ICT), Social
											Media, Pharmaceuticals, and Finance have their European
											headquarters (HQ) or their largest European operations in
											Ireland. And these are some really big companies that need a
											lot of talented and educated workforce eg. Google, HP, Apple,
									...
									<ul>
										<li><strong>One year post study work</strong> is available
											in Ireland after the student finished the course.</li>
									</ul>
									<p>&nbsp;</p>
									<ul>
										<li><strong>Cost of studying</strong> in Ireland is half to
											1/3rd as compared to studying in some other popular
											destinations.</li>
									</ul>
									<p>&nbsp;</p>
									<ul>
										<li>Ireland is one of the <strong>safest</strong> and the <strong>friendliest</strong>
									...
									<ul>
										<li>Ireland is <a
											href="https://en.wikipedia.org/wiki/Languages_of_Ireland"
											target="_blank" rel="noopener noreferrer"><strong>100%
													English speaking</strong></a> and hence the communication becomes
											extremely easy
										</li>
									</ul>
									<p>&nbsp;</p>
									<ul>
										<li>Northern Ireland is a <strong>part of the UK</strong>
											and Southern Ireland is known as <strong>the Republic
												of Ireland</strong></li>
									</ul>
									<p>&nbsp;</p>
									<p>
										Check out <a href="why_study_in_ireland"
											target="_blank" rel="noopener noreferrer">Why Study in
											Ireland</a>  that will categorically explain the reasons to obtain
										a top quality education in Ireland
									</p>
									<p>&nbsp;</p>
									<h2>Ireland Education Counselling</h2>
									<h2>Here is how we help with Ireland Education Counselling?</h2>
									<h4></h4>
									<h4>Save:</h4>
									<p>We save you some application fee required while applying
										to Irish Universities. Believe it!</p>
									<p>&nbsp;</p>
									<h4>Shortlisting:</h4>
									<p>Based on your interest area, future plans, career
										objectives, budget and several other factors, we help you select
										the right Bachelors programmes to apply to in Ireland</p>
									<p>&nbsp;</p>
									<h4>Application Documentation:</h4>
									<p>We guide to with your documents required for applying to
										Bachelors programmes in Ireland. This includes helping you build
										the right CV, editing suggestions to your statement of purpose
										(SOP), and other documents</p>
									<p>&nbsp;</p>
									<h4>Application:</h4>
									<p>We apply for you to Irish Universities where we guide you
										on filling the application forms, checking the content,
										rectifying any errors, and submitting the application.</p>
									<p>&nbsp;</p>
									<h4>Follow Ups:</h4>
									...
									<p>Once your offers are in, we help you finalize on the right
										Bachelors programme for you at the right University. Often
										students face a dilemma here.</p>
									<p>&nbsp;</p>
