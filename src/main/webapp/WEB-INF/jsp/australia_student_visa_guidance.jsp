...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2019/06/Torrens-University-Australia-Overseas-Education.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Australia Student Visa Guidance</h1>
						...
						<div id="breadcrumbs-wrapper">
							<div class="container">
								...
								&#187; <span><a
									href="study_australia">Study in Australia</a> &#187;  <span class="breadcrumb_last" aria-current="page">Australia Student Visa Guidance</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h2>Let&#8217;s answer some questions for you:</h2>
									<p>&nbsp;</p>
									<h3>When can I apply for the visa?</h3>
									<p>To apply for your visa you need to have the Confirmation
										of Enrolment (CoE) from your university. The CoE will be issued
										to you by your university after you accept your offer and make a
										part payment of your total fees. You also have to pay for  the
										Overseas Student Health Cover before the CoE is issued. The
										amounts to both these will be mentioned on your offer letter.</p>
									<p>The CoE contains an official course (CRICOS) registration
										code along with the start and end dates. The CoE is also called
										as eCoE as it is issued electronically.</p>
									<p>Note: You can apply for your visa 124 days, approximately
										4 months before your course start date.</p>
									<h3>What&#8217;s my visa type?</h3>
									<p>Higher Education Sector: Temporary Visa (Subclass 573) PG
										and UG coursework degrees and Subclass 574 for PG research
										degrees.</p>
									<h3>What is the visa fee?</h3>
									<p>Demand Draft in INR in the name of &#8220;Australian High
										Commission&#8221;, payable at New Delhi</p>
									<p>AUD 535$ = INR 30,200 (Fees are revised every July, make
										sure you check before applying) Plus, INR Demand Draft in the
										name of &#8220;VFS Global Services Pvt. Ltd&#8221; INR 910</p>
									<h3>How soon can I travel to Australia?</h3>
									<p>You can travel to Australia 90 days before your course
										starts</p>
									<p>Can I work on if I have an Australian student visa?</p>
									<p>Yes, you can work 20 hours per week and 40 hours during
										your vacations.</p>
									<h3>Can I work in Australia after my studies are over?</h3>
									<p>Yes you can work in Australia after applying for the
										relevant post-study work visa:</p>
									<ul>
										<li>Bachelors and Masters degree holders are eligible to
											apply for a 2 year post study work visa in Australia</li>
										<li>Masters by research and Doctoral degree holders are
											eligible to apply for a 3 and 4 years post study work visa in
											Australia respectively</li>
										<li>All other students who have studied in Australia for a
											minimum of 2 years are eligible to apply for an 18 months work
											visa in Australia</li>
									</ul>
									<p>
										<strong>Students must have at least two years of
											academic study in Australia</strong> in order to be eligible for a post
										study work visa. You may get a single degree or multiple degrees
										but the total duration of your study must be at least two
										academic years. For eg. say you first studied a 1 year <a
											href="http://msi.unimelb.edu.au/study/graduate/master-of-information-systems/1-year/">Master
											of Information Systems (MIS)</a> at the University of Melbourne or
										the Masters of Engineering Science at the University of
										Queenland and the you finished a 1 year of <a
											href="https://mbs.edu/programs/full-time-mba/program">MBA
											from Melbourne Business School</a>, then you can apply for the post
										study work visa. If you would have studied only one of these
										degrees, the you will not be eligible to apply for a Post Study
										Work Visa in Australia
									</p>
									<p>&nbsp;</p>
									<h3>What are the documents that I need to apply for an
										Australian student visa?</h3>
									<ul>
										<li>Notarized copies of all 36 pages of your passport and
											one separate notarised copy of the first and last page</li>
										<li>Visa Application Forms</li>
										<li>Six (4+2) recent passport size photographs in white
											background and a dark shirt colour</li>
										<li>eCOE, University offer letter, Offer Acceptance Form
											and copy of Demand Draft of tuition fee deposit paid</li>
										<li>IETLS Score sheet &#8211; notarised copy</li>
										<li>Work Experience Certificate of Applicant (if any
											&#8211; Current and Previous) &#8211; notarised copy</li>
										<li>Degree Certificate along with all 3/4 years mark sheets
											of graduation / Post graduation &#8211; notarised copies</li>
										<li>Board Certificate and mark sheet of XII and X &#8211;
											notarised copy</li>
										<li>Statement of Purpose &#8211; notarised copy</li>
										<li>Any other relevant certificates related to course
											&#8211; notarised copy</li>
									</ul>
									<p>&nbsp;</p>
									<h4>Financial Documents:</h4>
									<p>
										1.Original <u>&#8221;Affidavit of Support&#8221;</u> on stamp
										paper of Rs. 100/- in the name of sponsor / parents. A separate
										stamp paper for each sponsor. Notarised
									</p>
									<p>
										2.Enclosed <u>proof of relationship</u> with the sponsor if
										parents aren&#8217;t sponsors e.g. passport copy, birth
										certificate, year 10th certificate, marriage certificate,
										photographs of marriage, voter ID card, etc.
									</p>
									<p>
										3.Original <u>Education Loan Sanction Letter</u> from
										nationalized bank and original documents related to Loan
										security i.e. loan disbursement Letter, Title Verification
										Search Report, Bank Valuation Report, Sale Deed and Visiting
										card of the branch manager or Loan issuing person
									</p>
									<p>
										4.Current <u>Bank Balance Certificate</u>, Bank Statement or
										Pass Book of last six months and Other Certificates showing
										balance with acceptable funds:
									</p>
									<p>&nbsp;</p>
									<ul>
										<li>Saving A/c&#8217;s in Nationalized Bank only (any
											proof, explanation for recent bank entries) and current dated
											Bank Balance Certificate</li>
										<li>Fixed Deposit Receipt + FDR Balance Certificate</li>
										<li>GPF / EPF / CMPF and Provident Fund Balance cum
											withdraw-able letter</li>
										<li>Public Provident Fund + PPF Balance cum withdraw-able
											letter</li>
										<li>For Business Concern &#8211; Current Account Bank
											Statement of 1 Year + Balance Certificate</li>
										<li>P.O. &#8211; Monthly Income Scheme passbook copy +
											Balance Certificate</li>
										<li>P.O. &#8211; Recurring Deposit passbook copy + Balance
											Certificate</li>
									</ul>
									<p>&nbsp;</p>
									<p>
										<strong>NOTE the following are UNACCEPTABLE funds are:</strong>
									</p>
									<ul>
										<li>Post Office Deposits i.e NSC, KVP and NSS</li>
										<li>Deposit with Companies, Chit Funds</li>
										<li>LIC Surrender Value Quotation</li>
										<li>Investments in Shares, Bonds and Debentures</li>
									</ul>
									<p>5.Original Chartered Accountant statement and Student
										Financial Sheet. (we will provide the format) &#8211; Financial
										Matrix</p>
									<p>6.In case of company sponsorship: Balance Sheet of (3
										yrs), Income Tax Returns (3 yrs), Bond signed with the company,
										Registered deed of ownership (property).</p>
									<p>
										Yeah! we know you’re confused, we suggest just fix an
										appointment with us and this will all be sorted for you. Write
										to 
										or call +91 9000133877
									</p>
													...
													<div class="tab-content">
														<div
															id="menu1" class="tab-pane fade in active">
																<p style="padding:15px">We are experts at what we do. Since 2019, 
with prior experience of 14 years we have
