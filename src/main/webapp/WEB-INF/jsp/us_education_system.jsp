			...
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						...
						<div id="breadcrumbs-wrapper">
							<div class="container">
								<p id="breadcrumbs">
									...
									<span><span><a href="index">Home</a> &#187; <span><a href="study_in_usa">Study in USA</a> &#187; <span class="breadcrumb_last" aria-current="page">USA EDUCATION SYSTEM</span></span></span></span>			
					    ...
					    <div class="container">
							...
							<h1>USA Education System</h1>
								<p>
									USA offers the world&#8217;s most flexible education system. Each
									university can determine the content of the program and
									admission standards. Transfer of credits is possible ensuring
									smooth lateral movement i.e. one can change from one
									institution or course to another. Students can decide their
									area of specialization and US has it on offer. There are public
									and private universities, faith-based and secular universities,
									ivy league universities, liberal arts and community colleges.
									In short, there are a lot of options on this buffet. The
									grading system isn&#8217;t % or 10 scale GPA, it&#8217;s a 4 scale GPA.
									This is generally why they require credential evaluations from
									international students. This however, shouldn&#8217;t stop you from
									studying MS in USA (or whichever course it is you want to do!).
									Cost is calculated in <a
										href="https://www.xe.com/currencyconverter/convert/?Amount=1&amp;From=USD&amp;To=INR"
										target="_blank" rel="noopener noreferrer">Dollars</a>.
								</p>
