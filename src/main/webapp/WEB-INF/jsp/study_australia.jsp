...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2020/01/banners/Australia.jpg"
							...
							<div class="container">
								<p id="breadcrumbs">
									<span><span><a href="index">Home</a>
											&#187; <span class="breadcrumb_last" aria-current="page">Study in Australia</span></span></span>
								</p>
							</div>
						</div>
						<div id="why-study-in" style="background-color:#00a0af    !important">
							<div class="container">
								<h2 style="color:#fff !important">Why study in Australia</h2>
								<div>
								<p><strong>Quality of Education + Close to India + Quality of Life + Safe Country + Reasonable Fee as compared to many Countries </strong></p>
									 <p>Australia. Australia. Australia. – that’s where Cricket happens!</p>
                        <p>Here are our simple reasons to tell you that if you decide to study in Australia, you are making a great choice:</p>
                        <p>Suitable Climate + Top Education + Work during Study + Work after Study + Australia Immigration</p>
                        <p>15 Years Education Accepted: If you wish to study an MBA in Australia or an MS in Australia, you can directly apply after your Bachelors. You can immediately start your Masters level study in Australia in the same year that you finish your</p>
                        <p style="margin-top:10px;"><a href="why_study_in_australia">Continue reading...</a></p>
								</div>
							</div>
						</div>
					...
					<div id="left-area">
							...
							<div id="country-dashboard" style="margin-top:30px;marrgin-bottom:20px">
								...
								<div id="how-can-we-help-eop">
									<h2 style="color:#FD9601">Australia Admission Counseling</h2>
									...
									studying in Australia hassle-free.
