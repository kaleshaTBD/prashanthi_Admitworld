			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>New Zealand Counseling Packages</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_newzaland">Study in
										New Zealand</a> &#187;  <span class="breadcrumb_last" aria-current="page">New Zealand Counseling Packages</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
										...
										<h2>It’s not always about money, is it!</h2>
										<p>&nbsp;</p>
										<table>
											<tbody>
												<tr>
													<td width="366"><strong>Our Service</strong></td>
													<td width="250"><strong>Cost</strong></td>
												</tr>
												<tr>
													<td width="366">Selecting the right course</td>
													<td width="250">Rs 0</td>
												</tr>
												<tr>
													<td width="366">Selecting the right set of universities</td>
													<td width="250">Rs 0</td>
												</tr>
												<tr>
													<td width="366">Sending you draft CV, SOPs,
														recommendation letters, other documents</td>
													<td width="250">Rs 0</td>
												</tr>
												<tr>
													<td width="366">Editing statement of purpose (SOP)</td>
													<td width="250">Rs 0</td>
												</tr>
												<tr>
													<td width="366">Making applications to 6 Universities</td>
													<td width="250">Rs 0</td>
												</tr>
												<tr>
													<td width="366">Following up with Universities on your
														behalf</td>
													<td width="250">Rs 0</td>
												</tr>
												<tr>
													<td width="366">Securing admission and finalizing your
														University</td>
													<td width="250">Rs 0</td>
												</tr>
												<tr>
													<td width="366">Guiding you through the visa process
														(visa documentation, mock interview rounds, appointment
														booking, etc.)</td>
													<td width="250">Rs 0</td>
												</tr>
												<tr>
													<td width="366">Helping you book your accommodation</td>
													<td width="250">Rs 0</td>
												</tr>
												<tr>
													<td width="366">Helping you find the right flights,
														buying forex, etc.</td>
													<td width="250">Rs 0</td>
												</tr>
												<tr>
													<td width="366">Replying to 1000s of your questions or
														reducing your parent’s anxiety</td>
													<td width="250">Rs 0</td>
												</tr>
											</tbody>
										</table>
										<p>&nbsp;</p>
										<p>What else do you want? Indeed, our services are free of
											cost. There are no hidden charges whatsoever. Visit us once or
											book your free consultation with us.</p>
										<p>&nbsp;</p>
									</div>
