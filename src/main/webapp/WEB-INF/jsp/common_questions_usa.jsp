...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2019/08/Georgian-College-Canada.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Common Questions – FAQs</h1>
						...
						<div id="breadcrumbs-wrapper">
							<div class="container">
								<p id="breadcrumbs">
									...
									<span><span><a href="index">Home</a> &#187; <span><a href="study_in_usa">Study in USA</a> &#187; <span class="breadcrumb_last" aria-current="page">Common Questions – FAQs</span></span></span></span>			
					    ...
					    <div class="container">
							...
							<div class="entry-content">
								<h1 style="color: #002868" >Common Questions – FAQs &#8211; USA</h1>
								<h2></h2>
								<h2 style="color: #002868">5 Common Questions – FAQs &#8211; USA</h2>
								<h3></h3>
								<h3 style="color: #002868">Where can I stay off campus?</h3>
								<p>In general, US Universities provide adequate information
									on accommodation when they send you your I 20. we may be able
									to get you in touch with other students or our previous
									students and they can help.</p>
								<p>&nbsp;</p>
								<h3 style="color: #002868">What&#8217;s an Ivy League Institute?</h3>
								<p>
									Technically, the Ivy League is an athletic conference between 8
									institutions &#8211;  Brown University, <a
										href="https://www.columbia.edu/" target="_blank">Columbia
										University</a>, <a href="https://www.cornell.edu/" target="_blank">Cornell
										University</a>, Dartmouth College, Harvard University, the <a
										href="https://www.upenn.edu/" target="_blank">University
										of Pennsylvania</a>, <a href="https://www.princeton.edu/"
										target="_blank">Princeton University</a>, and Yale University.
									They&#8217;re considered extremely prestigious and rank among the top
									10 in the USA.
								</p>
								<p>&nbsp;</p>
								<h3 style="color: #002868">What&#8217;s the difference between assistantships and
									fellowships?</h3>
								<h4 style="color: #002868">Assistantships &#8211;</h4>
								<p>Students provide services to the university e.g.
									assisting in teaching or research, in exchange for funding the
									students. This will help you network as well as add to your
									resume!</p>
								<h4 style="color: #002868">Fellowships &#8211;</h4>
								<p>Students receive funds from the university without having
									to give anything back.</p>
								<p>&nbsp;</p>
								<h3 style="color: #002868">I want a scholarship to study in USA. What can I do?</h3>
								<p>
									Most universities will have their scholarship criteria and
									details listed on their websites. Most US Universities will
									directly consider you for applicable scholarships. Many
									Universities email you about the details with the requirements,
									essays to be written, etc. You can also look into bodies in
									India to apply for a scholarship e.g. Aga Khan Foundation, Tata
									Endowment, Inlaks etc. You should know the <a
										href="https://www.xe.com/currencyconverter/convert/?Amount=1&amp;From=USD&amp;To=INR"
										target="_blank" rel="noopener noreferrer">value of dollars
										in rupees</a>.
								</p>
								<p>&nbsp;</p>
								<h3 style="color: #002868">What is MA USA?</h3>
								<p>An MA is a Master of Arts degree. If you pursue it in the
									USA it&#8217;s an MA from the USA. No special connotations here! An
									MS in USA stands for Master of Science in USA, while we&#8217;re on
									this topic.</p>
								<p>&nbsp;</p>
								<p>
									Please <a href="contact_us" target="_blank"
										rel="noopener noreferrer" style="color: #002868">contact us</a> in case you are
									planning to study in USA. We help our students with admission
									counseling.
								</p>
