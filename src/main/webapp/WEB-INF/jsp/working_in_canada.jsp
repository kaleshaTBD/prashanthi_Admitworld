							...
							<div class="container">
								...
								&#187; <span><a
									href="study_canada">Study in
										Canada</a> &#187;  <span class="breadcrumb_last" aria-current="page">Working in Canada</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
						...
						<div class="entry-content">
							...
							<h1>Working in Canada</h1>
							<h2>Working in CANADA during studies:</h2>
							<p>Many Universities and Colleges encourage you and connect
								you with companies with who you can work during your holidays.
								Keep in touch with the career service unit at the
								University/College early on!</p>
							<p>
								<strong>a) Work On Campus in Canada: </strong>Students may work
								up to 20 hours per week for the University/College they are
								attending. Typical on-campus jobs might include working in a
								cafeteria or working in the Athletic Centre. These jobs are,
								however, scarce and usually on a first come, first served basis.
								There are jobs available for only a few students each semester
								and you shouldn’t count on getting an on-campus job during your
								first semester. Usually, all the jobs are filled by students who
								apply during the previous semester. You don&#8217;t need a work
								permit to work on campus.
							</p>
							<p>
								<strong>b)</strong> <strong>Work</strong> <strong>Off
									Campus in Canada</strong>: You may qualify to work off campus without a
								work permit. If you qualify, your study permit will allow you to
								work for a total of 20 hours per week and during vacations a
								maximum of 40 hours per week.
							</p>
							<p>
								<strong>c) Spouse Work permit: </strong>Your spouse may apply
								for an open work permit (which means they need not have a job
								offer or a labour market opinion from service Canada) if you are
								a full time student and have a valid study permit. Work permits
								of Spouse are valid for the same period of time as your study
								permit.
							</p>
							<p>
								<strong>d) Internship (Co-op) Work in Canada</strong>: Many
								Colleges and Universities at the undergraduate and graduate
								level have a Co-op option within their course curriculum which
								allows students to gain valuable work experience in line of
								...
								are studying at the college. The International student
								centres/advisors at the University / College where you are
								studying help you in this case.
							</p>
							<p>&nbsp;</p>
							<h2>Work after your studies:</h2>
							<p>
								To work in Canada you must apply for <strong>Post
									Graduation Work Permit Program</strong> (PGWPP). A student is allowed to
								stay back in the country for the length of your program upto a
								maximum of 3 years to look for a job and work full-time Over 90%
								of Canada’s college graduates are employed in their field of
								study within six months after graduation and 93% of employers
								are satisfied with graduates.
							</p>
							<p>
								<a href="contact_us">Contact us</a> in case you
								need admission counseling to study and plan for working in
								Canada.
							</p>
						</div>
