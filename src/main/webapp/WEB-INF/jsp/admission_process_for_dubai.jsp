...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2018/11/canada-dubai-1242434_1920-1-e1543830109548.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Application &#038; Admission Process for Dubai</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_dubai">Study in
										Dubai</a> &#187;  <span class="breadcrumb_last" aria-current="page">Application &#038; Admission Process for Dubai</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<p>&nbsp;</p>
									<p>
										<strong>STEP 1:</strong> Select your programme and finalize your
										Universities in Dubai and Abu Dhabi. We will help you do that
										based on your interest area, career plan, current academic
										background and scores, budget, more
									</p>
									<p>
										<strong>STEP 2:</strong> Collect your documents and submit them
										to us. For a list of documents to apply to Universities in
										Dubai, <a
											href="application_requirements_documents_dubai"
											target="_blank" rel="noopener noreferrer">check this page
											of our website</a> . Book your <a
											href="ielts" target="_blank">IELTS</a>
										test date. We can help you do that. Simply call +91 9000133877
										(between 10am and 7pm)
									</p>
									<p>
										<strong>STEP 3:</strong> Make online or paper application as
										indicated by each University. You will need to pay the
										application fee. We will help you plan your applications and do
										that for you, or shall help you fill out the forms correctly.
										Dispatch your documents to the right department in the
										University
									</p>
									<p>
										<strong>STEP 4:</strong> Follow up with the Universities and
									...
									<p>
										<strong>STEP 5:</strong> Collect admission offers and plan your
									...
									<p>
										<strong>STEP 6:</strong> Finalize one University that you wish
										to join and pay a deposit as required by the University. We will
									...
									<p>
										<strong>STEP 7:</strong> Prepare your documents for the Dubai
									...
									<p>
										<strong>STEP 8:</strong> Fly. Once you receive the visa,
										celebrate, buy your stuff, pack your bags, and fly. We will
										provide a pre-departure brief (eg. what to carry when you are
										going, about life in Dubai, etc.), help you connect with other
										students going to Dubai, help you book your accommodation and
										much more
									</p>
								</div>
