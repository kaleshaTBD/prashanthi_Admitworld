...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2018/11/singapore-811114_1920-e1543827105614.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Application &#038; Admission Process for Singapore</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_singapore">Study in
										Singapore</a> &#187;  <span class="breadcrumb_last" aria-current="page">Application &#038; Admission Process for Singapore</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h2>Step-wise process of what you need to do if you wish to
										study in Singapore:</h2>
									<p>&nbsp;</p>
									<p>
										<strong>STEP 1:Select</strong> your program and finalize your
										Universities in Singapore. We will help you do that based on
										your interest area, career plan, current academic background and
										scores, budget, more.
									</p>
									<p>
										<strong>STEP 2:Collect</strong> your documents and submit them
										to us. For a list of documents to apply to Universities in
										Singapore, <a
											href="application_requirements_documents_singapore"
											target="_blank" rel="noopener">check this page of our
											website</a> . Book your <a href="ielts"
											target="_blank">IELTS</a> test date. We can help you do that.
										Simply call +91 9000133877 (between 10am and 7pm)
									</p>
									<p>
										<strong>STEP 3:Make</strong> online or paper application as
										indicated by each Singaporean University. You will need to pay
										the application fee. We will help you plan your applications and
										do that for you, or shall help you fill out the forms correctly.
										Dispatch your documents to the right department in the
										University
									</p>
									<p>
										<strong>STEP 4:Follow up</strong> with the Universities and
										ensure that they have received your documents and that nothing
										is missing. We will do that on your behalf and provide any
										additional information required by the University
									</p>
									<p>
										<strong>STEP 5:Collect</strong> admission offers and plan your
										next move (visa process, accommodation, etc.). We will keep
										sending you the offers and also will keep you updated on new
										information and updates. We will also be assisting you with your
										SCHOLARSHIP application at this stage.
									</p>
									<p>
										<strong>STEP 6:Finalize</strong> one University that you wish to
										join and pay a deposit as required by the University. We will
										help you make this crucial decision and also guide you on the
										financial matters, including how to transfer the deposit and
										getting you a confirmation from the University
									</p>
									<p>
										<strong>STEP 7:Prepare</strong> your documents for the Singapore
										student visa application. Book an appointment and apply for the
										visa. We will help you finalize your documents, check if they
										are in order and guide you in taking the visa appointment
									</p>
									<p>
										<strong>STEP 8: Fly.</strong> Once you receive the visa,
										celebrate, buy your stuff, pack your bags, and fly. We will
										provide a pre-departure brief (eg. what to carry when you are
										going, about life in Singapore, etc.), help you connect with
										other students going to Singapore, help you book your
