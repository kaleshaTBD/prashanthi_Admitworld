...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2019/07/School-of-Advanced-Study-University-of-London-UK.jpg"
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_uk">Study in
										UK</a> &#187;  <span class="breadcrumb_last" aria-current="page">UK Student Visa Guidance (Tier 4 Visa Guidance)</span></span></span></span>
					...
					<div class="entry-content">
						...
						<table width="636">
							<tbody>
								...
								<tr>
									...
									<td>You can apply for the Tier 4 (Child) student visa if
										you’re aged between 4 and 17 and want to study in the UK. If
										you are between 4-15 years old you must be coming to the UK to
										be educated at an independent fee-paying school.</td>
								</tr>
								<tr>
									<td width="158"><strong>Standard Visitor</strong></td>
									<td>You can apply for a child visitor visa if you are 17
										years old or under and want to study in the UK for up to 6
										months. You cannot switch to a Tier 4 child visa. If you want
										to apply for a Tier 4 child visa you must apply from your home
										country.</td>
								</tr>
								<tr>
									<td width="158"><strong>Tier 4 (General)</strong></td>
									<td>You can apply for a Tier 4 (General) student visa to
										study in the UK if you’re 16 or over and have been offered a
										place on a course.</td>
								</tr>
								<tr>
									<td width="158"><strong>Short Term Study</strong></td>
									<td>You can apply for a Short-term study visa if you’re
										doing a short course of study in the UK. This visa will allow
										you to come to the UK if you are 18 years or older and want to
										enter for up to 6 months to study a short course, up to 11
										months to study an English language course or do a
										short period of research up to 6 months as part of a degree
										course of your overseas study.</td>
								</tr>
							</tbody>
						</table>
						<h1 class="gem-c-title__text ">General student visa (Tier 4)</h1>
						<p>In general, students need to apply for a Tier 4 (General)
							Student Visa to study Foundation, Bachelors, Masters (or MBA),
							MPhil or PhD in the UK.</p>
						<h2>UK Student Visa Requirements for Indian Students</h2>
						<h3>
							UK Student Visa Financial Requirements<u></u>
						</h3>
						...
						<ul>
							<li><strong>Course Fee</strong>: Course fee for ONE year <em>(even
									if the course is of higher duration)</em> towards your tuition as
								shown on the CAS letter. Reduce the amount that you would have
								already paid to the University as tuition fee deposit (or
								advance fee payment). This amount should also reflect on your
								CAS.</li>
							<li><strong>Maintenance Funds</strong>: This is basically
								your living cost in the UK. Maintenance funds need to be shown
								for upto 9 months <em>(even if the course is of higher
									duration)</em>. If your course is lesser than 9 months, then you
								...
								<ul>
									<li><strong>Outside London</strong>: £1,015 x 9 months =
										£9,135 if your University is located outside the inner London
										boroughs</li>
									<li><strong>London</strong>: £1,265 x 9 months = £11,385
										if your University is located inside the inner London boroughs</li>
								</ul></li>
						</ul>
						<p>
							<strong>Example</strong>:
						</p>
						<p>If you are joining a Masters course at the University of
							Warwick, and say the tuition fee is £20,000 for the full one year
							Masters, the funds you need to show are: £20,000 + £9,135 =
							£29,135 x Exchange Rate on the day of visa application (say, £1 =
							INR 90) = INR 26,22,150.</p>
						<p>
							Keep up to date on the exchange rate using <a
								href="https://www1.oanda.com/currency/converter/"
								target="_blank" rel="noopener noreferrer">Oanda</a> currency
							converter, which the UK embassy will also refer to. We recommend
							that you keep extra money in your account in case of changes in
							the exchange rate.
						</p>
						<h4>2. Methods to show the funds for UK Student Visa</h4>
						<p>Funds can be shown only in one or a combination of the
							three ways below:</p>
						<ul>
							<li><strong>Savings Bank Account</strong>: Money should be
								in the applicant&#8217;s bank account or the bank account of
								either or both parents ONLY. It CANNOT be in the bank account of
								any other relative such as grandfather, uncle, aunt, family
								friend. The money however can be in a joint account with anyone
								as long as you are named on the account.</li>
							<li><strong>Fixed Deposits</strong>: The fixed deposits
								should be either in the applicant&#8217;s name or in the name of
								either of the parents&#8217;. The FD however can be held jointly
								with anyone as long as you or either of your parents are named
								on the account.</li>
							<li><strong>Education Loan</strong>: An <strong>unconditional</strong>
								education loan sanctioned in the name of the applicant only is
								also acceptable for UK student visa application. Personal loans
								are not acceptable.</li>
						</ul>
						<p>
							<strong>Other Liquid Assets</strong>:
						</p>
						<p>PPF, PF, KVP, gold valuation, value of demat holdings,
							mutual funds or any other liquid assets other than the ones
							listed above are NOT acceptable.</p>
						<p>
							<strong>Acceptable Banks</strong>:
						</p>
						<p>
							Your bank has to be an accepted financial institution as per
							UKVI. Refer to <strong><em>&#8220;</em></strong><strong><em><a
									href="https://www.gov.uk/guidance/immigration-rules/immigration-rules-appendix-p-lists-of-financial-institutions">Banks
										Accepted</a></em></strong><strong><em>&#8220;</em></strong><em>. </em>This
							means, the money you hold in either the savings account or in the
							form of an FD, should be with one of the banks listed in
							acceptable list of financial Institutions.
						</p>
						<h4>3. Financial Documents Required to Apply for UK Student
							Visa</h4>
						<p>
							<strong><u>Financial Documents</u> </strong>need to be in
							specific formats (list of financial documents is available below)
						</p>
						<ul>
							<li>Bank Statements OR Passbook to confirm the money is in
								the savings bank account. It should cover the 28 day period of
								holding the funds.</li>
							<li>Bank letter or balance certificate (confirming the
								balance in the savings account).</li>
							<li>Fixed Deposits (FD) original + FD Balance certificate
								(letter) confirming that the FD can be liquidated at any point
								of time. FD should be older than 28 days and should not mature
								until you get your student visa to study in the UK.</li>
							<li>Education Loan sanction letter (if any) + Cover letter
								(confirming that there are no pending conditions on the loan).</li>
							<li>Birth certificate, if funds are in the name of parents.
								If the funds are in the account of the applicant, birth
								certificate is not required.</li>
							<li>Affidavit from parents only if funds shown in parents
								account or if parents are guarantor for education loan.</li>
							<li>In case name varies in any documents (passport,
								marksheets, birth certificate) then an Affidavit that states
								that all the names are of one and the same person.</li>
						</ul>
						<h3>TB Testing for UK Student Visa</h3>
						<p>
							<strong><u>TB Testing</u></strong> is mandatory. Testing can only
							be done from one of the approved clinics. Refer to <strong><em>&#8220;<a
									href="https://www.gov.uk/government/publications/tuberculosis-test-for-a-uk-visa-clinics-in-india/tuberculosis-testing-in-india"
									target="_blank" rel="noopener noreferrer">TB Testing
										&#8211; Approved Clinics in India</a>&#8220;
							</em></strong><em>. </em>
						</p>
						<p>5. MAKE SURE YOU HAVE ALL YOUR FINANCIAL DOCUMENTS IN HAND
							WHEN YOU ARE TAKING YOUR                       APPOINTMENT. i.e.:
							Do not submit your visa application (for an appointment) on 12th
							August and have your           financial documents dated 14th
							August</p>
						<p>
							6. <u></u><strong><u>Online Visa application</u></strong>
						</p>
						<p>
							UK Visa Fees for students (Tier 4 visa) is Rs. 33,810/- (£322) as
							of July, 2015. Visa Fees will have to be paid online using Visa
							or MasterCard debit or credit card. UK Visa Application Link: <a
								href="https://www.visa4uk.fco.gov.uk/">https://www.visa4uk.fco.gov.uk/</a>
						</p>
						<p>&nbsp;</p>
						<h2 style="padding-left: 30px;"></h2>
						<h2></h2>
						<h2>Important points to note about your UK student visa
							application:</h2>
						<p>
							1.<strong> Sponsor</strong>: While filling your visa application
							your Sponsor is your University not your parents. So enter the
							University name
						</p>
						<p>
							2.<strong>Travel Date</strong>: If you&#8217;ll be studying for
							more than 6 months in UK, you can go there 1 month before your
							course starts. So select the date of arrival in the UK
							accordingly
						</p>
						<p>
							3.<strong>Booking your Appointment:</strong> Before selecting a
							visa application centre on Visa4UK, you will be asked to confirm
							the type of appointment you want. When applying for a Tier 4
							Student visa, you&#8217;re required to book the appointment as
							follows:
						</p>
						<ul>
							<li>Select appointment location</li>
							<li>Select appointment type which should be <strong>‘PBS
									Tier 4 Student’</strong></li>
						</ul>
						<p>
							<strong>Note</strong>: You should only pick up the Tier 4 student
							option and <strong>not</strong> the Standard appointment
						</p>
						<ul>
							<li>Select appointment Date and Time</li>
						</ul>
						<p>If an appointment is booked in a wrong category, centre
							won&#8217;t let you in or accept your application</p>
						<p>
							4.UK <strong><u>Immigration Health Surcharge (IHS)</u></strong>:
							From 5 July, UK Visas and Immigration (UKVI) is improving how
							applicants pay the IHS of GBP 225. If an IHS reference (or
							payment) is needed, you will be automatically directed through
							the IHS process when you complete your online visa application.
							All Indian students will need to pay this amount. For Bachelors
							students, you have to pay the IHS fee for all 3 years. You can
							calculate the cost of IHS <a
								href="https://www.immigration-health-surcharge.service.gov.uk/checker/type">here</a>
						</p>
						<p>
							5.<strong>Biometric Residence Permit (BRP)</strong>: April 2015
							onward, students will be issued with a sticker in their passport
							instead of the vignette. This sticker will be valid for 30 days
							from the applicant&#8217;s intended date of travel. Once the
							applicant arrives in UK, they have 10 days to go to the post
							office and collect their Biometric Residence Permit (BRP) for the
							rest of their stay in the UK. Your University may also be a
							location from where you can collect your BRP. Your University may
							provide the BRP number (code) which must be entered in the visa
							application before submission
						</p>
						<p>
							6.<strong>Photo</strong>: Your photos (4) must meet UK Visas and
							Immigration (UKVI) <a
								href="https://www.gov.uk/photos-for-passports">requirements</a>.
							You can also have the photos taken inside the VFS when you go for
							the appointment ( 204/4 copies)
						</p>
						<p>
							7.<strong>Biometric &amp; UK Visa Interview</strong>: When
							submitting your documents at the VFS you will be required to get
							your biometrics done &amp; you will be interviewed over skype at
							the centre by the Home Office in the UK. Prepare well for the UK
							visa interview
						</p>
						<p>
							8.<strong>UK Visa Process Time (Tier 4 Visa): </strong>12 Working
							days (in general). Priority visa service (at higher visa fees
							&#8211; £120) is also available where the decision is made within
							3 to 5 working days
						</p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
						...
						<ul>
							...
							<li>Valid Passport (6 months validity) with at least 1 page
								that is blank on both sides</li>
							<li>Previous Passports (if any) and photocopies of visas or
								stamps in the passports</li>
							<li>1 recent passport-sized (45mm x 35mm) colour photograph
								of your face, which meets the requirements in UKVI’s photograph
								guidance <a href="https://www.gov.uk/photos-for-passports">Requirements</a>
							</li>
							<li>A printout of your online application form, signed and
								dated</li>
							<li>A completed self-assessment form, signed and dated
								&#8211; Appendix 8</li>
						...
						<p>
							<strong>PPF, PF, KVP, NSC, LIC Policies, Current
								(company) A/c statements – these documents are NOT accepted</strong>
						</p>
						<p>
							<strong>Only your parents can show the proof of funds if
								the fund is not in your account. No grandparents, uncles and
								aunts</strong>
						</p>
						<h4>
							<strong> </strong>
						...
						<ul>
							<li>Confirmation of Acceptance for Studies (CAS) – this is
								received from the University once a deposit payment is made</li>
							<li>All marksheets and other academic documents listed on
								your CAS</li>
							<li>Evidence of previous study or qualifications as
								mentioned on your CAS</li>
							<li><a href="ielts" target="_blank">IELTS</a>
								test result if it was required by the University and its mention
								on the CAS</li>
						</ul>
						<p>&nbsp;</p>
						<p>Note: The documentation may change based on what is mention
							on your CAS. Mostly the above list of documents will suffice</p>
						<p>&nbsp;</p>
						<h3>Visa Application Service Help by Admitworld</h3>
						<p>In order to complete your UK visa application efficiently
							and to increase the likelihood of its success, we help you
							completely in the process. Here is what we shall do:</p>
						<ol>
							<li>Initial consultation and checking your CAS and other
								documents</li>
							<li>Understand your financials and recommend the right list
								of documents to show</li>
							<li>Provide a checklist for necessary supporting documents
								including the formats</li>
							<li>Help you fill out the UK visa application form online</li>
							<li>Help you with the registration and payment</li>
							<li>Book an appointment for your documents to be submitted
								at a UK visa centre</li>
