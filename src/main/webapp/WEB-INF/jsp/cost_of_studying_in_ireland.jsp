...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2018/11/ireland-o2-dublin-reflection.jpg "
							alt="Master&#8217;s in Ireland" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Cost of Studying in Ireland</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_ireland">Study in
										Ireland</a> &#187;  <span class="breadcrumb_last" aria-current="page">Cost of Studying in Ireland</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
						<div class="entry-content">
							...
							<h1>Cost of studying in Ireland can be divided into;</h1>
							<h4></h4>
							<ol>
								<li><h2>Tuition Fees (Course Fees) as a part of cost
										of studying in Ireland</h2></li>
								<li><h2>Living Expenses as a part of cost of studying
										in Ireland</h2></li>
								<li><h2>Other Expenses as a part of cost of studying
										in Ireland</h2></li>
							</ol>
							<p>&nbsp;</p>
							<h3>Tuition Fees at Irish Institutions (in general):</h3>
							<p>
								<strong> </strong>
							</p>
							<table width="864">
								<tbody>
									<tr>
										<td width="363"><strong>Courses in Ireland</strong></td>
										<td width="265"><strong>Course Fee in Euro
												(range)</strong></td>
										<td width="236"><strong>Course fee in INR
												(range)</strong></td>
									</tr>
									<tr>
										<td width="363"><strong>Engineering courses in
												Ireland</strong></td>
										<td width="265">Euro 9100 to Euro 19000</td>
										<td width="236">Rs 5.9 lacs to Rs 12.5 lacs approx.</td>
									</tr>
									<tr>
										<td width="363"><strong>Science and Technology
												including IT related courses in Ireland</strong></td>
										<td width="265">Euro 9100 to Euro 19000</td>
										<td width="236">Rs 5.9 lacs to Rs 12.5 lacs approx.</td>
									</tr>
									<tr>
										<td width="363"><strong>Business related courses
												in Ireland</strong></td>
										<td width="265">Euro 8000 to Euro 16500</td>
										<td width="236">Rs 5.2 lacs to Rs 10.7 lacs</td>
									</tr>
									<tr>
										<td width="363"><strong>Arts and Humanities
												courses in Ireland</strong></td>
										<td width="265">Euro 9100 to Euro 15500</td>
										<td width="236">Rs 5.9 lacs to Rs 10 lacs</td>
									</tr>
									<tr>
										<td width="363"><strong>Medicine related courses
												in Ireland</strong></td>
										<td width="265">Euro 29000 to Euro 42000</td>
										<td width="236">Rs 19 lacs to 27 lacs</td>
									</tr>
								</tbody>
							</table>
							<p>
								<strong> </strong>1 Euro is calculated as Rs 65 in the above
								table. To know the rate now at this time please <a
							...
							<p>&nbsp;</p>
							<h2>Cost of studying in Ireland based on programs:</h2>
							<h4>
								<strong> </strong>
							</h4>
							<h3>MBA in Ireland</h3>
							<p>&nbsp;</p>
							<p>MBA in Ireland may cost between Euro 8000 to Euro 15000
								(except the UCD MBA which costs Euro 34500) (full course fee)</p>
							<p>&nbsp;</p>
							<h3>Masters in Ireland</h3>
							<p>&nbsp;</p>
							<p>Following Masters in Ireland will cost between Euro 10000
								to Euro 15000 (except for a few programmes that may go up to
								Euro 17000)</p>
							<h4>Masters in the field of:</h4>
							<p>&nbsp;</p>
							<ol>
								<li>Management</li>
								<li>Finance</li>
								...
								<li>International Business / Entrepreneurship</li>
								<li>Media</li>
								<li>Information Technology (IT)</li>
								<li>Information Systems</li>
								<li>Cloud Computing</li>
								<li>Data Analytics and/or Data Mining</li>
								<li>Software Engineering</li>
								<li>Project Management</li>
								<li>Computing (and/or Communications Software, Enterprise
									Software Systems, other combinations)</li>
								...
								<li>Biomedical Device Materials</li>
								<li>Pharmacy (Clinical Pharmacy)</li>
								<li>Pharmaceutical Technology and/or Quality Systems</li>
							</ol>
							<p>
								<strong> </strong>
							</p>
							<h3>Bachelors in Ireland</h3>
							<p>&nbsp;</p>
							<h4>Tuition Fees:</h4>
							<p>Most Bachelors Degree in Ireland costs between Euro 7000
								to Euro 11000 per year.</p>
							<p>&nbsp;</p>
							<h4>Popular Bachelors Degrees:</h4>
							<p>
								<strong> </strong>Some extremely popular Bachelors degree in
								Ireland are Business Management (or BBA), Software Systems, IT,
								Computer Science, Gaming Technology, Biomedical Science, Data
								Science, Pharmacy, Medicine.
							</p>
							<p>&nbsp;</p>
							<h4>Living Expenses in Ireland:</h4>
							<p>Cost of living is generally between 7000 and 10000 euros
								per year. This includes your accommodation, food, travel, books,
								some warm clothing, etc. It all depends on where are you
								studying Ireland and what type of accommodation you choose
								largely</p>
							<p>&nbsp;</p>
							<p>&nbsp;</p>
							<h2>Other Expenses under cost of studying in Ireland:</h2>
							<p>&nbsp;</p>
							<h3>This includes the following:</h3>
							<p>Visa application, travel insurance, medical insurance*,
								mobile phone and such other expenses.</p>
							<p>&nbsp;</p>
							<h4>Medical Insurance*:</h4>
							<ul>
								<li>You are required to show proof of comprehensive medical
									insurance when registering with the Garda National Immigration
									Bureau</li>
								<li>Proof of health insurance is also required when
									applying for a student visa and before entering in to Ireland</li>
								<li>Both travel and medical Insurance is valid for only one
									year</li>
							</ul>
							<p>&nbsp;</p>
							<h2>Super News:</h2>
							<p>&nbsp;</p>
							<p>
								Indian students who stay in Ireland for at least one year are
								eligible for public hospital treatment under the same conditions
								as an Irish citizen. Under this scheme, students pay Euro 100
								for a visit to the Emergency Department (ED) and, on admission
								to hospital, a further Euro 75 per day up to a maximum of Euro
								750 for the first ten days. No further charges are incurred if a
								student remains in hospital for longer than this. Note: Students
								are not covered if they travel to Northern Ireland (in the UK)
								or other EU countries. Further information can be obtained at
								the<a href="http://www.hse.ie/eng/">Health Service
										Executive (HSE)</a>. This scheme does not apply to students
								staying for less than a year in Ireland.
							</p>
							<p>
								If you are planning to study in Ireland, we provide <a
									href="contact_us">free consultation</a> for
								the same.
							</p>
							<p>&nbsp;</p>
							<p>&nbsp;</p>
