...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2019/08/Simon-Fraser-University-Canada-1.jpg"
							...
							<div class="container">
								<p id="breadcrumbs">
									<span><span><a href="index">Home</a>
											&#187; <span class="breadcrumb_last" aria-current="page">PhD in Canada</span></span></span>
								</p>
							</div>
						</div>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
							...
							<h1>Study PhD in CANADA</h1>
							<p>
								<strong>Research</strong> is one of the key components of a
								Canadian post-secondary education. In Canada, government and
								industry together support research including:
								telecommunications, medicine, agriculture, computer technology,
								and environmental science. Canadian universities conducts more
								than one third of Canada&#8217;s research. This is one of the
								highest rates among OECD and G8 countries.
							</p>
							<p>
								Like the UK&#8217;s Russell Group and Australia&#8217;s Group of
								Eight, Canada has its own group of leading universities known as
								the <strong>Group of Thirteen (G13)</strong>. These institutions
								are among the most research-intensive in the country and
								specialize in offering joint research programs.
							</p>
							<h2>G13 institutions for PhD in CANADA are:</h2>
							<ul>
							...
							<p>&nbsp;</p>
							<h2>Quick notes on studying PhD in CANADA:</h2>
							<p>
								<strong>Duration of PhD in Canada</strong>: The doctoral degree
								usually requires three or four years of full-time residency,
								although a longer period of directed research and writing is
								often necessary to complete the doctoral thesis.
							</p>
							<p>
								<strong>Cost of PhD</strong>: There are several Graduate
								scholarships that are available to cover some of the costs of
								studying in Canada. The best source of funds tends to be
								individual universities and colleges, many of whom offer
								different types of scholarships that cover tuition costs or
								living expenses and sometimes both. Several awards are based
								solely on academic merit and therefore financial aid is not
								taken into account through the application process. The Canadian
								government also offers a range of awards for graduate students,
								as do a large number of individual universities.
							</p>
							<p>
								<strong>Who can apply for PhD in Canada</strong>: Students who
								have finished their Master’s degree. The universities may
								consider Bachelor students for a direct PHD, the duration of
								which would be longer than a regular one.
							</p>
							<p>
								<strong>English Language Proficiency</strong>: You can take
								either an <a href="ielts">IELTS</a> test
								or <a href="toefl">TOEFL</a>
								test to establish your English language abilities. The test
								could be done within one month from the date you decide to take
								the test i.e. preparing for the test, registering for the test,
								to appearing for it. If you need to register for the test or
								need help or coaching, you could contact us at +91 9000133877
							</p>
							<p>&nbsp;</p>
							<h2>Other Important Points:</h2>
							<p>
								<strong>Research Proposal</strong>: Students wishing to pursue
								PhD need to submit a research proposal that clearly outlines the
								title and the research that can be undertaken. The research
								proposal can be around 2500-3000 words. Your research proposal
								helps your future supervisors to understand your line of
								thinking. Your experience and ability to conduct research. And
								how your strengths will enable you to write your thesis. In
								addition,, a research proposal is a great tool that can help you
								to structure your thinking and outline the path you would like
								to follow during your PhD education.
							</p>
							<p>
								<strong>Connect with Professors</strong>: You will need to get
								in touch with professors at the university who conducts research
								similar to your interest. Once this is done, and they agree to
								be your guide, you can make an application at the university.
							</p>
							<p>
								<strong>Work During Study:</strong> You could work 20 hours /
								week during your term and 40 hours /wk during holidays.
							</p>
							<p>
								<strong>Work After Study</strong>: You could stay back for upto
								a maximum of 3 years to look for a job and work full-time. You
								do not need a job offer in hand to stay back.
							</p>
							<p>
								<strong>Visa: </strong>You should apply for a visa only, and
								immediately, after the school accepts. To apply for a visa you
								must complete and submit all required documents as requested by
								the Canadian government including the official acceptance
								document(s) from the University at which one will be studying.
								And if planning to study in Quebec, a Certificate of Acceptance
								from the Quebec government. And pay the required visa processing
								fee. A visa applicant may be required to undergo an interview
								with a Canadian Visa Officer and/or a medical examination and/or
								prove that you have sufficient funds to study and live in Canada
								and return to your country.
							</p>
							<h2>Permanent Residency option:</h2>
							<p>
								PhD graduates may be eligible to apply for permanent residence.
								<a href="contact_us">Reach out to us</a> in
								case you are planning to study PhD in Canada.
							</p>
							</div>
						<div id="how-can-we-help-eop">
							<h2 style="color: #c00026">CANADA ADMISSION COUNSELING</h2>
							In case you&#8217;re confused about your studies in , we
