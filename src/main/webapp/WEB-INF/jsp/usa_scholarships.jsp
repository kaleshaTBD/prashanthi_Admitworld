...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2018/11/usa-photo-27-02-16-12-18-12-e1543820973349.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>USA SCHOLARSHIPS</h1>
						...
						<div id="breadcrumbs-wrapper">
							<div class="container">
								<p id="breadcrumbs">
									...
									<span><span><a href="index">Home</a> &#187; <span><a href="study_in_usa">Study in USA</a> &#187; <span class="breadcrumb_last" aria-current="page">USA SCHOLARSHIPS</span></span></span></span>			
					    ...
					    <div class="container">
							...
							<h1 style="color: #002868">USA SCHOLARSHIPS</h1>
								<p>
									There are good chances for you to study in USA with
									scholarship. USA easily enjoys the advantage of providing more
									scholarships, financial assistance and bursaries to students as
									compared to the rest of the world. Most of our students who
									have applied to US schools at any level have managed to get
									some scholarship or the other. Generally, the criteria for
									scholarships is academic merit and the entrance test scores.
									Universities generally list the available scholarships on their
									Tuition and Funding webpage. You can apply for some at the
									application stage while others will only be open to you once
									you accept an offer at the university or reach there. There are
									different deadlines for each scholarship, which are sometimes
									before the application deadline itself! <a
										href="contact_us" target="_blank"
										rel="noopener noreferrer" style="color: #002868">Contact us</a> if you want to study
									in USA. You also need to know the <a
										href="https://www.xe.com/currencyconverter/convert/?Amount=1&amp;From=USD&amp;To=INR"
										target="_blank" rel="noopener noreferrer" style="color: #002868">value of dollars
										in rupees</a> while applying for scholarships.
								</p>
