...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2018/11/singapore-431421_1920-e1543827142362.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Bachelor’s in Singapore</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_singapore">Study in
										Singapore</a> &#187;  <span class="breadcrumb_last" aria-current="page">Bachelor’s in Singapore</span></span></span></span>
					...
					<div id="left-area">
									...
									<h2>
										<span style="font-weight: normal!msorm;">Quick notes on
											studying Bachelor’s in Singapore</span>:
									</h2>
									<h3></h3>
									<p>
										<strong>Duration of Bachelor&#8217;s in Singapore: </strong>The
										Bachelor’s degree programs are offered in almost every subject.
										The duration of the Bachelors course is 2 years to 3 years
									</p>
									<p>
										<strong>Intakes in Singapore: </strong>Majority of programs will
										admit students twice a year in August and January.  Each intake
										has a specific deadline of the submitting the application as
										provided by the University
									</p>
									<p>
										<strong>Fee Structure: </strong>The fee range for pursuing
										Bachelor’sin Singapore may range from S$ 15,000 to S$ 20,000
										depending upon the Institution and the course applied.
									</p>
									<p>
										<strong><a
											href="sat1"
											target="_blank">SAT</a> Requirement: </strong>In general, <a
											href="sat1"
											target="_blank">SAT</a> is not required to apply to
										Universities in Singapore. NUS however will need <a
											href="sat1"
											target="_blank">SAT</a> and <a
											href="sat1"
											target="_blank">SAT</a> II Subject Test (with Math Level 2
										being compulsory) for students who have not studied their IBDP.
									</p>
									<p>
									...
									<p>Once your offers are in, we help you finalize on the right
										Bachelors program for you. Often students face a dilemma at this
										stage when they receive more than one admit</p>
									<p>
										<strong> </strong>
									</p>
