							...
							<div class="container">
								...
								&#187; <span><a
									href="study_dubai">Study in
										Dubai</a> &#187;  <span class="breadcrumb_last" aria-current="page">Education System In Dubai</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
										...
										<h3>Colleges and Universities in Dubai:</h3>
										<p>The colleges and universities in Dubai have significantly
											increased in the last two decades making it the most popular
											destination to study abroad in the Middle East.  . Most of the
											colleges and universities are affiliating themselves to
											prestigious institutions abroad, and all the reputed
											Colleges/Universities use English as tuition language. The
											duration of the graduate programs depend upon the Institute and
											the program applied for.  Usually the programs offered are for
											3-4 years of duration</p>
										<h3>Postgraduate Education in Dubai:</h3>
										<p>
											The increasing number of the esteemed foreign University Campus
											in Dubai have led to a large number of Dubai&#8217;s
											universities offer various Master and PhD postgraduate programs.
											To learn more about postgraduate programs in Dubai and see a
											full <a href="dubai_universites">list
												of universities</a> and institutes that offer master and PhD
											programs.
										</p>
										<p>Technical Secondary School Length of programme is about
											6years and age level is from 12 to 18 years. Certificate/diploma
											awarded: Technical Secondary Diploma.</p>
										<p>&nbsp;</p>
										<h3>Courses Offered</h3>
										<p>&nbsp;</p>
										<h4>At Undergraduate levels:</h4>
										<p>
											With the combination of courses offered, Dubai almost covers all
											the fields of education one can think of pursuing
											professionally. The mentioned subjects are a brief division of
											these courses.<br /> Business Management, Accounting, Finance,
											Human resources management, Hospitality Management, Tourism,
											Psychology with counselling, Global social science, Advertising
											public relations Media, Business information systems,
											Information technology, Early childhood education, Fashion
											designing, civil engineering. Duration for the undergraduate
											program will be 3 to 4 years.
										</p>
										<p>&nbsp;</p>
										<h4>At Postgraduate levels:</h4>
										<p>The courses offered at post graduate levels as well cover
											major professional courses in demand with the current economic
											scenario.MBA, Retailing, Advertising, Supply chain management,
											International Business, Petroleum Engineering, International
											relations, Quality Management, Engineering Management, Strategic
											Marketing, Human resources management, Marketing
