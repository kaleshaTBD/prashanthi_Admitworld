							...
							<div class="container">
								...
								&#187; <span><a
									href="study_ireland">Study in
										Ireland</a> &#187;  <span class="breadcrumb_last" aria-current="page">MBA in Ireland</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
							...
							<h1>Study MBA in Ireland</h1>
								<h2>The advantages of studying for a MBA in Ireland:</h2>
								<p>
									<strong>Your 15 years of education are enough for
										admission:</strong> You can pursue your MBA in Ireland with 15 years of
									your Indian education ie. students who have studied, BCom, BMS,
									BMM, BBA and other equivalent three year degrees are accepted.
								</p>
								<p>
									<strong>Save time:</strong> A MBA in Ireland is generally of ONE
									year duration ie. you could finish your MBA early as compared to
									studying in India.
								</p>
								<p>
									<strong>Work after MBA:</strong> One year post study work permit
									is available after you complete your MBA in Ireland.
								</p>
								<p>
									<strong>MBA Fee Range:</strong> MBA programs in Ireland can cost
									you between Euro 8000 to Euro 16000 ie Rs. 5.2 lacs to Rs 10.5
									lacs. Some MBAs like the UCD MBA costs Euro 34500 ie. Rs 22.5
									lacs.
								</p>
								<p>&nbsp;</p>
								<h2>Irish Universities and Colleges that offer an MBA in
									Ireland:</h2>
								<p>University College Cork (UCC), Cork: Executive MBA</p>
								<p>Dublin Institute of Technology, Dublin: Part-time MBA</p>
								<p>University of Limerick (UoL) &#8211; Kemmy Business School,
									Limerick: Executive MBA</p>
								<p>Irish Management Institute (IMI), Dublin : Executive MBA</p>
								<p>University of Dublin &#8211; Trinity College, Dublin:
									Full-time MBA and part-time Executive MBA</p>
								<p>Dublin City University (DCU) Business School, Dublin:
									Executive MBA</p>
								<p>National University of Ireland, Galway (NUIG) &#8211;
									Cairnes Graduate School, Galway, Ireland: Executive MBA</p>
								<p>Griffith College Limerick (GCL), Limerick, Ireland:
									Full-time MBA in International Business and part-time MBA in
									International Business, and Distance Learning MBA</p>
								<p>University College Dublin (UCD) &#8211; Michael Smurfit
									School of Business, Dublin: Full-time MBA and Executive MBA</p>
								<p>Griffith College Dublin (GCD), Dublin: Full-time MBA in
									International Business and part-time MBA in International Business</p>
								<p>Warnborough College (WCD), Dublin: Distance Learning in MBA
									and International Executive MBA</p>
								<p>American College, Dublin (ACD): Full-time MBA and Part-time
									MBA</p>
								<p>Dublin Business School (DBS), Dublin: Full-time MBA and
									Part-time Executive MBA</p>
								<p>Institute of Technology, Carlow (ITC) :Part-time MBA</p>
								<p>Althone Institute of Technology (AIT), Althone: Executive
									MBA</p>
								<p>Cork Institute of Technology (CIT), Cork: Part-time MBA</p>
								<p>IBAT College Dublin, Ireland: Part-time MBA</p>
								<p>&nbsp;</p>
								<h2>Entry Requirement to study MBA in Ireland:</h2>
								<p>
									<strong>Course duration:</strong> 12 months (Full time MBA)<br />
									24 months (Part Time MBA)
								</p>
								<p>
									<strong>Fee:</strong> EU 12,000 to EU 34,500 (Depending on
									scholarships)
								</p>
								<p>
									<strong>Average <a href="gmat">GMAT</a>
										Requirement:
									</strong> 630
								</p>
								<p>
									<strong>Best Time to Apply:</strong> The sooner you apply, the
									better it is. We recommend our students to apply around November
									of the preceding year of when you are hoping to join. You could
									however make your applications until April/May of the same year if
									you wish to join in September. Irish Universities have specific
									awards for Indian students and it is advisable to apply well in
									advance to ensure you are able to receive maximum aid. Also, the
									visa process time is between four to eight weeks so an early admit
									means you get the chance to plan and prepare for your travel, stay
									etc.
								</p>
								<p>
									<strong>Remember:</strong> 1000&#8217;s of giant companies in
									Information &amp; Communications Technology (ICT), Social Media,
									...
									Genzyme and many more.
								</p>
								<p>&nbsp;</p>
								<h2>How we help?</h2>
								<p>
									<strong>Save:</strong> We save you a chunk of the application fee
									required while applying to Irish Universities. Believe it!
								</p>
								<p>
									<strong>Shortlisting:</strong><br /> Based on your area of
									interest, future plans, career objectives, budget and several
									other factors, we help you select the right MBA programs to apply
									to in Ireland.
								</p>
								<p>
									<strong>Application Documentation:</strong><br /> We guide to
									with your documents required for applying to MBA programs in
									Ireland. This includes helping you build the right CV, editing
									suggestions to your statement of purpose (SOP), and other
									documents.
								</p>
								<p>
									<strong>Application:</strong><br /> We apply for you to Irish
									Universities where we guide you on filling the application forms,
									checking the content, rectifying any errors, and submitting the
									application.
								</p>
								<p>
									<strong>Follow Ups:</strong><br /> We follow up on your behalf
									with the University to get you your admission offer letter.
								</p>
								<p>
									<strong>Finalization:</strong><br /> Once your offers are in, we
									help you finalize the right MBA program for you.
								</p>
								<p>
									<strong>Financial Matters:</strong><br /> We will guide on how
									you have to make your fee payment and get your confirmation from
									the University.
								</p>
								<p>
									<strong>Visa Guidance:</strong><br /> We guide you through the
									complete student visa process including suggesting the right
									documents, documentation check, applying for appointment,
									preparing the visa application file.
								</p>
								<p>
									<strong>Connect:</strong><br /> We try to connect you with other
									students who are going to Ireland or who are already studying
									there.
								</p>
								<p>
									<strong>Accommodation:</strong><br /> We guide you with booking
									of your accommodation in Ireland and/or transfer of any deposit
									and payments.
								</p>
								<p>Although the process for admission can seem effortless, the
									planning, preparing and execution of each step is crucial. Aside
									from the above steps, there&#8217;s so much more that we do during the
									entire process to make your journey successful and easy!</p>
