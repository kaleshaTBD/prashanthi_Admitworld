...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img src="wp-content/uploads/2019/08/Georgian-College-Canada.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>EASY ADMISSION PROCESS – CANADA</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_canada">Study in
										Canada</a> &#187;  <span class=	"breadcrumb_last" aria-current="page">Easy Admission Process – Canada</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
						...
						<div class="entry-content">
								...
								<h1>Easy Admission Process – Canada</h1>
								<p>Understand the recommended steps for Easy Admission Process
									–&nbsp; Canada</p>
								<h2>Steps for Easy Admission Process –&nbsp; Canada</h2>
								<table width="864">
									<tbody>
										<tr>
											<td><h3>
											...
											<td width="419"><strong>Your DIY Kit | To do list to
													study in USA</strong></td>
											<td width="384"><strong>When we are around</strong></td>
										</tr>
										<tr>
											<td><h4>STEP 1</h4></td>
											<td width="419"><strong>SEARCH</strong> – 100s of websites, all
												universities, specific courses. Here&#8217;s a list of Universities and
												Colleges in CANADA to give you a start</td>
											<td width="384"></td>
										</tr>
										<tr>
											<td><h4>STEP 2</h4></td>
											<td width="419"><strong>SHORTLIST</strong> – the right
												programme at the right list of Universities and Colleges in CANADA
												matching your academic background, test score, budget, other
												requirements.
												<p></p>
												<p>
													<strong>CREATE</strong> – an Excel workbook if that helps
												</p></td>
											<td width="384"></td>
										</tr>
										<tr>
											<td><h4>STEP 3</h4></td>
											<td width="419"><strong>COLLECT</strong> – Documents and ensure
												that each of these are correct and in order. This includes editing
												of the statement of purpose (SOP), getting recommendations from the
												right referees, writing and editing essays, internship and work
												experience letters and more. Here&#8217;s a <a
												href="application_requirements_documents_canada">list
													of documents required to study in CANADA to start with</a></td>
											<td width="384"></td>
										</tr>
										<tr>
											<td><h4>STEP 4</h4></td>
											<td width="419"><strong>BOOK</strong> – your <a
												...
												test date, prepare for it, check if you have scored right, update
												the University/ College and the right department and ensure that
												they have received the score once you receive it</td>
											<td width="384"></td>
										</tr>
										<tr>
											<td><h4>STEP 5</h4></td>
											<td width="419"><strong>APPLY</strong> - to all Universities
												and Colleges individually and keep a track of list of documents to
												be sent, and other requirements. It will start with questions like:
												where to apply, how to apply, is it online or a paper app, what
												about the application fee, so many more</td>
											<td width="384"></td>
										</tr>
										<tr>
											<td><h4>STEP 6</h4></td>
											<td width="419"><strong>TRACK</strong> and <strong>FOLLOW
													UP</strong> - track your emails, wait for the decisions, or update the
												missing documents, understand the next round of process, etc.</td>
											<td width="384"></td>
										</tr>
										<tr>
											<td><h4>STEP 7</h4></td>
											<td width="419"><strong>FINALIZE</strong> - make a final
												decision when you have more than one offer. Generally students
												apply to several Universities and Colleges and you are bound to
												face this stage. Crucially important is, that you make the right
												decision</td>
											<td width="384"></td>
										</tr>
										<tr>
											...
											<td width="419"><strong>DEPOSIT</strong> and <strong>FEE
													PAYMENT</strong> - pay your deposit or enrolment fee in CAD$ to the
												University / College, wait for a confirmation, or follow up with
												the University / College.</td>
											<td width="384"></td>
										</tr>
										<tr>
											<td><h4>STEP 9</h4></td>
											<td width="419"><strong>MEDICALS - </strong>Finish your medical
												examination and do the vaccinations as per student visa rules<strong>.</strong></td>
											<td width="384"></td>
										</tr>
										<tr>
											<td><h4>STEP 10</h4></td>
											<td width="419"><strong>VISA</strong> – Understand the student
												visa process, gather the right documents and check them thoroughly,
												book a visa appointment, wait for the decision. Here&#8217;s where you
												will find information about the <a
												href="canada_student_visa_guidance">visa
													process and documentation</a>. <strong>Note</strong>: You can open a
												Graduate Investment Certificate (GIC) Account in Canada where you
												will require approximately CAD$ 10000 to show your living expenses.
												<p></p>
												<p>During this time, decide on where you will live, what to
													pack before going, buy forex, medical and travel insurance and
													more</p></td>
											<td width="384"></td>
										</tr>
										<tr>
											<td><h4>STEP 11</h4></td>
											<td width="419"><strong>ACCOMMODATION - </strong>find and book
												the right type of accommodation</td>
											<td width="384"></td>
										</tr>
										<tr>
											<td><h4>STEP 12</h4></td>
											<td width="419"><strong>CONNECT</strong> - with other students
												so that you&#8217;ll may travel together or help each other</td>
											<td width="384"></td>
										</tr>
										<tr>
											<td><h4>STEP 13</h4></td>
											<td width="419"><strong>FLY</strong> - book tickets and fly.
												Ensure that you have collected details about how to open a bank
												account, about travelling locally in CANADA,, carried important
												documents along with you, bought the required forex and such other
												important information that comes up ONLY in the end</td>
											<td width="384"></td>
										</tr>
									</tbody>
								</table>
								<p>&nbsp;</p>
								<h2>
									<strong>Here&#8217;s how we will go about the process – Admitworld to your
										rescue!</strong>
								</h2>
								<p>Let&#8217;s TALK you through:</p>
								<h3></h3>
								<h3>Point 1</h3>
								<p>You can study just about anything that you wish to, at both
									undergraduate and postgraduate levels. All you have to do is tell us
									I want to study MS in CANADA or MBA in CANADA or Bachelors in
									CANADA or Diplomas, Advance Diplomas, Graduate Certificate in
									CANADA and we&#8217;ll give you the solution you require. Let us know about
									your preferences (location, budget, future plans, course
									specialization, interest in working in the CANADA or returning to
									India – and tons of other questions that we will ask you) and we will
									identify the best options available matching your profile. Canadian
									universities and colleges offer two main semester intakes: Fall
									(September / October), Winter (January ) and few programs may have a
									Spring (April to July) Intake.</p>
								<h3>Point 2</h3>
								<p>Selecting universities and colleges is quite a complicated
									process that we pride ourselves on. We help you pick the right mix of
									ambitious, moderate and safe universities and colleges for your
									admissions. We do this by matching your profile to the universities
									and colleges requirements and class average student. This is also the
									stage where information about finances and scholarships is dispensed.</p>
								<h3>Point 3</h3>
								<p>We recommend you select your universities and colleges before
									you take the tests because you will save some money by sending the
									scores to the correct university list (YES! You can report your scores
									to 5 Universities for free). Do not wait to apply to Canadian schools
									till you have given your tests. Instead, be realistic about the scores
									that you can achieve, decide on the universities you wish to apply
									(generally, restrict it to maximum 8 universities and colleges) and
									make your applications with the remaining documents. We can help you
									register for whichever tests it is you need to take. We can also coach
									you for the entrance exams. Our tutors have been working with us for
									years now and are qualified to help you reach your ideal score.</p>
								<h3>Point 4</h3>
								<p>Then comes the time to gather and edit your documents. Other
									than making you aware of which documents you need to collect, we will
									also help you edit and enhance documents like letters of
									recommendation (academic and professional), essays (topics are
									generally given by the universities), personal statement / statement
									of purpose, resume, scholarship essays (YES! They&#8217;re different!) etc.
									And let us tell you – We are GREAT at essay editing – ask any of our
									students! Then comes the tedious part - filling in the applications.
									We will help you do this and check this for you thoroughly as well.</p>
								<h3>Point 5</h3>
								<p>A big concern for most parents is finances. Once we understand
									your financial position, we will let you know which financial
									documents are acceptable &amp; preferable, and which you shouldn&#8217;t
									include for your applications. We will tell you how to present your
									case to the university and visa office. We have a bunch of formats and
									samples to help you with your bank statements, affidavits, and the
									like.</p>
								<h3>Point 5</h3>
								<p>Once your application is submitted, our role becomes that of a
									liaison. We follow up with universities and colleges for admission
									decisions and whether any documents are pending or required to get an
									offer.</p>
								<h3>Point 6</h3>
								<p>Once you have offers, we can also help you pick between
									universities and colleges and assist you with the time consuming, hair
									pulling, nail biting task of acquiring your visa. While it may seem
									odd at this stage, selecting which university or college in CANADA too
									go to is even more complicated than shortlisting universities and
									colleges! Other than filling out the forms and assisting you with your
									finances again, we take mock interviews to help you prepare of the big
									day. Once we&#8217;re done with you, your documents and confidence will both
									be in order. We will also help you open your (Graduate Investment
									Certificate) GIC Account in Canada.</p>
								<p>&nbsp;</p>
								<p>
									You can <a href="contact_us" target="_blank"
										rel="noopener noreferrer">contact us</a> for Easy Admission Process -
									Canada<strong>. </strong>Let us help you achieve YOUR dream!
								</p>
						</div>
