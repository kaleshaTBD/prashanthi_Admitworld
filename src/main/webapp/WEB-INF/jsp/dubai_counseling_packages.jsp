			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Dubai Counseling Packages</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_dubai">Study in
										Dubai</a> &#187;  <span class="breadcrumb_last" aria-current="page">Dubai Counseling Packages</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h2>Free Services:</h2>
									<p>
										<strong>We help you right from start to end in the
											process of studying in Dubai and the support is completely free
											of cost when you apply to many Universities. Isn’t that great?</strong>
									</p>
									<p>Only if you wish to apply to National Universities in
										Dubai or some world renowned programs like the INSEAD MBA,
										London Business School MBA or Masters, we charge for our
										services. These charges are completely based on the scope of
										work which will analyze after our first discussion. Only if we
										believe that you are eligible for applying and after reviewing
										the suitability, it will make sense for us to charge you;
										otherwise we will simply be happy to help!</p>
									<p>Call us today at +91 9000133877. Let’s discuss your future
										plan!</p>
									<p>&nbsp;</p>
									<h3>Our services will include:</h3>
									<ul>
										<li>Consulting and understanding your requirements (course
											interest, location, budget, future plans, etc.)</li>
										<li>Shortlisting and selecting the right set of Dubai
											Universities</li>
										<li>Documentation help and providing samples of CV,
											recommendation letters, statement of purpose etc.</li>
										<li>Editing of essays – we are great at this! Ask any of
											our current and past students</li>
										<li>Applications to all Universities – we will be doing
											this on your behalf</li>
										<li>Following up with Universities for your offers or any
											other requirements</li>
										<li>Securing admission offers and helping you finalize the
											University</li>
										<li>Helping you with scholarship applications and / or
											education loans</li>
										<li>Guiding you on financial matters (fee payments to
											Australian universities, financials required for Australia
											student visa applications, etc.)</li>
										<li>Visa process help – including helping you with the
											documentation, visa filing, etc.</li>
										<li>Pre-departure brief where we will tell you about the
											life and living in Dubai and much more</li>
										<li>Booking of accommodation, buying forex, flight tickets,
											etc.</li>
									</ul>
									<p>&nbsp;</p>
									<h3>However we won’t leave this opportunity to tell you why
										you should use our FREE help:</h3>
									<ol>
										<li>We’ve got over 12 years experience in placing students
											abroad</li>
										<li>We’ve visited Dubai and have seen most of the
											Universities and Institutions. We’ve met with University
											officials and we keep connecting with Universities and College
											in Dubai often to get you the perfect information</li>
										<li>We’ve understood the difference between studying in
											Dubai vis-a-vis another country and we can guide you extremely
											well – Use Our Experience</li>
										<li>We help you right from start to end in the process of
											applying to Dubai Colleges and Universities and thereafter with
											the visa process, helping you book the accommodation, buy
											forex, and much more</li>
										<li>We’ve already mentioned about – we help you for FREE
											and we SAVE you your application fee sometimes (whenever
											possible!)</li>
									</ol>
								</div>
