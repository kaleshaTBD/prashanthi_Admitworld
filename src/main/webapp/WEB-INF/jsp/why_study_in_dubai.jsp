			...
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_dubai">Study in
										Dubai</a> &#187;  <span class="breadcrumb_last" aria-current="page">Why Study in Dubai?</span></span></span></span>
						...
						<div id="why-study-in" >
								<div class="container">
								<h2>
									<strong>Cosmopolitan + Close to India + Economical
										Education + Quality of Life + Safe Country + Strong Network of
										Indian Community + 1 Year Work Permit + Tax Free Salary</strong>
								</h2>
								<p>&nbsp;</p>
								<p>Dubai is one of the growing educational hubs across the
									globe &#8211; providing a multicultural environment with increased
									settlement of foreign population enabling international experience
									&#8211; an integral part of pursuing studies abroad. Most of the
									international universities have their branches located in Dubai.
									Abu Dhabi being UAE’s capital city, Dubai is the largest city and
									it is going to host World Expo 2020. Dubai’s strategic location
									allows its provinces to be positioned within a 5 hour radius of
									half of the world&#8217;s population, bridging Asia to the West.</p>
								<p>
									<strong>Cosmopolitan: </strong>Dubai has an extremely high
									standard of living wherein millions of people from all over the
									world call it home, creating a truly cosmopolitan culture.
									Students in the UAE are exposed to more nationalities than
									anywhere else in the world, molding them to be truly globalized
									leaders for the 21st century.
								</p>
								<p>
									<strong>Proximity to India</strong><strong>: </strong>Dubai is
									well connected internationally &#8211; most importantly close to
									India as compared to other preferred destinations for studying
									abroad. It is a hardly a 3 hour flight from India making room for
									students to take low-cost flights back home at a moment’s notice!
								</p>
								<p>
									<strong>Affordable and Quality Education</strong><strong>:
									</strong>As compared to the education cost in many other popular
									destinations, Dubai provides high quality education at a very
									reasonable cost. Dubai further promises comprehensive options to
									students in terms of courses based on their qualification.
								</p>
								<p>
									<strong>Combination of East and West (degree):</strong> You can
									obtain a recognized foreign University degree (from US, UK, &amp;
									more) in Dubai at both – undergraduate and postgraduate level.
									Interestingly, these degrees in most cases will be cheaper as
									compared to studying the same in the respective Countries.
								</p>
								<p>
									<strong>Safety:</strong> There are students from all over the
									world coming to pursue further education in Dubai. The country is
									safe and the culture is diverse. The students here are welcomed by
									the nationals and women are treated with respect. People from
									other nationalities practise their religions easily without any
									external fear in Dubai.
								</p>
								<p>
									<strong>Active &amp; Vibrant Lifestyle: </strong>For adventure
									lovers there are a lot of activities to choose from. They are
									parasailing, desert safaris and mountaineering. The sea tours are
									enjoyable as well. Dubai houses the best golf courses in the
									world. The beaches are very relaxing and the scenic beauty of
									Dubai is a treat for the eyes.
								</p>
								<p>
									<strong>Tax Free Income (Jobs in Dubai) :</strong>The sectors
									emerging in Dubai include entertainment, education, banking and
									real estate. Macro-regulatory authorities are paying more
									attention to agriculture, entertainment, infrastructure and
									logistics and covering areas such as risk management, marketing
									and other investments in sectors of energy, manufacturing and
									financial operations to solidify the longer term stability and
									growth pool of Dubai. Tax Free Income is perhaps is one of the key
									selling points for study in Dubai as the career prospects are
									healthy in a range of sectors including Oil and Gas, Construction,
									Hospitality and Banking.
								</p>
								<p>
									<strong>Visa:</strong>Dubai has a hassle free visa process wherein
									the Dubai Institutions will apply for your visa making it all the
									more easy. Chances of getting a visa to study in Dubai are very
									high and you need not get tensed about attending rigorous
									interviews
								</p>
								<p>
									<strong>Intakes:</strong>Well, this is really a big benefit. Many
									Institutions have as many as start dates in January, May, July,
									August, September, November.  September is a major intake in
									Dubai, as in most of the courses will be available during this
									month.
								</p>
								<p>
									<strong>Strong Network of Indian Community:</strong>Indians form a
									large part of the population in the Dubai. With increasing
									opportunities in petroleum, construction, banking and IT sectors
									there has been an exponential increase in these numbers over the
									past few years. While most Indian migrants are a part of the
									manufacturing and transport industries, a sizeable number also
									form a part of the professional services sector.  Areas like Bur
									Dubai and Sharjah are densely populated with Indian Population. 
									Moreover Indian students will be excited to learn the Indian
									community in Dubai makes the most of all the Indian festivals like
									Diwali, Holi, Navratri etc.
								</p>
								<p>
									<strong>No language Barrier</strong><strong>:</strong> More than
									80 % of the population including the locals in Dubai speaks in
									English, making it convenient for foreign students to communicate
									and interact with the local population.
								</p>
