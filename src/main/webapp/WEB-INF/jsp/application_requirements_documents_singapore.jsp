			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Application Requirements &#038; Documents &#8211; Singapore</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_singapore">Study in
										Singapore</a> &#187;  <span class="breadcrumb_last" aria-current="page">Application Requirements &#038; Documents &#8211; Singapore</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h2>Documents required to be submitted for admissions in a
										Singapore University includes:</h2>
									<p>&nbsp;</p>
									<ul>
										<li>Filled application form of the University – for
											National Universities the applications will be online and for
											private Institutions, each University will have it own paper
											application form (in general) based</li>
									</ul>
									<p>&nbsp;</p>
									<p>
										<strong>&#8211;</strong>Attested copies of all your certificates
										X, XII &amp; Graduate Degree (if applicable), Mark Sheets
										including Backlogs (Re-sits)
									</p>
									<p>&nbsp;</p>
									<p>&nbsp;</p>
									<ul>
										<li>Transcript for degree College (especially for National
											Universities)</li>
									</ul>
									<p>&nbsp;</p>
									<p>
										<strong>&#8211;</strong>Evidence of English Language proficiency
										e.g. <a href="ielts" target="_blank">IELTS</a>,
										<a href="toefl" target="_blank">TOEFL</a>
										score report (if application). If you are seeking a waiver, then
										a letter from your degree Institution confirming that the medium
										of instruction at your Institution was in English (on the letter
										headed paper of the Institution)
									</p>
									<p>
										<strong>&#8211;</strong>Standardised Tests e.g. <a
											href="gmat" target="_blank">GMAT</a>, <a
											href="gre" target="_blank">GRE</a>, <a
											href="sat1"
											target="_blank">SAT</a> (if applicable)
									</p>
									<p>
										<strong>&#8211;</strong>Academic References as required which
										should be from your Institution (School / College) or Employer
										(minimum 2 recommendation letters are required)
									</p>
									<p>
										<strong>&#8211;</strong>Passport sized photographs
									</p>
									<p>
										<strong>&#8211;</strong>Statement of Purpose (SOP – Institute
										Specific)
									</p>
									<p>
									...
									<p>
										<strong>&#8211;</strong>Draft for application fees, if
										applicable
									</p>
									<p>
										<strong>&#8211;</strong>Design Portfolio (for Art, Design &amp;
										Architecture Courses)
									</p>
									<p>
										<strong>&#8211;</strong>Certificates &amp; Achievements of
										Extracurricular Activities (if available)
									</p>
									<p>
										<strong>Note</strong><strong>:</strong> The above mentioned
										documents are based on the general prerequisites and are
										subjected to the requirement of universities and individual
										courses in Singapore
									</p>
									<h3></h3>
									<h3></h3>
									<p>&nbsp;</p>
									<h3>For undergraduate applicants:</h3>
									<p>Besides the documents listed above as applicable, your
										school counselor can update the National Universities with the
										school report, predicted grades, etc.</p>
