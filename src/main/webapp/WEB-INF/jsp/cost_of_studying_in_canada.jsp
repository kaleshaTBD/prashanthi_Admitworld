			      ...
			      <div id="hero-wrapper">
						<img src="wp-content/uploads/2018/11/canada-desert-1009680_1920-1.jpg"
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Cost of studying in Canada</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_canada">Study in
										Canada</a> &#187;  <span class="breadcrumb_last" aria-current="page">Cost of studying in Canada</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
						...
						<div class="entry-content">
							...
							<h1>
								<strong>Cost of studying in Canada</strong>
							</h1>
							<p>
								Isn&#8217;t this the first aspect that comes to your mind when
								you think about studying in Canada? Indeed you must add up a <strong>list
									of costs</strong> when you decide to study in Canada. Before we talk
								about it, remember that education is an investment and students
								have done very well for themselves in Canada, not only
								recovering costs but have even made fortunes and becoming
								citizens of the country.
							</p>
							<p>&nbsp;</p>
							<h2>Cost of studying in Canada can be divided into three
								categories (for ease of understanding):</h2>
							<p>&nbsp;</p>
							<ol>
								<li><h4>
										<strong>Cost of Application (including academic
											entrance tests)</strong>
									</h4></li>
								<li><h4>
										<strong>Tuition Fees and Living Expenses</strong>
									</h4></li>
								<li><h4>
										<strong>Other Costs (like insurance, visa fee, air
											ticket, etc.) </strong>
									</h4>
									<h4> </h4></li>
							</ol>
							<h3> Cost of Application:</h3>
							<ol>
								<li><strong>Application Fees: </strong>CAD$ 50 to CAD$ 250
									per University and College (Although many colleges give
									Application fee waiver).</li>
								<li><strong> Courier Charges: </strong>Rs 1200 to Rs 1500
									per University (Canadian Universities need hard copies of your
									authenticated documents like transcripts).</li>
								<li><strong> Academic Test: </strong>Academic entrance
									examinations will cost you around US$ 100 to US$ 200 per
									examination, and most students take at least 2 tests. Assume
									that you will be spending at least US$ 500 on tests.</li>
								<li><strong> Score Reporting: </strong>Test scores like <a
									href="gmat">GMAT</a>, <a
									href="gre">GRE</a>, <a
									href="sat1">SAT</a>, <a
									href="toefl">TOEFL</a>,<a
									href="ielts"> IELTS</a> have to be
									reported by the testing agencies (like ETS), which may cost up
									to US$ 30 per University (an average cost for reporting scores
									of all tests you may have taken). Not required when applying to
									a college.</li>
							</ol>
							<p>
								<strong> </strong><strong>Note:</strong> Add some counselling
								charges that you will be paying to your counselor. To remind
								you, <strong>we enjoy saving your money</strong>!
							</p>
							<p>&nbsp;</p>
							<h3>Tuition Fees and Living Expenses:</h3>
							<h4>
								<strong><br /></strong>Tuition Fees
							</h4>
							<p>
								<strong>Estimated tuition fee (per year):<br /></strong><strong>Universities
									: </strong>CAD$ 12,000 to CAD$ 22,000 annually on an average<br />
								<strong>College: </strong>CAD$ 13,000 to CAD$ 17000 annually
							</p>
							<h4>Living Expenses</h4>
							<p>
								<strong>Estimated Living Cost: </strong>CAD$ 10,000 to CAD$
								15,000 per year. An average of CAD$1000 to CAD$1250 per month
								should be considered as safe. Expenses could be higher in
								downtown Toronto. This includes your accommodation (room and
								board), travel, food, some books, some clothing and may be some
								entertainment expense too.
							</p>
							<p>&nbsp;</p>
							<h3>Please find below a range of costs that have been
								considered while estimating the above listed living expenses:</h3>
							<ol>
								<li><strong>Books and study materials </strong>will cost
									CAD$1000 approximately per academic year.</li>
								<li><strong>Travel costs </strong>within the Canada will be
									between CAD$ 800 to CAD$ 1000 approximately.</li>
								<li><strong>Room and Board </strong>will cost between CAD$
									4,800 and CAD$ 7000 approximately per year. A higher cost would
									be in cities like Toronto.</li>
								<li>If you will be living <strong>off campus</strong>, the
									cost of renting an apartment will be between CAD$ 400 and CAD$
									1500 a month, but could be much higher contingent on the
									location of the school.
								</li>
								<li><strong>Meals </strong>should cost about CAD$ 2500 to
									CAD$ 3000 a year, assuming that you do not fancy too many
									outings.</li>
								<li><strong>Personal expenses </strong>will cost around
									CAD$ 2000 to CAD$ 3000 approximately per year.</li>
							</ol>
							<p>The College Board publishes college costs, required
								admissions tests, and other useful information in The
								International Student Handbook of US Colleges.</p>
							<p>&nbsp;</p>
							<h3>Other Costs:</h3>
							<p>
								<strong><br /></strong><strong>Air tickets</strong>: CAD$ 1000
								to CAD$ 2000 (depending when you finish your admission process
								and / or book tickets)<br />
								<strong>Health / Medical Insurance</strong>: CAD$ 300 to CAD$
								500 per year per person<br />
								<strong>Car</strong>: If you wish to buy a car, assume that it
								will cost you around CAD$ 4000<br />
								<strong>Family Member</strong>: If you take along other family
								members with you, assume that your annual expenses will increase
								about to CAD$ 4000 to     CAD$ 5000 approximately for spouse and
								CAD$ 3000 for each additional family member.
							</p>
							<p>&nbsp;</p>
							<h3>Cost of Studying MBA in CANADA:</h3>
							<p>Average course fee for MBA in Canada ranges between CAD$
								25,000 to CAD$ 60,000 for the full program (typically ranging
								from Rs. 12.5 lacs to Rs 30 lacs). Note: Higher fee does not
								determine the quality of the MBA and does not affect the MBA
								rankings.</p>
							<p>
								For a list of Canadian MBA programs with their approximate
								tuition cost check <a href="mba_in_canada">MBA</a>
								in CANADA.
							</p>
							<p>&nbsp;</p>
							<h3>Cost of Studying MS in CANADA:</h3>
							<p>Course fee for MS in CANADA ranges between CAD$ 18,000 to
								CAD$ 45,000 for the full program (typically ranging from Rs 9
								lacs to Rs 23 lacs). Note: Higher fee does not determine the
								quality of the MS program.</p>
							<p>&nbsp;</p>
							<h3>Cost of Studying Bachelors in CANADA:</h3>
							<p>Course fee for Bachelors in USA ranges between CAD$ 15,000
								to CAD$ 60,000 per year (typically ranging from Rs 15 lacs to Rs
								30 lacs). Higher fee does not determine the quality of the
								Bachelor program.</p>
							<p>&nbsp;</p>
							<h3>Cost of Studying Post Graduate Diploma in CANADA
								(Graduate Diploma in Canada):</h3>
							<p>Course fee for Postgraduate Diploma in Canada ranges
								between CAD$ 15000 and CAD$ 17000, equivalent to Rs 7.5 to Rs
								8.5 lacs for the entire course.</p>
						</div>
