			      ...
			      <div id="hero-wrapper">
						...
						<div id="breadcrumbs-wrapper">
							<div class="container">
								...
								&#187; <span><a
									href="study_australia">Study in Australia</a> &#187;  <span class="breadcrumb_last" aria-current="page">Working in Australia</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h1>Work in Australia after education</h1>
									<p>Australia in an attractive country for Indian students
										since it allows you to work in Australia after successfully
										completing your studies. However, under stand the work rules in
										Australia below:</p>
									<h3 id="work-during-study-in-australia">Work DURING study in
										Australia:</h3>
									<p>Students can work up to 20 hours part time per week during
										course of study and full time during vacations</p>
									<h3 id="work-after-study-in-australia:">Work AFTER study in
										Australia:</h3>
									<p>
										We’ll make this simple for you to understand. If you are
										studying a <strong>two year Masters programme</strong>, then you
										can apply for a work permit of 2 years to work in Australia. The
										minimum duration of your study period must be at least 24 months
										(104 weeks).
									</p>
									<ul>
									...
									<p>
										For eg. if you study the 1.5 years <a
											href="https://sydney.edu.au/courses/courses/pc/master-of-information-technology-management.html"
											target="_blank" rel="noopener noreferrer">Master of
											Information Technology Management</a> from the <a
											href="https://sydney.edu.au/" target="_blank"
											rel="noopener noreferrer">University of Sydney</a>, then you
										still have to study for another 6 months in Australia to be
										eligible to get the 2 years work permit in Australia. Or if you
										finished a 1 year <a
											href="https://mbs.edu/degree-programs/full-time-mba"
											target="_blank" rel="noopener noreferrer">MBA from
											Melbourne Business School</a>, then to be eligible to apply for a
										Post Study Work Visa in Australia, you need to finish one more
										degree which of at least 1 year duration.
									</p>
									<p>&nbsp;</p>
								</div>
