			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Bachelors in New Zealand</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_newzaland">Study in
										New Zealand</a> &#187;  <span class="breadcrumb_last" aria-current="page">Bachelors in New Zealand</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h2>Some quick notes for Bachelors in New Zealand</h2>
									<p>
										<strong>Duration: </strong>A degree from a New Zealand
										University is typically completed in three years
									</p>
									<p>
										<strong>English language test</strong>: One of the English
										tests, ie. either <a href="ielts"
											target="_blank">IELTS</a> or <a
											href="toefl" target="_blank">TOEFL</a>,
										is required for all applicants. If your English score in class
										10 and 12 have been good, then we can try for a waiver of  <a
											href="ielts" target="_blank">IELTS</a>
										test for you. The recommended score is 6.0 band overall with no
										less than 5.5 band in the individual modules (Reading, Writing,
										Listening, Speaking).
									</p>
									<p>
										...
										test, you can contact us and we can help you (for free)
									</p>
									<p>
										<strong>Intake</strong>: The New Zealand academic year runs from
										February to November, with the first semester held from February
										to June and the second semester held from July to November
									</p>
								</div>
