...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2018/11/new-zealand-new-zealand-218565-e1543828056598.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Master&#8217;s in New Zealand</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_newzaland">Study in
										New Zealand</a> &#187;  <span class="breadcrumb_last" aria-current="page">Master&#8217;s in New Zealand</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h1>
										<strong>Master&#8217;s in New Zealand</strong>
									</h1>
									<p>&nbsp;</p>
									<h2>Quick Notes on studying Master&#8217;s in New Zealand:</h2>
									<p>&nbsp;</p>
									<h3>Duration of Master&#8217;s in New Zealand:</h3>
									<p>Masters programs in New Zealand are between 1 and 2 years
										in duration and involves either coursework or research or a
										combination of both. Your research is presented in the form of
										either a thesis, dissertation or a research project.</p>
									<p>If you perform with excellence and meet certain standards,
										including completion within a set time limit, master’s degrees
										can be awarded with either honours or distinction.</p>
									<p>&nbsp;</p>
									<h3>Work Experience for Master&#8217;s in New Zealand:</h3>
									<p>No work experience is required for studying Master&#8217;s
										in NZ. However, in some cases where students do not qualify
										directly for Masters for instance in cases where your
										undergraduate degree is not an Honours degree, the University
										may offer a Post Graduate Diploma. Many post graduate diplomas
										in New Zealand form the first year of your Masters, which means
										that on successful completion of your PG Diploma, you can
										continue with the year 2 of the Masters degree</p>
									<p>&nbsp;</p>
									<h3>
									...
									<p>
										No need for <a href="gmat"
											target="_blank">GMAT</a> / <a href="gre"
											target="_blank">GRE</a> to study Master&#8217;s at Universities
									...
									<p>
										You need to appear for an <a href="ielts"
											target="_blank" rel="noopener noreferrer">IELTS</a> test and
										the recommended score is 6.5 band overall with no individual
										module being lower then 5.5 band.
									</p>
									<p>
									...
									<p>&nbsp;</p>
									<h3>15 Years Education Accepted for Master&#8217;s in NZ:</h3>
									<p>If you wish to study Master&#8217;s in New Zealand, you
										can directly apply after your Bachelors (15 years education).
