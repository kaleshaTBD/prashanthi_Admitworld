			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>List of Universities in Dubai (UAE)</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_dubai">Study in
										Dubai</a> &#187;  <span class="breadcrumb_last" aria-current="page">List of Universities in Dubai (UAE)</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
							...
							<div class="entry-content">
								...
								<h3>Post graduate:</h3>
								<p>
									MBA Banking &amp; Insurance<br /> MBA Entrepreneurship<br /> MBA
									Tourism Administration<br /> MBA Hospitality<br /> MBA Retail
									Management<br /> MBA Transport &amp; Logistics<br /> MBA Urban
									&amp; Real Estate Management<br /> MBA PR &amp; Event Management<br />
									MBA For Working Professionals<br /> MBA (General)<br /> Masters
									in Retailing
								</p>
								<p>Masters in Advertising</p>
								<p>Masters in Supply Chain Management</p>
								<p>Masters in International Business</p>
								<p>Masters in Petroleum Engineering</p>
								<p>Masters in Quality Management</p>
								<p>Masters in Engineering Management</p>
								<p>Masters in Strategic Marketing / Marketing</p>
								<p>Masters in Human Resource Management (HR)</p>
								<p>Masters in Marketing Communications (MarComm)</p>
								<p>Masters in International Relations</p>
								<p>&nbsp;</p>
								<p>
									For a list of popular MBA in Dubai, check out our <a
										href="mba_in_dubai">MBA</a> in Dubai section
								</p>
								<p>
									For a list of popular MS in Dubai, check out our <a
										href="ms_in_dubai">Masters in Dubai</a>
									section
								</p>
								<h3></h3>
								<h3>Under graduate:</h3>
								<p>
									BSc Forensic Science<br /> B.Tech Computer Science &amp; Eng.<br />
									B.Tech Civil Engineering<br /> B.Tech Electronics &amp; Telecom.<br />
									B.Tech Solar &amp; Alternate Energy<br /> B.Tech Aerospace
									Engineering<br /> B.Tech Nuclear Science &amp; Tech.<br />
									B.Tech Nanotechnology<br /> BBA (General)<br /> B. Architecture<br />
									BBA Banking &amp; Insurance<br /> BBA Entrepreneurship<br /> BBA
									For Working Professionals<br /> BA Tourism Management<br /> BSc
									Hotel Management
								</p>
								<p>
									<strong>Mostly all popular undergraduate programs you can
										study in Dubai</strong>: Business, Management, Accounting, Finance, Human
									resources management, Hospitality Management, Tourism, Psychology
									with counselling, Global social science, Advertising public
									relations Media, Business information systems, Information
									technology
								</p>
								</div>
