...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2019/09/study-in-singapore-banner.jpg"
							...
							<div class="container">
								<p id="breadcrumbs">
									<span><span><a href="index">Home</a>
											&#187; <span class="breadcrumb_last" aria-current="page">STUDY IN SINGAPORE</span></span></span>
								</p>
							</div>
						</div>
						<div id="why-study-in" style="background-color:#68B684 ">
							<div class="container">
								<h2 style="color:#fff !important">Why study in Singapore</h2>
								<div>
								<p><strong>Quality of Education + Close to India + Quality of Life + Safe Country + Reasonable Fee as compared to many Countries </strong></p>
									<p>Singapore offers a multi-cultural and sophisticated
										...
										consummate reputation for quality education has encouraged
										several of the world’s top institutions to set up campuses in
										Singapore and is also considered as a ‘Global School House’in
										itself. Areas like Little India, Dhobi Ghautetc will make you
										fell ‘at home’ with its majority Indian population. Let’s take a
										brief look at the practical advantages of studying in Singapore</p>
									<p style="margin-top: 10px;">
										<a href="why_study_in_singapore">Continue
											reading...</a>
									</p>
								</div>
							</div>
					...
					<div id="left-area">
							...
							<div id="country-dashboard" style="margin-top:30px;marrgin-bottom:20px">
								...
								<div id="how-can-we-help-eop">
									<h2 style="color:#FD9601">Singapore Admission Counseling</h2>
									...
									studying in Singapore hassle-free.
