			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Admission Documents for Masters/MBA in UK</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_uk">Study in
										UK</a> &#187;  <span class="breadcrumb_last" aria-current="page">Admission Documents for Masters/MBA in UK</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					...
					<div class="entry-content">
						<h2>Admission Documents for Masters/MBA in UK</h2>
						<p>If you are planning to study in UK then you need to
							understand the required Admission Documents for Masters/MBA in
							UK.</p>
						<p>&nbsp;</p>
						<h2>Resume:</h2>
						<p>
						...
						<p>10th standard onward to final year. If you do not have your
							final semester or final year mark sheet assuming you are studying
							in the last of your Bachelors, send the remaining ones to the
							University. You can update the final semester or final mark sheet
							once you have it from your College.</p>
						<p>&nbsp;</p>
						<h2>Transcripts:</h2>
						<p>Bachelors Transcript is a consolidated score sheet that you
							get from your College. It is not mandatory to submit a transcript
							to UK Universities. Some Universities however may ask for it. It
							alright however not to worry too much about it. Just send the
							other documents to the University.</p>
						<p>&nbsp;</p>
						<h2>Recommendation Letters:</h2>
						<p>UK Universities require two recommendation letters. These
							have to be on the letter head of your school / college /
							employer, should be stamped and signed. These need NOT be sealed
							in an envelope like in the case of US Universities. Some UK
							Universities the online method of submitting recommendations. You
							will need to register the referees online and you will have to
							add the title, full name, designation, company name and official
							email ID (no gmail, yahoo, outlook) of your referees to the
							online application.</p>
						<p>
							They will then get an email from the university with a link they
							need to click on to recommend you. Half of this is usually a
							rating scale and the other half is either a text box or specific
							questions about you need to be answered. Please pick referees who
							will be comfortable doing this all online and who have an
							official email ID. <strong>Tip</strong>: In case of your work
							reference letter, it is more important for your immediate manager
							who you regularly report to, to <a
								href="act" target="_blank">act</a> as
							your referee (as opposed to the Director of the company who has
							barely had any interaction with you)
						</p>
						<p>&nbsp;</p>
						<h2>Personal Statement / Statement of Purpose:</h2>
						<p>This is a 1.5 to 2 page essay. It should address 5 main
							questions: What motivates you to do this course? What prepares
							you to do this course (academics, work)? Why do you want to do
							your MBA or a particular Masters at the UK University? What are
							your short-term, long-term goals or career plans in general? You
							can submit this to us a MS Word file and we will check and edit
							this for you.</p>
						<p>&nbsp;</p>
						<h2>Work Experience or Internship Letters:</h2>
						<p>Especially for MBA applicants, this is very important. You
							must take a work experience letter from all your employers. Even
							for students who are applying for Masters, UK Universities will
							be keen on knowing about your experience which you have
							undertaken AFTER your graduation.</p>
						<p>&nbsp;</p>
						<h2>Test Score Reports:</h2>
						<p>
							Most UK Universities need <a href="ielts"
								target="_blank">IELTS</a> test score or <a
								href="pte" target="_blank">PTE</a> test
							score. These can be sent as a scanned copy once you receive the
							hard copy of the score.
						</p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
						...
						<p>Certificated &#8211; extracurricular activities, social
							...
							seminar or the like). Keep to the certificates you earned 9th
						...
						<p>&nbsp;</p>
						<h2>Photo:</h2>
						<p>Passport sized photograph (preferably with a white back
							ground) – only in some online applications.</p>
						<p>&nbsp;</p>
						<h2>Application Form:</h2>
						<p>Completed application form of each UK University must be
							filled and sent to the University. These forms are available on
							their website or you can take these from us. If its an online
							application, you may receive a confirmation email or you could
							take a screenshot of the application and send it with the other
							documents.</p>
						<p>
							<strong>Note</strong>: Financial documents are NOT required to be
							submitted to UK Universities at the time of admissions.
						</p>
