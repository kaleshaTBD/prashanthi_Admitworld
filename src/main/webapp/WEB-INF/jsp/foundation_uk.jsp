							...
							<div class="container">
								...
								&#187; <span><a
									href="study_uk">Study in
										UK</a> &#187;  <span class="breadcrumb_last" aria-current="page">>Foundation Courses UK</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h1>Foundation Courses in the UK</h1>
									<h2>What is a Foundation course in the UK?</h2>
									<p>Foundation courses are for high school-leavers who have
										studied a non-British curriculum but wish to pursue a degree at a
										UK university. The foundation course acts as a bridge between
										your current qualifications and UK university undergraduate entry
										requirements and is designed to bridge academic gaps, improve
										your English and familiarize you with UK life and culture in
										preparation for your UK university degree course.</p>
									<p>A foundation course is great choice for students who do not
										meet the direct entry requirement of a particular UK University.
										Many international students often choose to study a foundation
										course so that they can get an opportunity to study at a top
										ranked UK University. In most cases, after the foundation course
										is finished, students get a guaranteed progression to the
										Bachelors degree in that University.</p>
									<h2>What is the duration of a foundation course in the UK?</h2>
									<p>Foundation courses are of one year duration if you start in
										September. Additionally, most UK foundation courses that begin in
										January also allow you start your degree studies in September.Who
										should take a foundation course in the UK?</p>
									<p>Generally, students who do not meet the entry requirements
										of a particular UK University and wish to study in that
										University can do a foundation course with the University and
										then progress to year 1 of Bachelors studies in the same UK
										University. Additionally, students who wish to acclimatize with
										the UK education system before entering in to the main Bachelors
										level programme can study a foundation course</p>
									<h2>Who runs foundation courses and where can I study?</h2>
									<p>Many UK Universities offer their own foundation degrees eg.
										Queen Mary University of London. There are also foundation
										education providers like Kaplan, INTO, Navitas, Study Group,
										Cambridge Education Group that run these foundation courses
										inside the campus of the UK University whose Bachelors degree you
										eventually wish to join</p>
									<h2>Foundation courses are available for which
										subjects/fields?</h2>
									<p>Foundation courses can prepare you for a variety of
										subjects such as: Business, Finance &amp; Management; Computing;
										Law; Art and Design; Engineering; Social Science; Medicine;
										Science and Pharmacy, Media; and Humanities</p>
									<h2>Foundation Course Requirements</h2>
									<p>
										Minimum <a href="ielts" target="_blank">IELTS</a>:
										4.5 is required for international students to study foundation a
										UK foundation course with no single component lesser than 4.0.
										Some Universities have a higher entry requirement of up to 5.0 in
										<a href="ielts" target="_blank">IELTS</a>.
									</p>
									<h2>Documents required to study a foundation course in UK
										include:</h2>
									<ul>
										<li>Minimum <a href="ielts"
											target="_blank">IELTS</a> score of 4.5 or equivalent
										</li>
										<li>Higher Secondary School Certificate</li>
										<li>Higher Secondary transcripts</li>
										<li>Reference letter from your high school teacher</li>
										<li>Personal statement</li>
										<li>Scanned copy of passport and visa</li>
										<li>Completed application form</li>
									</ul>
									<h3>List of some foundation providers and the University you
										can enter for Bachelors thereafter:</h3>
									<h4>Navitas UK university programs are offered on campus
										at the following UK Universities:</h4>
									<ul>
										<li>Anglia Ruskin University International College</li>
										<li>Birmingham City University International College</li>
										<li>Brunel University International College</li>
										<li>Edinburgh Napier University International College</li>
										<li>University of Hertfordshire International College</li>
										<li>Robert Gordon University International College</li>
										<li>Plymouth University International College</li>
										<li>University of Portsmouth International College</li>
										<li>Swansea University International College</li>
									</ul>
									<h4>INTO has centres at the following locations:</h4>
									<ul>
										<li>INTO London World Education Centre</li>
										<li>INTO University of Stirling</li>
										<li>INTO University of Stirling London</li>
										<li>INTO University of East Anglia</li>
										<li>INTO University of Exeter</li>
										<li>INTO Newcastle University</li>
										<li>INTO Glasgow Caledonian University</li>
										<li>INTO Manchester</li>
										<li>INTO Queen&#8217;s University Belfast</li>
										<li>INTO University of East Anglia Newton A-level Program</li>
										<li>INTO City University London</li>
										<li>INTO St George&#8217;s, University of London</li>
										<li>INTO University of Gloucestershire</li>
										<li>INTO Manchester IPW University of Manchester</li>
										<li>INTO Manchester IPW Manchester Metropolitan</li>
									</ul>
									<h4>The Cambridge Education Group have long standing
										partnerships with many top UK universities, including:</h4>
									<ul>
										...
										<li>UCLAN, University of Central Lancashire</li>
										<li>Coventry University</li>
										<li>University of Sunderland</li>
										<li>Kingston University London</li>
										<li>Royal Veterinary College<strong> </strong></li>
									</ul>
									<h4>Study Group have International Study Centres at the
										following UK institutions:</h4>
									<ul>
										<li>Bellerbys College</li>
										...
										<li>University of Law</li>
										<li>University of Sheffield</li>
										<li>University of Strathclyde</li>
										<li>University of Surrey</li>
										<li>University of Sussex<strong> </strong></li>
									</ul>
									<p>
										<strong>And there are many UK Universities who offer
											their own foundation courses</strong>
									</p>
									<p>&nbsp;</p>
									<h2>Study a Foundation Course in the UK</h2>
									<p>
										If you wish to study a foundation course in the UK, which then
										allows you to study a Bachelors at a top UK University, <a
											href="contact_us" target="_blank"
											rel="noopener noreferrer">contact</a> our expert UK Counsellors.
										As one of the top UK education consultants in Hyderabad, our team
