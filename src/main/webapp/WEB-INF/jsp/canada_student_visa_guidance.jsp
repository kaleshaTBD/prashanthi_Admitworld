...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img src="wp-content/uploads/2019/08/Simon-Fraser-University-Canada-1.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Canada Student Visa Guidance</h1>
						...
						<div id="breadcrumbs-wrapper">
							<div class="container">
								...
								&#187; <span><a
									href="study_canada">Study in Canada</a> &#187;  <span class="breadcrumb_last" aria-current="page">Canada Student Visa Guidance</span></span></span></span>
				...
				<div id="content-area" class="clearfix">
					<div id="left-area">
						...
						<div class="entry-content">
							...
							<h1>Canada Student Visa Guidance</h1>
							<p>Since most students want to avoid the confusion that comes
								with the Offer letters, Type of Study Visa Application to be
								filled, Medicals, payments, booking the appointments, documents,
								checklists, financial information formats etc. this becomes one
								of the most crucial aspects of our jobs. It&#8217;s always advisable
								to have a professional eye over your visa because nobody wants
								anything to go wrong at this stage. We have a near perfect visa
								record, and we can help guide you through the process as well.</p>
							<p>&nbsp;</p>
							<h2>General application requirements under Canada Student
								Visa Guidance :</h2>
							<p>
								<strong><br /></strong>To study in Canada, you may need a study
								permit. The visa application can take anything between 2 &#8211;
								3 weeks.
							</p>
							<p>To apply for a study permit you will need to have a letter
								of acceptance from a higher education institution.</p>
							<ul>
								<li>You must not have a criminal record or be a risk to the
									security of Canada.</li>
								<li>Must be in good health and willing to undergo a medical
									examination, if necessary.</li>
								<li>You must provide proof you will leave Canada at the end
									of your authorized stay.</li>
							</ul>
							<p>A study permit is not needed if you want to take
								short-term courses or programs of study of six months or less.
								You may enrol in short-term programs at any learning
								institution, regardless of whether or not it is designated.</p>
							<p>&nbsp;</p>
							<h3>You must submit the following items:</h3>
							<ul>
								<li>Application for Study Permit made Outside of Canada
									(IMM 1294) for each applicant regardless of the age.</li>
								<li>Family Information Form (IMM 5645) for each applicant
									regardless of the age.</li>
								<li>Two (2) passport photographs.</li>
								<li>Processing fee.</li>
								<li>Valid passport.</li>
								<li>All cancelled or expired passports to show evidence of
									previous travel.</li>
								<li>A copy of the Letter of Acceptance from the educational
									institution where you intend to study.</li>
								<li>Proof of Medicals undergone.</li>
								<li>Proof of financial support for the duration of your
									studies in Canada.</li>
							</ul>
							<p>
								In case you are planning to go for Canada and need help in
								entire application process then we
