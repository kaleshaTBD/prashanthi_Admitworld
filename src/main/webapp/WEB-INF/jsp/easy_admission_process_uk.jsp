...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2019/06/University_of_Goldsmith_UK-2.jpg"
							alt="MBA in UK" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Easy Admission Process – UK</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_uk">Study in
										UK</a> &#187;  <span class="breadcrumb_last" aria-current="page">Easy Admission Process – UK</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					...
					<div class="entry-content">
						<table width="864" style="margin-top:20px;">
							<tbody>
								<tr>
									<td><strong>STEPS</strong></td>
									<td width="419"><strong>Your DIY Kit | To do list
											to study in UK</strong></td>
									<td width="384"><strong>When we are around</strong></td>
								</tr>
								<tr>
									<td>STEP 1</td>
									<td width="419"><strong>SEARCH</strong> &#8211; 100s of
										websites, all universities, specific courses. Here’s a list of
										Universities in UK to give you a start</td>
									<td width="384"></td>
								</tr>
								<tr>
									<td>STEP 2</td>
									<td width="419"><strong>SHORTLIST</strong> &#8211; the
										right program at the right list of Universities in UK matching
										your academic background, test score, budget, other
										requirements.
										</p>
										<p>
								...
								<tr>
									<td>STEP 3</td>
									<td width="419"><strong>COLLECT</strong> &#8211; documents
										and ensure that each of these are correct and in order. This
										includes editing of the statement of purpose (SOP), getting
										recommendations from the right referees, writing and editing
										essays, internship and work experience letters and more.
										Here’s a list of documents required to study for <a
										href="application_requirements_documents_uk"
										target="_blank" rel="noopener noreferrer">Bachelors</a> and <a
										href="application_requirements_documents_MBA_uk"
										target="_blank" rel="noopener noreferrer">MBA or Masters</a>
										in UK to start with</td>
									<td width="384"></td>
								</tr>
								<tr>
									<td>STEP 4</td>
									<td width="419"><strong>BOOK</strong> &#8211; your <a
										...
										update the University and the right department and ensure that
								...
								<tr>
									...
									<td width="419"><strong>APPLY</strong> &#8211; to all
										...
										online or a paper app, what about the application fee, so many
										more</td>
									<td width="384"></td>
								</tr>
								<tr>
								...
								<tr>
									<td>STEP 8</td>
									<td width="419"><strong>PAY DEPOSIT</strong> and <strong>FEE
											PAYMENT</strong> &#8211; pay your deposit or enrolment fee in GBP to
										the University, wait for a confirmation, or follow up with the
										University. Receive the CAS from the University and ensure
										that all details are correct</td>
									<td width="384"></td>
								</tr>
								<tr>
									<td>STEP 9</td>
									<td width="419"><strong>PAY </strong>International Health
										Surcharge which is compulsory if you must apply for the UK
										student visa</td>
									<td width="384"></td>
								</tr>
								<tr>
									...
									<td width="419"><strong>VISA</strong> &#8211; understand
										the student visa process, gather the right <a
										href="uk_student_visa_guidance"
										target="_blank" rel="noopener noreferrer">documents</a> and
										check them thoroughly, book a visa appointment, prepare for an
										interview, present yourself rightly, wait for the decision.
										Here’s where you will need information about the visa process
										and documentation. During this time, decide on where you will
										live, what to pack before going, buy forex, medical and travel
										insurance and more</td>
									<td width="384"></td>
								</tr>
								<tr>
									<td>STEP 11</td>
									<td width="419"><strong>ACCOMMODATION</strong> &#8211;
										find and book the right type of accommodation and <strong>CONNECT</strong>
										&#8211; with other students so that you’ll may travel together
										or help each other</td>
									<td width="384"></td>
								</tr>
								<tr>
									<td>STEP 12</td>
									<td width="419"><strong>FLY</strong> &#8211; book tickets
										...
										open a bank account, about travelling locally in the UK,
										carried important documents along with you, bought the
										required forex and such other important information that comes
										up ONLY in the end</td>
									<td width="384"></td>
								</tr>
							</tbody>
						</table>
						<p>&nbsp;</p>
						<p class="Normal1">
							<strong><span lang="EN-IN">Let us help you
									achieve YOUR dream!</span></strong>
						</p>
