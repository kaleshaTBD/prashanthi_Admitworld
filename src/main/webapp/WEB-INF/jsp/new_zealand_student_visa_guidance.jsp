...
<jsp:include page="commonheader.jsp" />
		<div id="et-main-area">
			<div id="main-content country-usa is-country-page">
			      <div id="hero-wrapper">
						<img
							src="wp-content/uploads/2018/11/new-zealand-auckland-city-0114-e1543828464566.jpg"
							alt="Study in USA" class="attachment-full">
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>New Zealand F1 Student Visa Guidance</h1>
						...
						<div id="breadcrumbs-wrapper">
							<div class="container">
								...
								&#187; <span><a
									href="study_newzaland">Study in
										New Zealand</a> &#187;  <span class="breadcrumb_last" aria-current="page">New Zealand F1 Student Visa Guidance</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					<div id="left-area">
									...
									<h2>Visa Guidance NZ</h2>
									<p>
										Complete details of visa and permit requirements, advice on
										rights to employment in New Zealand while studying, and
										reporting requirements are available through the New Zealand
										Immigration service, and can be viewed on their website at <a
											href="http://www.immigration.govt.nz/">www.immigration.govt.nz</a>.
									</p>
									<p>Student visa and permit information and application forms
										can be obtained from any New Zealand Immigration Service branch
										office within New Zealand or overseas (contact the nearest New
										Zealand High Commission in your country or Embassy in Delhi
										(India).</p>
									<p>It is also recommend that you visit the New Zealand
										Immigration website to obtain information on student visa
										criteria prior to completing an application form as requirement
										can vary for country to country.</p>
									<p>
										<a href="http://www.immigration.govt.nz/study">www.immigration.govt.nz/study</a>
									</p>
									<h2></h2>
									<p>&nbsp;</p>
									<h2>Student Visa:</h2>
									<h3>Brief</h3>
									<p>NZIS is the sole agency of the NZ government responsible
										for migration and entry to NZ.  Student visa is required to
										enter the country to study a course more than 3 months duration.</p>
									<p>You can only get a student visa to study in a course at an
										education institution, which is registered and approved by the
										NZQA.</p>
									<p>Your student visa will be issued for the length of time
										your course tuition fees have been paid. You must pay your
										tuition fees in advance for the University to send you an
										official receipt and the Offer of Place Certificate, which also
										guarantees that accommodation will be available, all these are
										required with your visa application.</p>
									<p>
										You can also obtain all relevant information and forms from the
										New Zealand Immigration Service website, <a
											href="http://www.immigration.govt.nz/">www.immigration.govt.nz</a>.
									</p>
									<p>&nbsp;</p>
									<h3>For your New Zealand student visa you may require:</h3>
									<ul>
										<li><strong>Offer letter:</strong> The New Zealand
											Qualifications Authority (NZQA) offer letter to international
											students, which lists minimum course duration, course fees and
											whether the fees are applicable at domestic or foreign rates</li>
										<li><strong>Fee Receipt</strong>: Receipt showing payment
											of one year’s tuition fees (provided that your visa application
											has been approved in principle)</li>
										<li><strong>Guarantee of Stay (for students aged
												under 18 years): </strong>A written document from an institution or
											person that states that the student has suitable accommodation
											arranged in New Zealand</li>
										<li><strong>Health and medical requirements: </strong>If
											you are staying in New Zealand for more than six months then
											you need to be screened for tuberculosis. For a longer stay, a
											general medical certificate and a chest X-ray certificate need
											to be provided. These must be obtained from Immigration New
											Zealand’s approved panel physicians in India. Check the list <a
											href="https://goo.gl/I6LelA">here</a></li>
										<li><strong>Medical and travel insurance</strong>: Student
											visa holders are generally not eligible for publicly funded
											health and disability services. For this reason, foreign
											fee-paying students are required to hold acceptable medical and
											travel insurance as a condition of their visa</li>
										<li><strong>Proof of English:</strong> An <a
											href="ielts" target="_blank">IELTS</a>
											score to demonstrate competency in English is necessary to
											apply for a New Zealand student visa. You will need to meet <a
											href="ielts" target="_blank">IELTS</a>
											score prerequisites to gain admission to the top universities
											in New Zealand. Some education providers do consider your
											English scores in year 12</li>
										<li><strong>Police certificate</strong>: If you are
											studying in New Zealand for more than two years, you must
											provide a police certificate from your country of citizenship
											and from any country in which you have lived for five or more
											years since reaching 17 years of age. The certificates must be
											less than six months old</li>
										<li><strong>Photographs</strong>: Two recent passport-sized
											photos will be required</li>
										<li><strong>Covering letter/SOP</strong>: Please give your
											 background covering the evidence of funds and the your English
											Language ability. In addition please provide a statement of
											purpose (SOP) which should contain reasons as to why you are
											applying, what do you wish to study and how will the course
											would help you in the future. This SOP should be hand-written
											by you (no one else)</li>
										<li><strong>Academics</strong>: All original academic
											marksheets and transcript that you had submitted to the
											University must to be submitted at the time of New Zealand
											student visa application</li>
										<li><strong>Financial Documents</strong>: You need to prove
											that you have sufficient funds to undertake the course of study
											in New Zealand</li>
									</ul>
									<h2></h2>
									<h3>You must submit evidence of sufficient funds for
										maintenance during your stay in New Zealand including:</h3>
									<ul>
										<li>Financial Undertaking Form/s (if more than one
											guarantor)</li>
										<li>Affidavit/s of Support from Guarantors (also stating
											the exact relationship of the guarantor with the applicant).
											The guarantor must provide documentary evidence of their
											identity including date of birth, proof of signature and full
											contact details including telephone numbers</li>
										<li>The student should provide evidence of funds upfront
											for the first 12 months of study inclusive of living expenses
											(NZ$15,000 per annum) in New Zealand. The student will have to
											transfer the tuition fees to the Institution and apart from
											that the student will have to show the living expense of
											NZ$10,000 per annum. If the duration of course is longer,
											students should provide a plan of payment to show that they
											have access to funds and have the ability to meet the rest of
											the course cost and living expenses.</li>
									</ul>
									<h4>Following evidences are acceptable to prove your funds:</h4>
									<ul>
										<li style="list-style-type: none;"><ul>
												<li><strong>Education loan sanction letter</strong> from
													a nationalised or multi national bank only</li>
												<li><strong>Latest bank statements</strong> for the past
													6 months. It should not be more than 1 week old from the date
													of visa application. Please ensure that statements and not
													balance certificates are provided</li>
												<li><strong>Fixed Deposits</strong>. In this case please
													ensure that a copy/counterfoil of the deposit along with a
													letter from the bank giving the details of the deposit is
													provided.</li>
												<li>Public Provident Fund Accounts/Employers Provident
													Fund Accounts along with a confirmation letter stating the
													exact amount that can be withdrawn and which can be
													considered as liquid</li>
												<li>Post Office Accounts</li>
												<li>National Saving Certificates.<br /> OR
												</li>
												<li>Funds Transfer Scheme</li>
											</ul></li>
									</ul>
									<p>New Delhi branch has put in place a system wherein the
										students may choose to transfer 12 months’ living expenses to a
										bank account in NZ, in addition to paying the tuition fee for 1
										year. The amount deposited in the bank is locked for a period of
										12 months and then drip fed to the student on a prearranged
										basis.</p>
									<p>The funds transfer option is to facilitate student visa
										applications from those students who genuinely intend to study
										in New Zealand but may not have access to funds older than six
										months. Students who opt for this process will not be required
										to provide verifiable documentary evidence to demonstrate the
										source of recent funds. This option does not preclude the
										applicant from submitting satisfactory evidence of funds and
										source of income for their financial guarantors.</p>
									<p>
										<strong>Note</strong>:
									</p>
									<p>
										<strong>Applicants are required to provide documentary
											evidence of income and source of income of their parents, even
											if the cost of study is being sponsored by another person.</strong>
									</p>
									<p>&nbsp;</p>
								</div>
								<div id="how-can-we-help-eop">
									<h2 style="color:#FD9601">NEW ZEALAND Admission Counseling</h2>
									In case you&#8217;re confused about your studies in New Zealand, we can help
									...
									studying in New Zealand hassle-free.
												...
												<div class="inner-wrapper">
													...
													<div>
														...
														<div class="box-list-wrapper">
															<ul>
																<li><a href="mba_in_new_zealand">MBA in New Zealand</a></li>
																<li><a href="mba_program_in_new_zealand">MBA Programs in New Zealand</a></li>
																<li><a href="ms_in_new_zealand">Master’s in New Zealand</a></li>
																	<li><a href="bachelors_in_new_zealand">Bachelors in New Zealand</a></li>
																		<li><a href="pg_in_new_zealand">Post Graduate Diploma in New Zealand</a></li>
												...
												<div class="inner-wrapper">
													...
													<div>
														...
														<div class="box-list-wrapper">
															<ul>
																<li><a
																	href="new_zealand_universites">List of Universities & Colleges in New Zealand</a></li>
												...
												<div class="inner-wrapper">
													...
													<div>
														...
														<div class="box-list-wrapper">
															<ul>
																<li><a
																	href="tests_required_to_apply_to_new_zealand">Tests Required to Apply to New Zealand</a></li>
																<li><a
																	href="admission_process_for_new_zealand">Application & Admission Process for New Zealand</a></li>
																<li><a
																	href="application_requirements_documents_new_zealand">Application Requirements & Documents – New Zealand</a></li>
																
																	<li><a
																	href="cost_of_studying_in_new_zealand">Cost of Study in New Zealand</a></li>
															</ul>
														</div>
													</div>
												</div>
											...
											<div class="quick-links box-style-01">
												<div class="inner-wrapper">
													...
													<div>
															...
															<ul>
																<li><a
																	href="easy_admission_process_new_zealand">Easy Admission Process – New Zealand</a></li>
																<li><a
																	href="new_zealand_admission_counseling">New Zealand Admission Counseling</a></li>
																<li><a
																	href="new_zealand_counseling_packages">New Zealand Counseling Packages</a></li>
																<li><a
																	href="new_zealand_student_visa_guidance">New Zealand F1 Student Visa Guidance</a></li>
															</ul>
														</div>
													</div>
												</div>
												...
												<div class="inner-wrapper">
													...
													<div>
														...
														<div class="box-list-wrapper">
															<ul>
																<li><a
																	href="new_zealand_working">Working in New Zealand</a></li>
														
																	<li><a
																	href="new_zealand_education_system">Education System in New Zealand</a></li>
																	<li><a
							...
							<div id="sidebar" class="sidebar custom-sidebar"
								...
								<div class="theiaStickySidebar"
									...
									<div class="sidebar__inner">
										<div class="frm_form_widget" style="background-color:#21627c;">
