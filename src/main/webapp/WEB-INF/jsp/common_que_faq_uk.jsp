			      ...
			      <div id="hero-wrapper">
						<img
							...
							<div id="hero-title" style="margin-top: -60.5px;">
								<div class="container">
									<h1>Common Questions – FAQs &#8211; UK</h1>
							...
							<div class="container">
								...
								&#187; <span><a
									href="study_uk">Study in
										UK</a> &#187;  <span class="breadcrumb_last" aria-current="page">Common Questions – FAQs &#8211; UK</span></span></span></span>
			...
			<div class="container">
				<div id="content-area" class="clearfix">
					...
					<div class="entry-content" style="margin-top:20px">
						<h3>What is the difference between the MA and MSc in the UK?</h3>
						<p>Depending on the candidate&#8217;s choice of future career,
							it is sometimes more beneficial to have either a Master of Arts
							degree or a Master of Science degree. There is no difference to
							the teaching of the programme. It is the same. Decades back most
							Masters in the UK started as MA programmes. Over the years, most
							MA programmes transited to becoming MSc is what we believe</p>
						<h3></h3>
						<h3>
							Which is a better test to appear – <a
								href="ielts" target="_blank">IELTS</a>, <a
								href="toefl" target="_blank">TOEFL</a> or
							<a href="pte" target="_blank">PTE</a>?
						</h3>
						<p>
							<strong><br /> </strong>All are good as long as your University
							accepts the test. All the 3 tests are English language tests so
							there isn’t a sea of difference between these – just some
							difference in the pattern of the test. None is more difficult
							than the other. <a href="toefl"
								target="_blank">TOEFL</a> test is not accepted by the UKVI when
							you are applying for a UK visa. The major difference is how soon
							you receive the test score – <a
								href="ielts" target="_blank">IELTS</a>
							score arrives in approximately 13 working days after you appear
							for the test while <a href="pte"
								target="_blank">PTE</a> test score arrives in approximately 5
							working days
						</p>
					</div>
